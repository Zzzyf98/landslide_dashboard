...
var acapi=function(u){function F(a){function b(c,d){return c.reduce(function(e,g){var h;Array.isArray(g)&&(h=b(g,d+1));return h>e?h:e},d)}return b(a,1)}function C(a){if(void 0!=a){var b=[];if(/^(rgb|RGB)/.test(a)){a=a.replace(/(?:\(|\)|rgb|RGB)*/g,"").split(",");for(var c of a)b.push(Number((Number(c)/255).toFixed(6)))}else/^#/.test(a)?a.includes("#")?(a=a.replace("#",""),3==a.length&&(a=a[0]+""+a[0]+a[1]+a[1]+a[2]+a[2]),6!=a.length?(console.error("\u975e\u5341\u516d\u8fdb\u5236\u989c\u8272\u683c\u5f0f"),
b=void 0):(b=parseInt(a.substring(0,2),16),c=parseInt(a.substring(2,4),16),a=parseInt(a.substring(4,6),16),b=[b/255,c/255,a/255])):(console.error("\u975e\u5341\u516d\u8fdb\u5236\u989c\u8272\u683c\u5f0f"),b=void 0):a instanceof Array&&(b=a);3==b.length&&b.push(1);return b}}function K(a){if(void 0!=a){var b,c=F(a);2==c?b=[[a]]:3==c?b=[a]:4==c&&(b=a);if(b)for(let d of b)for(let e of d)for(let g of e)2==g.length&&g.push(0);return b}}function P(a){if(void 0!=a)return 1==F(a)?[a]:a}function E(a){return a instanceof
Array?a:[a]}function I(a){let b=[];if(a instanceof Array)for(let c in a)b[c]=a[c].toString();else b=[a.toString()];return b}function za(a){return!isNaN(parseFloat(a))&&isFinite(a)}function S(a){switch(typeof a){case "undefined":return!0;case "string":if(0===a.replace(/(^[ \t\n\r]*)|([ \t\n\r]*$)/g,"").length)return!0;break;case "boolean":if(!a)return!0;break;case "number":if(isNaN(a))return!0;break;case "object":if(null===a||0===a.length)return!0;for(var b in a)return!1;return!0}return!1}function qa(a,
b){for(a=a.toString();a.length<b;)a="0"+a;return a}function ua(){let a=new Date;return qa(a.getHours(),2)+":"+qa(a.getMinutes(),2)+":"+qa(a.getSeconds(),2)+"."+qa(a.getMilliseconds(),3)}function La(a,b){let c,d=0;return function(...e){const g=this,h=+new Date,q=b-(h-d);0>=q?(d=h,a.apply(g,e),c&&(clearTimeout(c),c=null)):c||(c=setTimeout(()=>{d=+new Date;c=null;a.apply(g,e)},q))}}function Ma(a){switch(a){case ba.StartingProcess:return"starting process...";case ba.CheckingBusy:return"checking...";case ba.ProcessStartFailed:return"process start failed!";
case ba.ProcessStarted:return"process started";case ba.LoadingProject:return"loading project...";case ba.ProjectLoaded:return"project loaded";case ba.UserAccessDenied:return"user access denied";case ba.CheckingLicense:return"checking license..."}}function Aa(a){"string"===typeof a&&(a=document.getElementById(a));return a}function Na(a){return R.isIOSDevice&&R.isInWeixinBrowser?!1:a==ja.abnormal||a==ja.instance_disconnected}function W(a,b){return void 0!==a&&null!==a?a:b}function V(){if(!(this instanceof
V))return new V;this.reg=Array(8);this.chunk=[];this.size=0;this.reset()}function Oa(a){var b=new V;a=b.sum(a);return b.toArray(a,function(c){return("0"+(c&255).toString(16)).slice(-2)}).join("")}function Ba(a){return a.keyCode===ea.Shift&&"ShiftRight"===a.code?ea.RightShift:a.keyCode===ea.Control&&"ControlRight"===a.code?ea.RightControl:a.keyCode===ea.Alt&&"AltRight"===a.code?ea.RightAlt:a.keyCode}var l={None:0,Camera_PlayAnimation:1,Camera_StopAnimation:2,Misc_EnterReportMode:3,Misc_ExitReportMode:4,
...
HydroDynamic1D_Hide:551,HydroDynamic2D_Add:544,HydroDynamic2D_Update:545,HydroDynamic2D_Delete:546,HydroDynamic2D_Clear:547,HydroDynamic2D_Get:548,HydroDynamic2D_Focus:549,HydroDynamic2D_Show:550,HydroDynamic2D_Hide:551,Settings_GetWKT:552,SmoothMoveCustomObject:553,VectorField_Focus:554,Misc_ReloadPak:555,Misc_DownLoad:556,Misc_SetPakVisibility:557,TileLayer_GetDBTabID:558,GeoJSONLayer_Focus:559,Misc_ProjectAssetCount:560,Marker_SetViewPort:561,Misc_SwitchShortcutKey:562,Tools_GetFunctionNavBar:563,
GeoJSONLayer_HighlightFeature:564,GeoJSONLayer_UnHighlightFeature:565,GeoJSONLayer_FocusFeature:566,GeoJSONLayer_UnHighlightFeaturesByLayerId:568,ImageryLayer_Focus:567,VectorField_Show:570,VectorField_Hide:571,VectorField_Get:572,MarkerLayer_Add:573,MarkerLayer_Update:574,MarkerLayer_Delete:575,MarkerLayer_Clear:576,MarkerLayer_Focus:577,MarkerLayer_Show:578,MarkerLayer_ShowAll:579,MarkerLayer_Hide:580,MarkerLayer_HideAll:581,MarkerLayer_Get:582,MarkerLayer_FocusMarker:583,Settings_Update:585,GeoJSONLayer_Clear:584,
GeoJSONLayer_Update:586,Marker3D_CallFunction:587,TileLayer_TileLayerReceiveWMTSDecal:588,CustomObject_ShowByGroupId:590,CustomObject_HideByGroupId:591,Command_End:1E4},Ca=!1;(()=>{if(!Ca){Ca=!0;for(let a in l)l[l[a]]=a}})();class Pa{constructor(a,b){this.id=a;this.visible=b}}class Qa{constructor(a,b,c,d){this.id=a.toString();this.coordinate=b;this.radius=c;this.heatValue=d}}class Ra{constructor(a,b,c,d,e,g,h,q,k,f,m,t,x,r){this.id=a.toString();this.coordinate=b;this.imagePath=c;this.imageSize=d;
this.url=e;this.text=g;this.range=h||[1,1E5];this.showLine=!!q;this.textColor=k||[0,0,0,1];this.textBackgroundColor=f||[1,1,1,.85];this.textBorderColor=m||[0,0,0,0];this.textRange=t||1E5;this.hoverImagePath=x;this.autoHidePopupWindow=r||!0}}class Sa{constructor(a,b,c){this.url=a;this.width=b;this.height=c}}class Ta{constructor(a,b,c,d,e,g,h,q){this.id=a.toString();this.coordinate=b;this.contentURL=c.url;this.contentSize=[c.width,c.height];this.popupURL=d.url;this.popupSize=[d.width,d.height];this.pivot=
e;this.range=g;this.autoHidePopupWindow=h||!0;this.popupPos=q}}class Ua{constructor(a,b,c,d,e,g){this.id=a.toString();this.coordinates=K(b);this.color=C(c);this.heightRange=d;this.intensity=e;this.depthTest=g||!0}}class Va{constructor(a,b,c,d,e,g,h,q){this.id=a.toString();this.x=b;this.y=c;this.width=d;this.height=e;this.normalImage=g;this.hoverImage=h;this.tooltip=q}}class Wa{constructor(a,b,c,d,e,g,h,q,k){this.id=a.toString();this.x=b;this.y=c;this.width=d;this.height=e;this.imageSequecePath=g;
this.imageSequeceLength=h;this.loop=!!q;this.interactable=!!k}}class Xa{constructor(a,b,c,d,e,g,h){this.id=a.toString();this.duration=b;this.thickness=c;this.interval=d;this.velocity=e;this.color=C(g);this.coordinates=h}}class Ya{constructor(a,b,c,d,e,g){this.id=a.toString();this.coordinate=b;this.radius=c;this.rippleNumber=d;this.color=C(e);this.brightness=g}}class Za{constructor(a,b,c,d,e,g,h,q){this.id=a.toString();this.style=b;this.coordinates=K(c);this.color=C(d);this.height=e;this.intensity=
g;this.tillingX=h;this.tillingY=q}}class $a{constructor(a,b,c,d,e,g,h,q,k,f){this.id=a.toString();this.color=C(b);this.coordinates=c;this.style=void 0==d?0:d;if(0>this.style||5<this.style)this.style=0;this.thickness=void 0==e?20:e;this.brightness=void 0==g?.5:g;this.flowRate=void 0==h?.5:h;this.tiling=q||0;this.depthTest=k||!0;this.shape=void 0==f?0:f}}class ab{constructor(a,b,c,d,e,g,h,q,k,f,m,t,x,r,y,v,A){this.id=a.toString();this.color=C(b);this.coordinates=c;this.flowRate=void 0==d?.5:d;this.brightness=
void 0==e?.5:e;this.bendDegree=void 0==g?.5:g;this.tiling=h||0;this.lineThickness=void 0==q?20:q;this.flowPointSizeScale=void 0==k?20:k;this.labelSizeScale=void 0==f?100:f;this.lineShape=void 0==m?1:m;this.lineStyle=t||0;this.flowShape=x||0;this.startPointShape=r||0;this.endPointShape=y||0;this.startLabelShape=v||0;this.endLabelShape=A||0;this.endLabelStyle=this.startLabelStyle=this.endPointStyle=this.startPointStyle=this.flowStyle=0}}class bb{constructor(a,b,c,d,e,g,h,q){this.id=a.toString();this.color=
C(b);this.coordinates=K(c);this.framecolor=C(d);this.framethickness=e;this.depthTest=g||!0;this.brightness=h;this.style=q;if(0>this.style||10<this.style)this.style=0}}class cb{constructor(a,b,c,d,e,g){this.id=a.toString();this.imagePath=b;this.coordinate=c;this.yaw=d;this.groupId=e||"";this.userData=g||""}}class db{constructor(a,b,c,d,e,g,h,q){this.id=a.toString();this.order=b;this.texturePath=c;this.location=d;this.rotation=e;this.scale=g;this.groupId=h;this.userData=q}}class eb{constructor(a,b,
c,d,e){this.id=a.toString();this.fileName=b;this.location=c;this.rotation=d;this.scale=e}}class fb{constructor(a,b,c,d,e,g,h){this.id=a;this.pakFilePath=b;this.assetPath=c;this.location=d;this.rotation=e;this.scale=g;this.smoothMotion=h}}class gb{constructor(a,b,c,d,e,g,h){this.id=a;this.tileLayerId=b;this.objectId=c;this.location=d;this.rotation=e;this.scale=g;this.smoothMotion=h}}class hb{constructor(a,b,c,d,e,g,h){this.id=a;this.videoURL=b;this.location=c;this.rotation=d;this.fov=e;this.aspectRatio=
g;this.distance=h}}class ib{constructor(a,b,c,d,e){this.id=a;this.coordinates=K(b);this.style=c;this.groupId=d;this.userData=e}}class jb{constructor(a,b,c,d,e){this.actorTag=a;this.objectName=b;this.functionName=c;this.paramType=d;this.paramValue=e}}class fa{constructor(a,b){this.tileLayerId=a;this.tileLayerActorNames=I(b)}}class kb{constructor(a,b,c,d){this.index=a;this.time=b;this.location=c;this.rotation=d}}class lb{constructor(a,b,c){this.id=a.toString();this.name=b.toString();this.keyFrames=
c}}class mb{constructor(){this.queue=[];this.dataMap=new Map}enqueue(a){if(null==a||void 0==a||!a.callbackIndex)return!1;this.queue.push(a.callbackIndex);this.dataMap.set(a.callbackIndex,a);return!0}dequeue(){if(0!=this.queue.length){const a=this.queue.shift();return this.dataMap.get(a)}}removeData(a){this.dataMap.has(a)&&this.dataMap.delete(a)}dataSize(){return this.dataMap.size}queueSize(){return this.queue.length}}class nb extends mb{constructor(a){super();this.onSendAPI=a;this.timer=null;this.isMainThreadBusy=
...
this._callNextForTimeout(5E3):this.callNext()},a)}}class N{constructor(a,b,c){this.int=a;this.type=b;this.colorProps=c;this._useBatchUpdate=!1;this._tempUpdateData=[]}_checkCommand(a){a=this.type+a;let b=l[a];void 0==b&&this.int.logWithColor("red",`Invalid command: ${a}`);return b}_convertFilePath(a){return this.int.resourcesPath?a.replace("@path:",this.int.resourcesPath+"/"):a}_processProps(a){a=E(a);for(var b of a)for(let d in b)if("string"==typeof b[d]&&b[d].startsWith("@path:")&&(b[d]=this._convertFilePath(b[d])),
"imagesArray"==d)for(let e=0;e<b[d].length;e++)b[d][e]=this._convertFilePath(b[d][e]);for(let d of a)"string"!=typeof d.id&&(d.id=d.id.toString());if(this.colorProps){b=this.colorProps.split("|");for(var c of a)for(let d of b)c.hasOwnProperty(d)&&(c[d]=C(c[d]))}if(-1!=["Polygon","Polygon3D","HighlightArea","DynamicWater"].indexOf(this.type))for(let d of a)d.coordinates=K(d.coordinates);for(let d of a)d.hasOwnProperty("userData")&&(c=d.userData,this._isJsonString(c)&&(d.userData=c.replace(/"/g,"~!@~!@~!@")))}_isJsonString(a){try{return"string"===
...
a);this._tempUpdateData=null;this._useBatchUpdate=!1;return a}test(){alert("test")}}class ob extends N{constructor(a){super(a,"Beam","color")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,d,e){return super._focus(a,b,c,d,e)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}showAll(a){return super._showAll(a)}hideAll(a){return super._hideAll(a)}get(a,b){return super._get(a,b)}setDuration(a,
b,c){return super._updateOneProp(a,"duration",b,c)}setThickness(a,b,c){return super._updateOneProp(a,"thickness",b,c)}setInterval(a,b,c){return super._updateOneProp(a,"interval",b,c)}setVelocity(a,b,c){return super._updateOneProp(a,"velocity",b,c)}setColor(a,b,c){return super._updateOneProp(a,"color",C(b),c)}setCoordinates(a,b,c){return super._updateOneProp(a,"coordinates",b,c)}}class pb extends N{constructor(a){super(a,"CameraTour")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,
b)}delete(a,b){return super._delete(a,b)}play(a,b){return this.int.call({command:l.CameraTour_Play,ids:I(a)},b)}setMouseClickToPause(a,b,c){return this.int.call({command:l.CameraTour_Play,ids:I(a),mouseInput:b},c)}setTime(a,b,c){return this.int.call({command:l.CameraTour_Play,ids:I(a),playerTime:b},c)}pause(a){return this.int.call0(l.CameraTour_Pause,a)}resume(a){return this.int.call0(l.CameraTour_Resume,a)}stop(a){return this.int.call({command:l.CameraTour_Stop},a)}setUserData(a,b,c){return super._updateOneProp(a,
"userData",b,c)}setDuration(a,b,c){return super._updateOneProp(a,"duration",b,c)}setKeyFrames(a,b,c){return super._updateOneProp(a,"keyFrames",b,c)}setName(a,b,c){return super._updateOneProp(a,"name",b,c)}}class qb extends N{constructor(a){super(a,"Cesium3DTile")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,d,e){return super._focus(a,b,c,d,e)}show(a,b){return super._show(a,b)}showAll(a){return super._showAll(a)}hide(a,
b){return super._hide(a,b)}hideAll(a){return super._hideAll(a)}get(a,b){return super._get(a,b)}setTileURL(a,b,c){return super._updateOneProp(a,"tileURL",b,c)}}class rb extends N{constructor(a){super(a,"CustomMesh","color")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,d,e){return super._focus(a,b,c,d,e)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,
...
ca={V1:1,V2:2,V3:4,V4:8,All:255},Da={ClearObjects:1,ResetSettings:2,ResetCamera:4};class sb extends N{constructor(a){super(a,"CustomObject")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,d,e,g){"function"==typeof c&&(g=c,c=void 0);"function"==typeof d&&(g=d,d=null);"function"==typeof e&&(g=e,e=0);1<e&&(d=2==e?[-45,0,0]:3==e?[0,0,0]:4==e?[-90,0,0]:5==e?[90,0,0]:6==e?[0,90,0]:7==e?[0,270,0]:[0,
0,0]);!S(a)&&-1==b&&S(c)&&S(d)&&S(e)&&(e=1,b=0);return this.int.call({command:l.CustomObject_Focus,ids:I(a),distance:b||0,flyTime:c,rotation:d||null,follow:e||0},g)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}addByTileLayer(a,b){if(a instanceof Array)for(let c of a)this._fixTileLayerProperty(c);else this._fixTileLayerProperty(a);return this.int.call({command:l.CustomObject_AddByTileLayer,data:E(a)},b)}_fixTileLayerProperty(a){a.tileLayerId instanceof
Array||(a.tileLayerId=E(a.tileLayerId));a.objectId instanceof Array||(a.objectId=E(a.objectId))}highlight(a,b){return this.int.call({command:l.CustomObject_Highlight,ids:I(a)},b)}unhighlight(a,b){return"undefined"==typeof a||"function"==typeof a?("function"==typeof a&&(b=a),this.int.call({command:l.CustomObject_StopHighlight},b)):this.int.call({command:l.CustomObject_Unhighlight,ids:I(a)},b)}glow(a,b){if(a instanceof Array)for(let c of a){let d;d=C(c.color);c.colors=[{color:[d[0]/2,d[1]/2,d[2]/2],
value:0},{color:c.color,value:1}]}else o.colors=[{color:o.color,value:0},{color:o.color,value:1}];return this.int.call({command:l.CustomObject_StartGlow,data:E(a)},b)}stopGlow(a,b){return this.int.call({command:l.CustomObject_StopGlow,ids:I(a)},b)}getBPFunction(a,b){return this.int.call({command:l.Misc_QueryActorOrMaterial,idOrPaths:E(a)},b)}callBPFunction(a,b,c,d,e,g){this.callFunction(a,b,c,d,e,g)}callFunction(a,b,c,d,e,g){return this.int.call({command:l.CustomObject_CallFunction,data:E({id:a.toString(),
functionName:b,paramType:c,paramValue:d,parameters:e})},g)}callBPFunction(a,b){this.callBatchBPFunction(a,b)}callBatchBPFunction(a,b){this.callFunction4CustomObjectArr(a,b)}callBatchFunction(a,b){this.callFunction4CustomObjectArr(a,b)}callFunction4CustomObjectArr(a,b){return this.int.call({command:l.CustomObject_CallFunction,data:E(a)},b)}setLocation(a,b,c,d){return"function"==typeof c?super._updateOneProp(a,"location",b,c):"number"==typeof c?this.int.call({command:l.CustomObject_Update,data:[{id:a,
location:b,smoothTime:c}]},d):super._updateOneProp(a,"location",b,d)}setSmoothTime(a,b,c){return super._updateOneProp(a,"smoothTime",b,c)}moveTo(a,b){return this.int.call({command:l.CustomObject_Update,data:E(a)},b)}setRotation(a,b,c){return super._updateOneProp(a,"rotation",b,c)}setLocalRotation(a,b,c){return super._updateOneProp(a,"localRotation",b,c)}setScale(a,b,c){return super._updateOneProp(a,"scale",b,c)}setSmoothMotion(a,b,c){return super._updateOneProp(a,"smoothMotion",b,c)}setTintColor(a,
b,c){a={ids:E(a),color:C(b)};return this.int.call({command:l.CustomObject_SetTintColor,data:E(a)},c)}overrideMaterial(a,b){return this.int.call({command:l.CustomObject_OverrideMaterial,data:E(a)},b)}restoreMaterial(a,b){return this.int.call({command:l.CustomObject_RestoreMaterial,ids:E(a)},b)}setViewportVisible(a,b,c){let d=[];d.push({viewportIndex:1,viewportVisible:!!(b&ca.V1)});d.push({viewportIndex:2,viewportVisible:!!(b&ca.V2)});d.push({viewportIndex:3,viewportVisible:!!(b&ca.V3)});d.push({viewportIndex:4,
viewportVisible:!!(b&ca.V4)});return this.int.call({command:l.CustomObject_SetViewportVisible,id:a,data:d},c)}startMove(a,b,c,d){return this.int.call({command:l.CustomObject_StartMove,id:a,coordinateType:b,data:E(c)},d)}showByGroupId(a,b){return this.int.call({command:l.CustomObject_ShowByGroupId,groupIds:I(a)},b)}hideByGroupId(a,b){return this.int.call({command:l.CustomObject_HideByGroupId,groupIds:I(a)},b)}stopMove(a,b){return this.int.call({command:l.CustomObject_StopMove,id:a},b)}}class tb extends N{constructor(a){super(a,
"CustomTag")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,d,e){return super._focus(a,b,c,d,e)}focusAll(a,b,c,d){return super._focusAll(a,b,c,d)}show(a,b){return super._show(a,b)}showAll(a){return super._showAll(a)}hide(a,b){return super._hide(a,b)}hideAll(a){return super._hideAll(a)}get(a,b){return super._get(a,b)}setAutoHidePopupWindow(a,b,c){return super._updateOneProp(a,"autoHidePopupWindow",
b,c)}}class ub extends N{constructor(a){super(a,"Decal")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,d,e){return super._focus(a,b,c,d,e)}focusAll(a,b,c,d){return super._focusAll(a,b,c,d)}get(a,b){return super._get(a,b)}}class vb extends N{constructor(a){super(a,"DynamicWater")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,
b,c,d,e){return super._focus(a,b,c,d,e)}focusAll(a,b,c,d){return super._focusAll(a,b,c,d)}get(a,b){return super._get(a,b)}setCoordinates(a,b,c){return super._updateOneProp(a,"coordinates",K(b),c)}setMaterialPath(a,b,c){return super._updateOneProp(a,"materialPath",b,c)}setStyle(a,b,c){return super._updateOneProp(a,"style",b,c)}}class wb extends N{constructor(a){super(a,"FiniteElement","")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,
b,c,d,e){return super._focus(a,b,c,d,e)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}}class xb extends N{constructor(a){super(a,"FloodFill","color")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,d,e){return super._focus(a,b,c,d,e)}show(a,b){return super._show(a,b)}showAll(a){return super._showAll(a)}hide(a,b){return super._hide(a,b)}hideAll(a){return super._hideAll(a)}get(a,
b){return super._get(a,b)}setRange(a,b,c,d){b instanceof Array&&c instanceof Array?0<b.length&&0<c.length?this.update({id:a,min:b,max:c},d):console.error("\u6570\u7ec4\u53c2\u6570\u4e0d\u80fd\u4e3a\u7a7a."):console.error("\u6570\u7ec4\u53c2\u6570\u683c\u5f0f\u4e0d\u6b63\u786e.")}setMin(a,b,c){return super._updateOneProp(a,"min",b,c)}setMax(a,b,c){return super._updateOneProp(a,"max",b,c)}setSeed(a,b,c){return super._updateOneProp(a,"seed",b,c)}setElevation(a,b,c){return super._updateOneProp(a,"elevation",
b,c)}setColor(a,b,c){return super._updateOneProp(a,"color",C(b),c)}setPrecision(a,b,c){return super._updateOneProp(a,"precision",b,c)}}class yb extends N{constructor(a){super(a,"Fluid","color")}add(a,b){this._fixMarkerData(a,"add");return super._add(a,b)}_fixMarkerProperty(a,b){var c=[[[120,250,350,3],[.6,1,1,3E-5],[.117708,.294268,.470833,0],[1,1.2,1.15,.65],0],[[70,180,350,5],[.05,.25,.3,1.5E-4],[.15,.3,.45,0],[1,1.2,1.15,.65],0],[[140,180,300,2.5],[.14,.33,.36,2E-4],[.077778,.203,.333333,0],[.9,
...
.475,.290938,0],[1,1.05,.85,.8],1],[[333,270,200,12],[.7,.8,.4,2E-4],[.461049,.475,.290938,0],[1,.9,.8,.8],1]];za(a.style)&&0<=a.style&&23>=a.style&&"add"==b?(b=a.style,a.color1=c[b][0],a.color2=c[b][1],a.color3=c[b][2],a.color4=c[b][3],a.color5=c[b][4]):(a.color1=c[0][0],a.color2=c[0][1],a.color3=c[0][2],a.color4=c[0][3],a.color5=c[0][4]);if(0<a.sources.length)for(c=0;c<a.sources.length;c++){b=a.sources[c].velocity;let d=b[1];-2>=b[0]&&(a.sources[c].velocity[0]=-2);2<=d&&(a.sources[c].velocity[1]=
2)}}_fixMarkerData(a,b){if(a instanceof Array)for(let c of a)this._fixMarkerProperty(c,b);else this._fixMarkerProperty(a,b)}update(a,b){return super._update(a,b)}pause(a,b){return this.update({id:E(a),active:!1},b)}continue(a,b){return this.update({id:E(a),active:!0},b)}reset(a,b){return this.int.call({command:l.Fluid_Reset,ids:E(a)},b)}addSource(a,b){return this.int.call({command:l.Fluid_AddSource,data:E(a)},b)}removeSource(a,b){return this.int.call({command:l.Fluid_RemoveSource,data:E(a)},b)}continueSource(a,
b){if(a instanceof Array)for(let c of a)c.sources.active=!0;return this.update(a,b)}stopSource(a,b){if(a instanceof Array)for(let c of a)c.sources.active=!1;return this.update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,d,e){return super._focus(a,b,c,d,e)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}}class zb extends N{constructor(a){super(a,"GeoJSONLayer")}add(a,b){this.load(a,b)}update(a,b){a.sourceJson&&
(a.url=a.sourceJson);"object"==typeof a.url&&(a.url=JSON.stringify(a.url));Array.isArray(a.viewHeightRange)&&(a.minVisibleHeight=a.viewHeightRange[0],a.maxVisibleHeight=a.viewHeightRange[1]);return super._update(a,b)}load(a,b){a.sourceJson&&(a.url=a.sourceJson);"object"==typeof a.url&&(a.url=JSON.stringify(a.url));Array.isArray(a.viewHeightRange)&&(a.minVisibleHeight=a.viewHeightRange[0],a.maxVisibleHeight=a.viewHeightRange[1]);return super._add(a,b)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,
b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,d,e){return super._focus(a,b,c,d,e)}highlightFeature(a,b,c){return this.int.call({command:l.GeoJSONLayer_HighlightFeature,data:E({id:a,featureIds:[b]})},c)}stopHighlightFeature(a,b,c){return this.int.call({command:l.GeoJSONLayer_UnHighlightFeature,data:E({id:a,featureIds:[b]})},c)}highlightFeatures(a,b){return this.int.call({command:l.GeoJSONLayer_HighlightFeature,data:E(a)},b)}stopHighlightFeatures(a,b){return this.int.call({command:l.GeoJSONLayer_UnHighlightFeature,
data:E(a)},b)}stopAllHighlightFeaturesById(a,b){return this.int.call({command:l.GeoJSONLayer_UnHighlightFeaturesByLayerId,ids:E(a)},b)}focusFeature(a,b,c,d,e,g){return this.int.call({command:l.GeoJSONLayer_FocusFeature,data:E({id:a,featureIds:[b]}),distance:c,flyTime:d,rotation:e},g)}setViewHeightRange(a,b,c,d){return this.int.call({command:l.GeoJSONLayer_Update,data:[{id:a,minVisibleHeight:b,maxVisibleHeight:c}]},d)}}class Ab extends N{constructor(a){super(a,"HeatMap")}_checkBBox(a){if(a instanceof
Array){if(6!=a.length||a[0]>a[3]||a[1]>a[4]||a[2]>a[5])return!1}else return!1;return!0}add(a,b,c,d,e,g,h,q,k,f,m,t,x,r,y){if(!this._checkBBox(b))return this.int.logWithColor("red","Invalid bbox value"),!1;if("undefined"==typeof e||"function"==typeof e)return"function"==typeof e&&(y=e),this.int.call({command:l.HeatMap_Add,id:a.toString(),bbox:b,range:c,data:E(d),style:-1},y);if(0==e||1==e)return this.int.call({command:l.HeatMap_Add,id:a.toString(),bbox:b,range:c,data:E(d),style:e,textureSize:g,opacityMode:h,
opacityRange:q,blur:k,colors:f,blendMode:m,light:t,binaryFile:x,updateTime:r},y);"function"==typeof e&&(y=e);return this.int.call({command:l.HeatMap_Add,id:a.toString(),bbox:b,range:c,data:E(d),style:-1},y)}update(a,b,c,d,e,g,h,q,k,f,m,t,x,r,y){a={command:l.HeatMap_Update,id:a.toString()};b&&(this._checkBBox(b)||this.int.logWithColor("red","Invalid bbox value"),a.bbox=b);c&&(a.range=c);d&&(a.data=E(d));"undefined"!=typeof e&&"function"!=typeof e&&(g&&(a.textureSize=g),h&&(a.opacityMode=h),q&&(a.opacityRange=
q),k&&(a.blur=k),f&&(a.colors=f),m&&(a.blendMode=m),t&&(a.light=t),x&&(a.binaryFile=x),r&&(a.updateTime=r));"function"==typeof e&&(y=e);return this.int.call(a,y)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,d,e){return super._focus(a,b,c,d,e)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}addPoints(a,b,c){return this.int.call({command:l.HeatMap_AddPoints,id:a,data:E(b)},c)}removePoints(a,b,c){return this.int.call({command:l.HeatMap_RemovePoints,
id:a,pointIds:E(b)},c)}setRange(a,b,c){return this.int.call({command:l.HeatMap_Update,id:a,range:b},c)}setBBox(a,b,c){return this._checkBBox(b)?this.int.call({command:l.HeatMap_Update,id:a,bbox:b},c):(this.int.logWithColor("red","Invalid bbox value"),!1)}}class Bb extends N{constructor(a){super(a,"HeatMap3D")}_checkBBox(a){if(a instanceof Array){if(6!=a.length||a[0]>a[3]||a[1]>a[4]||a[2]>a[5])return!1}else return!1;return!0}addByImages(a,b){this.add(a,b)}addByBinaryFiles(a,b){this.add(a,b)}addByHeatPoints(a,
b){this.add(a,b)}addByVoxels(a,b){this.add(a,b)}addBySparseVoxels(a,b){this.add(a,b)}add(a,b){return super._add(a,b)}addHeatPoints(a,b){this.addVoxels(a,b)}addVoxels(a,b){return this.int.call({command:l.HeatMap_AddVoxels,data:E(a)},b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,d,e){return super._focus(a,b,c,d,e)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}queryVoxel(a,
b,c){return this.int.call({command:l.HeatMap3D_Query,id:a,coordinate:b},c)}setDisplayMode(a,b,c){return this.int.call({command:l.HeatMap3D_Update,id:a,displayMode:b},c)}setViewportVisible(a,b,c){let d=[];d.push({viewportIndex:1,viewportVisible:!!(b&Viewport.V1)});d.push({viewportIndex:2,viewportVisible:!!(b&Viewport.V2)});d.push({viewportIndex:3,viewportVisible:!!(b&Viewport.V3)});d.push({viewportIndex:4,viewportVisible:!!(b&Viewport.V4)});return this.int.call({command:l.HeatMap3D_SetViewPort,id:a,
data:d},c)}}class Cb extends N{constructor(a){super(a,"HighlightArea","color")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,d,e){return super._focus(a,b,c,d,e)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}setColor(a,b,c){return super._updateOneProp(a,"color",C(b),c)}setCoordinates(a,b,c){return super._updateOneProp(a,"coordinates",b,c)}setHeightRange(a,
b,c){return super._updateOneProp(a,"heightRange",b,c)}setIntensity(a,b,c){return super._updateOneProp(a,"intensity",b,c)}setDepthTest(a,b,c){return super._updateOneProp(a,"depthTest",b,c)}}class Db extends N{constructor(a){super(a,"HydrodynamicModel2")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,d,e){return super._focus(a,b,c,d,e)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,
b)}get(a,b){return super._get(a,b)}setTime(a,b){return this.update(a,b)}startPlay(a,b){if(a instanceof Array){for(let c of a)c.playing=!0;return this.update(a,b)}return this.update({id:a.id,displayMode:a.displayMode,time:a.time,playing:!0},b)}stopPlay(a,b){if(a instanceof Array){let c=[];for(let d of a)a={},a.id=d,a.playing=!1,c.push(a);return this.update(c,b)}return this.update({id:a,playing:!1},b)}pause(a,b){if(a instanceof Array){let c=[];for(let d of a)a={},a.id=d,a.paused=!0,c.push(a);return this.update(c,
b)}return this.update({id:a,paused:!0},b)}resume(a,b){if(a instanceof Array){let c=[];for(let d of a)a={},a.id=d,a.paused=!1,c.push(a);return this.update(c,b)}return this.update({id:a,paused:!1},b)}}class Eb extends N{constructor(a){super(a,"Antenna")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,d,e){return super._focus(a,b,c,d,e)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,
b)}get(a,b){return super._get(a,b)}}class Fb extends N{constructor(a){super(a,"HydroDynamic1D","arrowColor|waterColor")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,d,e){return super._focus(a,b,c,d,e)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}}class Gb extends N{constructor(a){super(a,"HydroDynamic2D","arrowColor|waterColor")}addByTif(a,
b){this.add(a,b)}addBySdb(a,b){this.add(a,b)}addByBin(a,b){this.add(a,b)}addByShp(a,b){this.add(a,b)}_fixMarkerProperty(a,b){"add"==b&&(a.waterDepthAttributeName&&(a.waterDepth=a.waterDepthAttributeName),a.uvAttributeName&&(a.flowField=a.uvAttributeName),a.sdb&&(a.sdbFilePath=a.sdb))}_fixMarkerData(a,b){if(a instanceof Array)for(let c of a)this._fixMarkerProperty(c,b);else this._fixMarkerProperty(a,b)}add(a,b){this._fixMarkerData(a,"add");return super._add(a,b)}update(a,b){this._fixMarkerData(a,"add");
return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,d,e){return super._focus(a,b,c,d,e)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}}class Hb extends N{constructor(a){super(a,"HydrodynamicModel","arrowColor|waterColor")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,d,e){return super._focus(a,
b,c,d,e)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}}class Ib extends N{constructor(a){super(a,"ImageryLayer")}init(a,b){return this.int.call({command:l.ImageryLayer_Init,xmlPath:a.xmlUrl,layerName:a.layerName,tileMatrixName:a.tileMatrixName,ogcEPSG:a.ogcEPSG,cachePath:a.cachePath,mapMode:a.mapMode,renderMode:a.renderMode},b)}add(a,b){const c=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){return a instanceof Array?new Promise(d=>
$jscomp.asyncExecutePromiseGeneratorFunction(function*(){let e;for(let g of a)if(e=yield c.addOne(g,b),0!=e.result){d(e);break}d(e)})):c.addOne(a,b)})}addOne(a,b){return this.int.call({command:l.ImageryLayer_Add,id:a.id,url:a.url,xmlPath:a.xmlPath,layerName:a.layerName,tileMatrixName:a.tileMatrixName,ogcEPSG:a.ogcEPSG},b)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}delete(a,b){return super._delete(a,b)}focus(a,b,c,d,e){return super._focus(a,b,c,d,e)}}class Jb extends N{constructor(a){super(a,
"Light","color")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,d,e){return super._focus(a,b,c,d,e)}show(a,b){return super._show(a,b)}showAll(a){return super._showAll(a)}hide(a,b){return super._hide(a,b)}hideAll(a){return super._hideAll(a)}get(a,b){return super._get(a,b)}}class Kb extends N{constructor(a){super(a,"Marker","fontColor|fontOutlineColor|textBackgroundColor|lineColor")}add(a,b){this._fixMarkerData(a,
"add");return super._add(a,b)}_fixMarkerProperty(a,b){a.textColor&&(a.fontColor=a.textColor);a.url&&(a.popupURL=a.url);a.dispalyMode&&(a.displayMode=a.dispalyMode);S(a.displayMode)&&"add"==b&&(a.displayMode=4);a.popupURL&&!a.popupSize&&"add"==b&&(a.popupSize=[600,400]);0==a.showLine&&(a.lineSize=[0,0]);1!=a.showLine||null!=a.lineSize&&void 0!=a.lineSize||(a.lineSize=[2,100]);4==a.displayMode&&0<a.autoDisplayModeSwitchFirstRatio&&0<a.autoDisplayModeSwitchSecondRatio&&(a.autoDisplayModeSwitchRatio=
...
b,c,d){return super._focusAll(a,b,c,d)}show(a,b){return super._show(a,b)}showAll(a){return super._showAll(a)}hide(a,b){return super._hide(a,b)}hideAll(a){return super._hideAll(a)}showPopupWindow(a,b){return this.int.call({command:l.Marker_ShowPopupWindow,ids:I(a)},b)}hidePopupWindow(a,b){return this.int.call({command:l.Marker_HidePopupWindow,ids:I(a)},b)}showAllPopupWindow(a){return this.int.call0(l.Marker_ShowAllPopupWindow,a)}hideAllPopupWindow(a){return this.int.call0(l.Marker_HideAllPopupWindow,
...
"popupOffset",b,c)}setLineSize(a,b,c){return super._updateOneProp(a,"lineSize",b,c)}setLineColor(a,b,c){return super._updateOneProp(a,"lineColor",b,c)}setLineOffset(a,b,c){return super._updateOneProp(a,"lineOffset",b,c)}setPriority(a,b,c){return super._updateOneProp(a,"priority",b,c)}setOcclusionCull(a,b,c){return super._updateOneProp(a,"occlusionCull",b,c)}setAttachCustomObject(a,b){return this.int.call({command:l.Marker_SetupPOIAttachment,data:E(a)},b)}setViewportVisible(a,b,c){let d=[];d.push({viewportIndex:1,
viewportVisible:!!(b&Viewport.V1)});d.push({viewportIndex:2,viewportVisible:!!(b&Viewport.V2)});d.push({viewportIndex:3,viewportVisible:!!(b&Viewport.V3)});d.push({viewportIndex:4,viewportVisible:!!(b&Viewport.V4)});return this.int.call({command:l.Marker_SetViewPort,id:a,data:d},c)}showByGroupId(a,b){return this.int.call({command:l.Marker_ShowByGroupId,ids:E(a)},b)}hideByGroupId(a,b){return this.int.call({command:l.Marker_HideByGroupId,ids:E(a)},b)}deleteByGroupId(a,b){return this.int.call({command:l.Marker_DeleteByGroupId,
ids:E(a)},b)}}class Lb extends N{constructor(a){super(a,"Marker3D","textColor|textOutlineColor")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,d,e){return super._focus(a,b,c,d,e)}show(a,b){return super._show(a,b)}showAll(a){return super._showAll(a)}hide(a,b){return super._hide(a,b)}hideAll(a){return super._hideAll(a)}get(a,b){return super._get(a,b)}showByGroupId(a,b){return this.int.call({command:l.Marker3D_ShowByGroupId,
groupIds:I(a)},b)}hideByGroupId(a,b){return this.int.call({command:l.Marker3D_HideByGroupId,groupIds:I(a)},b)}deleteByGroupId(a,b){return this.int.call({command:l.Marker3D_DeleteByGroupId,groupIds:I(a)},b)}getBPFunction(a,b){return this.int.call({command:l.Misc_QueryActorOrMaterial,idOrPaths:E(a)},b)}callBPFunction(a,b){this.callBatchBPFunction(a,b)}callBatchBPFunction(a,b){return this.int.call({command:l.Marker3D_CallFunction,data:E(a)},b)}setViewHeightRange(a,b,c,d){return this.int.call({command:l.Marker3D_Update,
data:[{id:a,minVisibleHeight:b,maxVisibleHeight:c}]},d)}}class Mb extends N{constructor(a){super(a,"MarkerLayer","color|fontColor|fontOutlineColor|textBackgroundColor|lineColor")}add(a,b){this._fixMarkerProperty(a);return super._add(a,b)}_fixMarkerProperty(a){Array.isArray(a.viewHeightRange)&&(a.minVisibleHeight=a.viewHeightRange[0],a.maxVisibleHeight=a.viewHeightRange[1])}_fixMarkerData(a,b){if(a instanceof Array)for(let c of a)this._fixMarkerProperty(c,b);else this._fixMarkerProperty(a,b)}update(a,
b){this._fixMarkerProperty(a);return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,d,e){return super._focus(a,b,c,d,e)}focusByMarkerId(a,b,c,d,e,g){return this.int.call({command:l.MarkerLayer_FocusMarker,data:[{id:a,ids:[b]}],distance:c,flyTime:d,rotation:e},g)}show(a,b){return super._show(a,b)}showAll(a){return super._showAll(a)}hide(a,b){return super._hide(a,b)}hideAll(a){return super._hideAll(a)}setViewHeightRange(a,b,c,d){return this.int.call({command:l.MarkerLayer_Update,
...
b,c)}setStartPointShape(a,b,c){return super._updateOneProp(a,"startPointShape",b,c)}setEndPointShape(a,b,c){return super._updateOneProp(a,"endPointShape",b,c)}setStartLabelShape(a,b,c){return super._updateOneProp(a,"startLabelShape",b,c)}setEndLabelShape(a,b,c){return super._updateOneProp(a,"endLabelShape",b,c)}}class Ob extends N{constructor(a){super(a,"Panorama")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,
b,c,d,e){return super._focus(a,b,c,d,e)}get(a,b){return super._get(a,b)}enter(a,b){return this.int.call({command:l.Panorama_Enter,ids:I(a)},b)}exit(a){return this.int.call({command:l.Panorama_Exit},a)}switchMode(a){return this.int.call({command:l.Panorama_Switch},a)}}class Pb extends N{constructor(a){super(a,"Polygon","color|frameColor")}add(a,b){this._fixPolygonData(a);return super._add(a,b)}_fixPolygonProperty(a){a.brightness=0==a.intensity||1==a.intensity?a.intensity:1;11==a.style&&(a.style=0,
...
b)}get(a,b){return super._get(a,b)}glow(a,b,c){return this.int.call({command:l.Polygon_Glow,ids:I(a),duration:b},c)}highlight(a,b){return this.int.call({command:l.Polygon_Highlight,ids:I(a)},b)}stopHighlight(a,b){return this.int.call({command:l.Polygon_StopHighlight,ids:I(a)},b)}setCoordinates(a,b,c){return super._updateOneProp(a,"coordinates",K(b),c)}setColor(a,b,c){return super._updateOneProp(a,"color",C(b),c)}setDepthTest(a,b,c){return super._updateOneProp(a,"depthTest",b,c)}setViewHeightRange(a,
b,c,d){return this.int.call({command:l.Polygon_Update,data:[{id:a,minVisibleHeight:b,maxVisibleHeight:c}]},d)}}class Qb extends N{constructor(a){super(a,"Polygon3D","color")}add(a,b){this._fixPolygonData(a);return super._add(a,b)}_fixPolygonProperty(a){11==a.style&&(a.style=9,a.intensity=1);17==a.style&&(a.style=11);Array.isArray(a.viewHeightRange)&&(a.minVisibleHeight=a.viewHeightRange[0],a.maxVisibleHeight=a.viewHeightRange[1])}_fixPolygonData(a){if(a instanceof Array)for(let b of a)this._fixPolygonProperty(b);
else this._fixPolygonProperty(a)}update(a,b){this._fixPolygonData(a);return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,d,e){return super._focus(a,b,c,d,e)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}showAll(a){return super._showAll(a)}hideAll(a){return super._hideAll(a)}highlight(a,b){return this.int.call({command:l.Polygon3D_Highlight,ids:I(a)},b)}stopHighlight(a,b){return this.int.call({command:l.Polygon3D_StopHighlight,
ids:I(a)},b)}glow(a,b){if(a instanceof Array)for(let c of a){let d;d=C(c.color);c.colors=[{color:[d[0]/2,d[1]/2,d[2]/2],value:0},{color:c.color,value:1}]}else o.colors=[{color:o.color,value:0},{color:o.color,value:1}];return this.int.call({command:l.Polygon3D_Glow,data:E(a)},b)}stopGlow(a,b){return this.int.call({command:l.Polygon3D_StopGlow,ids:I(a)},b)}setStyle(a,b,c){return super._updateOneProp(a,"style",b,c)}setCoordinates(a,b,c){return super._updateOneProp(a,"coordinates",b,c)}setColor(a,b,c){return super._updateOneProp(a,
"color",C(b),c)}setHeight(a,b,c){return super._updateOneProp(a,"height",b,c)}setIntensity(a,b,c){return super._updateOneProp(a,"intensity",b,c)}setTillingX(a,b,c){return super._updateOneProp(a,"tillingX",b,c)}setTillingY(a,b,c){return super._updateOneProp(a,"tillingY",b,c)}setViewHeightRange(a,b,c,d){return this.int.call({command:l.Polygon3D_Update,data:[{id:a,minVisibleHeight:b,maxVisibleHeight:c}]},d)}}class Rb extends N{constructor(a){super(a,"Polyline","color")}add(a,b){this._fixPolylineData(a);
return super._add(a,b)}_fixPolylineProperty(a){a.intensity&&(a.brightness=a.intensity);8==a.style&&(a.style=4,a.brightness=1,a.intensity=1);Array.isArray(a.viewHeightRange)&&(a.minVisibleHeight=a.viewHeightRange[0],a.maxVisibleHeight=a.viewHeightRange[1])}_fixPolylineData(a){if(a instanceof Array)for(let b of a)this._fixPolylineProperty(b);else this._fixPolylineProperty(a)}update(a,b){this._fixPolylineData(a);return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,
b,c,d,e){return super._focus(a,b,c,d,e)}show(a,b){return super._show(a,b)}showAll(a){return super._showAll(a)}hide(a,b){return super._hide(a,b)}hideAll(a){return super._hideAll(a)}get(a,b){return super._get(a,b)}setCoordinates(a,b,c){return super._updateOneProp(a,"coordinates",b,c)}setStyle(a,b,c){return super._updateOneProp(a,"style",b,c)}setThickness(a,b,c){return super._updateOneProp(a,"thickness",b,c)}setColor(a,b,c){return super._updateOneProp(a,"color",C(b),c)}setFlowRate(a,b,c){return super._updateOneProp(a,
"flowRate",b,c)}setBrightness(a,b,c){return super._updateOneProp(a,"brightness",b,c)}setShape(a,b,c){return super._updateOneProp(a,"shape",b,c)}setDepth(a,b,c){return super._updateOneProp(a,"depthTest",b,c)}setViewHeightRange(a,b,c,d){return this.int.call({command:l.Polyline_Update,data:[{id:a,minVisibleHeight:b,maxVisibleHeight:c}]},d)}}class Sb extends N{constructor(a){super(a,"RadiationPoint","color")}add(a,b){this._fixRadiationPointData(a);return super._add(a,b)}_fixRadiationPointProperty(a){a.intensity&&
(a.brightness=a.intensity)}_fixRadiationPointData(a){if(a instanceof Array)for(let b of a)this._fixRadiationPointProperty(b);else this._fixRadiationPointProperty(a)}update(a,b){this._fixRadiationPointData(a);return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,d,e){return super._focus(a,b,c,d,e)}focusAll(a,b,c,d){return super._focusAll(a,b,c,d)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}showAll(a){return super._showAll(a)}hideAll(a){return super._hideAll(a)}get(a,
b){return super._get(a,b)}setCoordinate(a,b,c){return super._updateOneProp(a,"coordinate",b,c)}setRadius(a,b,c){return super._updateOneProp(a,"radius",b,c)}setRippleNumber(a,b,c){return super._updateOneProp(a,"rippleNumber",b,c)}setColor(a,b,c){return super._updateOneProp(a,"color",C(b),c)}setBrightness(a,b,c){return super._updateOneProp(a,"brightness",b,c)}setAutoHeight(a,b,c){return super._updateOneProp(a,"autoHeight",b,c)}}class Tb extends N{constructor(a){super(a,"River","arrowColor|waterColor")}add(a,
b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,d,e){return super._focus(a,b,c,d,e)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}}class Ub extends N{constructor(a){super(a,"ShapeFileLayer","color")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}_fix_property(a){if(a instanceof Array){let b=[];for(let c of a)S(c.cacheAllField)&&
(c.cacheAllField=!1,b.push(c));a=b}else S(a.cacheAllField)&&(a.cacheAllField=!1);return a}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}get(a,b){return super._get(a,b)}focus(a,b,c,d,e){return super._focus(a,b,c,d,e)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}showAll(a){return super._showAll(a)}hideAll(a){return super._hideAll(a)}open(a,b){return this.int.call({command:l.ShapeFileLayer_OpenShapeFileLayer,data:E(a)},b)}highlightFeature(a,b,c){return this.int.call({command:l.ShapeFileLayer_HighlightFeature,
data:E({shpId:a,featureIds:[b]})},c)}stopHighlightFeature(a,b,c){return this.int.call({command:l.ShapeFileLayer_UnHighlightFeature,data:E({shpId:a,featureIds:[b]})},c)}highlightFeatures(a,b){return this.int.call({command:l.ShapeFileLayer_HighlightFeature,data:E(a)},b)}stopHighlightFeatures(a,b){return this.int.call({command:l.ShapeFileLayer_UnHighlightFeature,data:E(a)},b)}focusFeature(a,b,c,d,e,g){return this.int.call({command:l.ShapeFileLayer_FocusFeature,data:E({shpId:a,featureIds:[b]}),distance:c,
flyTime:d,rotation:e},g)}getFeature(a,b){return this.int.call({command:l.ShapeFileLayer_GetFeatureInfo,data:E(a)},b)}}class Vb extends N{constructor(a){super(a,"SignalWave","olor")}add(a,b){this._fixMarkerData(a,"add");return super._add(a,b)}_fixMarkerProperty(a,b){if(0<=a.alpha&&1>=a.alpha)if(0==a.alpha)a.alpha=.9;else if(1==a.alpha)a.alpha=.8;else{b=a.alpha;var c=[0,1],d=[.9,.8];b=b<c[0]||b>c[1]?NaN:(b-c[0])*(d[1]-d[0])/(c[1]-c[0])+d[0];a.alpha=b}else a.alpha=1}_fixMarkerData(a,b){if(a instanceof
Array)for(let c of a)this._fixMarkerProperty(c,b);else this._fixMarkerProperty(a,b)}update(a,b){this._fixMarkerData(a,"update");return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,d,e){return super._focus(a,b,c,d,e)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}}class Wb extends N{constructor(a){super(a,"Tag","textColor|textBackgroundColor|textBorderColor")}add(a,b){return super._add(a,b)}update(a,
b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,d,e){return super._focus(a,b,c,d,e)}focusAll(a,b,c,d){return super._focusAll(a,b,c,d)}show(a,b){return super._show(a,b)}showAll(a){return super._showAll(a)}hide(a,b){return super._hide(a,b)}hideAll(a){return super._hideAll(a)}get(a,b){return super._get(a,b)}setCoordinate(a,b,c){return super._updateOneProp(a,"coordinate",b,c)}setImagePath(a,b,c){return super._updateOneProp(a,"imagePath",b,
c)}setImageSize(a,b,c){return super._updateOneProp(a,"imageSize",b,c)}setText(a,b,c){return super._updateOneProp(a,"text",b,c)}setRange(a,b,c){return super._updateOneProp(a,"range",b,c)}setTextColor(a,b,c){return super._updateOneProp(a,"textColor",b,c)}setTextBackgroundColor(a,b,c){return super._updateOneProp(a,"textBackgroundColor",b,c)}setTextBorderColor(a,b,c){return super._updateOneProp(a,"textBorderColor",b,c)}setShowLine(a,b,c){return super._updateOneProp(a,"showLine",b,c)}setAutoHidePopupWindow(a,
b,c){return super._updateOneProp(a,"autoHidePopupWindow",b,c)}setURL(a,b,c){return super._updateOneProp(a,"url",b,c)}showPopupWindow(a,b){return this.int.call({command:l.Tag_PopupWindow_Show,ids:I(a)},b)}hidePopupWindow(a,b){return this.int.call({command:l.Tag_PopupWindow_Hide,ids:I(a)},b)}showAllPopupWindow(a){return this.int.call0(l.Tag_PopupWindow_ShowAll,a)}hideAllPopupWindow(a){return this.int.call0(l.Tag_PopupWindow_HideAll,a)}}class Xb{constructor(){this._where=this._fields=this._id=null}get id(){return this._id}set id(a){this._id=
a}get fields(){return this._fields}set fields(a){this._fields=a}get where(){return this._where}set where(a){this._where=a}get limit(){return this._limit}set limit(a){this._limit=a}get offset(){return this._offset}set offset(a){this._offset=a}}class Yb extends N{constructor(a){super(a,"TileLayer")}add(a,b){this._fixMarkerProperty(a);return super._add(a,b)}_fixMarkerProperty(a){Array.isArray(a.viewHeightRange)&&(a.minVisibleHeight=a.viewHeightRange[0],a.maxVisibleHeight=a.viewHeightRange[1])}_fixMarkerData(a,
b){if(a instanceof Array)for(let c of a)this._fixMarkerProperty(c,b);else this._fixMarkerProperty(a,b)}update(a,b){this._fixMarkerProperty(a);return super._update(a,b)}delete(a,b){return super._delete(a,b)}focus(a,b,c,d,e){return super._focus(a,b,c,d,e)}clear(a){return super._clear(a)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}getAllFlattenInfo(a){return this.int.call({command:l.TileLayer_GetAllFlattenData},a)}getActorInfoFromDB(a,b){return this.int.call({command:l.TileLayer_GetActorInfoFromDB,
data:E(a)},b)}enableXRay(a,b,c){return this.int.call({command:l.TileLayer_EnableXRay,ids:I(a),color:C(b)},c)}disableXRay(a,b){return this.int.call({command:l.TileLayer_DisableXRay,ids:I(a)},b)}enableClip(a,b){let c=[];a=E(a);for(let d of a)c.push({id:d,allowClip:!0});return this.int.call({command:l.TileLayer_SetAllowClip,data:c},b)}disableClip(a,b){let c=[];a=E(a);for(let d of a)c.push({id:d,allowClip:!1});return this.int.call({command:l.TileLayer_SetAllowClip,data:c},b)}setFileName(a,b,c){return super._updateOneProp(a,
"fileName",b,c)}setLocation(a,b,c){return super._updateOneProp(a,"location",b,c)}setTranslation(a,b,c){return this.setLocation(a,b,c)}setRotation(a,b,c){return super._updateOneProp(a,"rotation",b,c)}setScale(a,b,c){return super._updateOneProp(a,"scale",b,c)}showActor(a,b,c){a=new fa(a,b);return this.int.call({command:l.TileLayer_Actor_Show,data:E(a)},c)}showActors(a,b){let c=[];if(a instanceof Array)for(let e=0;e<a.length;e++){var d=a[e];d={tileLayerId:d.id,tileLayerActorNames:I(d.objectIds)};c.push(d)}else a=
{tileLayerId:a.id,tileLayerActorNames:I(a.objectIds)},c.push(a);return this.int.call({command:l.TileLayer_Actor_Show,data:c},b)}hideActor(a,b,c){a=new fa(a,b);return this.int.call({command:l.TileLayer_Actor_Hide,data:E(a)},c)}hideActors(a,b){let c=[];if(a instanceof Array)for(let e=0;e<a.length;e++){var d=a[e];d={tileLayerId:d.id,tileLayerActorNames:I(d.objectIds)};c.push(d)}else a={tileLayerId:a.id,tileLayerActorNames:I(a.objectIds)},c.push(a);return this.int.call({command:l.TileLayer_Actor_Hide,
data:c},b)}focusActor(a,b,c,d,e,g){a=new fa(a,b);return this.int.call({command:l.TileLayer_Actor_Focus,data:E(a),distance:c,flyTime:d,rotation:e},g)}focusActors(a,b,c,d,e){a=new fa(a.id,a.objectIds);return this.int.call({command:l.TileLayer_Actor_Focus,data:E(a),distance:b,flyTime:c,rotation:d},e)}highlightActor(a,b,c){a=new fa(a,b);return this.int.call({command:l.TileLayer_Actor_Highlight,data:E(a)},c)}stopHighlightActor(a,b,c){let d=void 0==a;"function"==typeof a&&(c=a,d=!0);if(d)return this.stopHighlightActors(c);
if(S(a)||S(b))console.error("\u53c2\u6570\u4e0d\u80fd\u4e3a\u7a7a!");else return this.stopHighlightActors({id:a,objectIds:[b]},c)}highlightActors(a,b){return this.int.call({command:l.TileLayer_Actor_Highlight,data:this._fix_highlight_actors_data(a)},b)}stopHighlightActors(a,b){let c=!a;"function"==typeof a&&(b=a,c=!0);return c?this.int.call0(l.TileLayer_Actor_StopHightlight,b):this.int.call({command:l.TileLayer_Actor_Unhighlight,data:this._fix_highlight_actors_data(a)},b)}_fix_highlight_actors_data(a){if(S(a))console.error("\u53c2\u6570\u4e0d\u80fd\u4e3a\u7a7a!");
else{var b=[];if(a instanceof Array)for(let c=0;c<a.length;c++){let d=new fa(a[c].id,a[c].objectIds);b.push(d)}else a=new fa(a.id,a.objectIds),b.push(a);return b}}stopHighlightAllActors(a){return this.int.call0(l.TileLayer_Actor_StopHightlight,a)}showAllActors(a,b){return this.int.call({command:l.TileLayer_Actor_ShowAll,ids:I(a)},b)}hideAllActors(a,b){return this.int.call({command:l.TileLayer_Actor_HideAll,ids:I(a)},b)}setStyle(a,b,c,d,e,g,h,q){return this.int.call({command:l.TileLayer_SetStyle,ids:I(a),
style:b,color:C(c),saturation:d,brightness:e,contrast:g,contrastbase:h},q)}setHeatMapStyle(a,b,c){return this.int.call({command:l.TileLayer_SetStyle,ids:I(a),style:7,colors:{gradient:!0,invalidColor:[1,1,1,0],colorStops:b}},c)}setCollision(a,b,c,d,e,g){a=I(a);let h=[];for(let q of a)h.push({id:q,enableCollision:b,enableMouseRoma:c,enableFunctionInteract:d,enableCharacterCollision:e});return this.int.call({command:l.TileLayer_SetCollision,data:h},g)}getCollision(a,b){return this.int.call({command:l.TileLayer_GetCollision,
ids:I(a)},b)}addModifiers(a,b){return this.int.call({command:l.TileLayer_Modifier_Add,data:E(a)},b)}addModifierByShapeFile(a,b){return this.int.call({command:l.TileLayer_Modifier_Add,data:E(a)},b)}addModifier(a,b,c,d,e){this.addModifiers([{id:a,tileLayerId:b,coordinates:c,ententBufferSize:d}])}updateModifier(a,b,c,d,e){return this.int.call({command:l.TileLayer_Modifier_Update,data:E([{id:a,tileLayerId:b,coordinates:c,ententBufferSize:d}])},e)}deleteModifier(a,b,c){return this.int.call({command:l.TileLayer_Modifier_Delete,
id:a,tileLayerId:b},c)}clearModifier(a,b){return this.int.call({command:l.TileLayer_Modifier_Clear,ids:I(a)},b)}setViewportVisible(a,b,c){let d=[];d.push({viewportIndex:1,viewportVisible:!!(b&ca.V1)});d.push({viewportIndex:2,viewportVisible:!!(b&ca.V2)});d.push({viewportIndex:3,viewportVisible:!!(b&ca.V3)});d.push({viewportIndex:4,viewportVisible:!!(b&ca.V4)});return this.int.call({command:l.TileLayer_SetViewportVisible,id:a,data:d},c)}getObjectIDs(a,b){return this.int.call({command:l.TileLayer_GetObjectIDs,
ids:I(a)},b)}getActorInfo(a,b){return this.int.call({command:l.TileLayer_Actor_GetInfo,data:E(a)},b)}addHoleByShapeFile(a,b){return this.int.call({command:l.TileLayer_CutPolygon_Add,data:E(a)},b)}addHole(a,b){return this.int.call({command:l.TileLayer_CutPolygon_Add,data:E(a)},b)}updateHole(a,b,c,d,e){return this.int.call({command:l.TileLayer_CutPolygon_Update,data:E({id:a,tileLayerId:b,coordinates:c,isReverseCut:d})},e)}deleteHole(a,b,c){return this.int.call({command:l.TileLayer_CutPolygon_Delete,
id:a,tileLayerId:b},c)}clearHole(a,b){return this.int.call({command:l.TileLayer_CutPolygon_Clear,ids:I(a)},b)}setViewHeightRange(a,b,c,d){return this.int.call({command:l.TileLayer_SetViewHeightRange,data:[{id:a,minVisibleHeight:b,maxVisibleHeight:c}]},d)}setPointCloudSize(a,b,c){return this.int.call({command:l.TileLayer_SetPointSize,data:[{tileLayerId:a,size:b}]},c)}enableDecal(a,b){this.setEnableDecal(a,b)}setEnableDecal(a,b){return this.int.call({command:l.TileLayer_SetDecalAttach,data:a},b)}enableImageLayerDecal(a,
b){return this.int.call({command:l.TileLayer_TileLayerReceiveWMTSDecal,data:a},b)}getDBTabID(a,b){return this.int.call({command:l.TileLayer_GetDBTabID,ids:E(a)},b)}createQuery(){return new Xb}query(a,b){const c=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){if(!a||!a.id)return c.int.logWithColor("red","Invalid queryOption!"),Promise.reject();let d=yield c.getDBTabID(a.id);return d.result==va.OK&&d.data&&0!=d.data.length?c.int.sendApiToCS({type:"api",command:"PG_Query",id:d.data[0],
fields:a.fields,where:a.where,limit:a.limit,offset:a.offset},b):(c.int.logWithColor("red","Unable to get dbTabId based on tilelayerId!"),Promise.reject())})}updateRecord(a,b,c,d){const e=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){if(!b||!c)return e.int.logWithColor("red","Invalid parameters!"),Promise.reject();let g=yield e.getDBTabID(a);return g.result==va.OK&&g.data&&0!=g.data.length?e.int.sendApiToCS({type:"api",command:"PG_Update",id:g.data[0],newValMap:b,where:c},d):
(e.int.logWithColor("red","Unable to get dbTabId based on tilelayerId!"),Promise.reject())})}}class Zb extends N{constructor(a){super(a,"VectorField")}add(a,b){this._fixMarkerData(a,"add");return super._add(a,b)}_fixMarkerProperty(a,b){"add"==b&&a.binFilePath&&(a.vetorFieldFilePath=a.binFilePath)}_fixMarkerData(a,b){if(a instanceof Array)for(let c of a)this._fixMarkerProperty(c,b);else this._fixMarkerProperty(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,
b,c,d,e){return super._focus(a,b,c,d,e)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}setViewportVisible(a,b,c){let d=[];d.push({viewportIndex:1,viewportVisible:!!(b&Viewport.V1)});d.push({viewportIndex:2,viewportVisible:!!(b&Viewport.V2)});d.push({viewportIndex:3,viewportVisible:!!(b&Viewport.V3)});d.push({viewportIndex:4,viewportVisible:!!(b&Viewport.V4)});return this.int.call({command:l.VectorField_SetViewPort,id:a,data:d},c)}}class $b extends N{constructor(a){super(a,
"Vehicle")}add(a,b){this._fixVehicleData(a);return super._add(a,b)}_fixVehicleData(a){if(a instanceof Array)for(let b of a)this._fixVehicleProperty(b);else this._fixVehicleProperty(a)}_fixVehicleProperty(a){0<a.colorType?a.initFunctionInfos=[{functionName:"setVehicleColor",parameters:[{paramType:2,paramValue:a.colorType}]}]:a.colorType=0}update(a,b){this._fixVehicleData(a);return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,d,e,g,h){return this.int.call({command:l.Vehicle_Focus,
ids:E(a),distance:c,flyTime:d,rotation:e,distanceRotation:g,followEnabled:b},h)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}setWayPoint(a,b){return this.int.call({command:l.Vehicle_AddWayPoints,data:E(a)},b)}moveTo(a,b){return this.int.call({command:l.Vehicle_MoveTo,data:E(a)},b)}start(a,b){if(S(a))console.error("\u53c2\u6570\u4e0d\u80fd\u4e3a\u7a7a!");else{if(0<=a.timeStamp)a.active=!0;else if(a instanceof Array)for(let c of a)c.active=!0;else{console.error("\u53c2\u6570\u975e\u6cd5!");
return}return this.int.call({command:l.Vehicle_Update,data:E(a)},b)}}pause(a,b){a=this._fixIds(a,!1);if(!S(a))return this.int.call({command:l.Vehicle_Update,data:a},b)}resume(a,b){a=this._fixIds(a,!0);if(!S(a))return this.int.call({command:l.Vehicle_Update,data:a},b)}stop(a,b){a=this._fixIds(a,!1);if(!S(a))return this.int.call({command:l.Vehicle_Update,data:a},b)}_fixIds(a,b){let c=[];if(S(a))console.error("\u53c2\u6570\u4e0d\u80fd\u4e3a\u7a7a!");else{if(a instanceof Array){let d=!1;for(let e of a){if("string"!=
typeof e){d=!0;break}c.push({id:e,active:b})}if(d){console.error("\u53c2\u6570\u975e\u6cd5!");return}return c}if("string"!==typeof a||S(a))console.error("\u53c2\u6570\u975e\u6cd5!");else return c.push({id:a,active:b}),c}}callBatchFunction(a,b){return this.int.call({command:l.Vehicle_CallBatchFunction,data:E(a)},b)}}class ac extends N{constructor(a){super(a,"VideoProjection","frustumColor")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,
...
"distance",b,c)}setDepthCulling(a,b,c){return super._updateOneProp(a,"depthCulling",b,c)}setFrustumColor(a,b,c){return super._updateOneProp(a,"frustumColor",b,c)}}class bc extends N{constructor(a){super(a,"WaterFlowField")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,d,e){return super._focus(a,b,c,d,e)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,
b)}setViewportVisible(a,b,c){let d=[];d.push({viewportIndex:1,viewportVisible:!!(b&Viewport.V1)});d.push({viewportIndex:2,viewportVisible:!!(b&Viewport.V2)});d.push({viewportIndex:3,viewportVisible:!!(b&Viewport.V3)});d.push({viewportIndex:4,viewportVisible:!!(b&Viewport.V4)});return this.int.call({command:l.WaterFlowField_SetViewPort,id:a,data:d},c)}}class cc extends N{constructor(a){super(a,"WaterMesh","waterColor")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,
...
"waterColor",b,c)}setWaterSpeed(a,b,c){return super._updateOneProp(a,"waterSpeed",b,c)}setWaterUVRepeat(a,b,c){return super._updateOneProp(a,"waterUVRepeat",b,c)}setWaterDirection(a,b,c){return super._updateOneProp(a,"waterDirection",b,c)}setWaterWaveScale(a,b,c){return super._updateOneProp(a,"waveScale",b,c)}}var Ea="en",wa={},Fa={VersionMismatch:["\u8b66\u544a\uff1a\n--------------------------------------------------\n    ac.min.js\u6587\u4ef6\u7248\u672c\uff08{0}\uff09\u548c\u4e91\u6e32\u67d3\u670d\u52a1\u5668\u7248\u672c\uff08{1}\uff09\u4e0d\u4e00\u81f4\uff0c\n    \u53ef\u80fd\u9020\u6210\u63a5\u53e3\u8c03\u7528\u9519\u8bef\u6216\u5d29\u6e83\uff0c\u8bf7\u786e\u8ba4!",
...
H.setLanguage=a=>{Ea="zh"===a?"zh":"en";wa={};a="zh"==Ea;for(let b in Fa){let c=Fa[b];wa[b]=a?c[0]:c[1]}for(let b of H.onLanguageChangedCallbacks)"function"==typeof b&&b()};H.getString=a=>wa[a];class sa{static valid(){return"object"==typeof ue&&"object"==typeof ue.internal}static _check(){if(!this.valid())throw"This method must be called on the WebUI page or Marker pop-up page!";}static execute(a){this._check();ue.internal.execute(a)}static getViewportSize(){this._check();return ue.internal.execute("viewportSize")}static setData(a,
b){this._check();ue.internal.execute("setItem",a,b)}static getData(a){this._check();return ue.internal.execute("getItem",a)}static showTickWindow(a){this._check();return ue.internal.showtickwindow(a)}static close(){this._check();return ue.internal.closewindow()}static postEvent(a){this._check();ue.internal.postevent(a)}}"object"==typeof window&&(window.FdExternal=sa);class dc{constructor(a){this.int=a;this._useOldDataFormat=!1}useOldDataFormat(a){this._useOldDataFormat=a||!0}get(a){return this.int.call0(l.Camera_GetCamera,
a)}_setByArray(a,b,c){return this.set(a[0],a[1],a[2],a[3],a[4],b,c)}_setByObject(a,b,c){return this.set(a.x,a.y,a.z,a.pitch,a.yaw,b,c)}set(a,b,c,d,e,g,h){if(a instanceof Array&&5<=a.length)return this._setByArray(a,b,c);if("object"==typeof a&&a.hasOwnProperty("x"))return this._setByObject(a,b,c);"function"==typeof g&&(h=g,g=void 0);if(this._useOldDataFormat){let q=d;d=e;e=q}return this.int.call({command:l.Camera_Set,coordinate:[a,b,c],pitch:d||0,yaw:e||0,flyTime:g},h)}lookAt(a,b,c,d,e,g,h,q){"function"==
typeof h&&(q=h,h=void 0);if(this._useOldDataFormat){let k=e;e=g;g=k}return this.int.call({command:l.Camera_Set,coordinate:[a,b,c],distance:d,pitch:e||0,yaw:g||0,flyTime:h},q)}lookAtBBox(a,b,c,d,e){"function"==typeof d&&(e=d,d=void 0);if(this._useOldDataFormat){let g=b;b=c;c=g}return this.int.call({command:l.Camera_LookAtBBox,bbox:a,pitch:b||0,yaw:c||0,flyTime:d},e)}playAnimation(a,b){return this.int.call({command:l.Camera_PlayAnimation,id:a},b)}stopAnimation(a){return this.int.call0(l.Camera_StopAnimation,
a)}pauseAnimation(a){return this.int.call0(l.Camera_PauseAnimation,a)}resumeAnimation(a){return this.int.call0(l.Camera_ResumeAnimation,a)}getAnimationList(a){return this.int.call0(l.Camera_GetAnimationList,a)}getAnimationImage(a,b){return this.int.call({command:l.Camera_GetAnimationImage,name:a},b)}moveForward(a){return this.int.call({command:l.Camera_Move,moveForward:!0},a)}moveBackward(a){return this.int.call({command:l.Camera_Move,moveBackward:!0},a)}moveLeft(a){return this.int.call({command:l.Camera_Move,
moveLeft:!0},a)}moveRight(a){return this.int.call({command:l.Camera_Move,moveRight:!0},a)}moveUp(a){return this.int.call({command:l.Camera_Move,moveUp:!0},a)}moveDown(a){return this.int.call({command:l.Camera_Move,moveDown:!0},a)}turnLeft(a){return this.int.call({command:l.Camera_Move,turnLeft:!0},a)}turnRight(a){return this.int.call({command:l.Camera_Move,turnRight:!0},a)}turnUp(a){return this.int.call({command:l.Camera_Move,turnUp:!0},a)}turnDown(a){return this.int.call({command:l.Camera_Move,turnDown:!0},
a)}stop(a){return this.int.call({command:l.Camera_Move,stop:!0},a)}getEulerAngle(a,b){const c=360/(2*Math.PI);let d=b[0]-a[0],e=b[1]-a[1];return[Math.atan2(b[2]-a[2],Math.sqrt(d*d+e*e))*c,Math.atan2(d,e)*c-90,0]}lockByBBox(a,b){return this.int.call({command:l.Camera_LockBBox,bbox:a},b)}unlock(a){return this.int.call({command:l.Camera_UnLockBBox},a)}flyAround(a,b,c,d,e){return this.int.call({command:l.Camera_FlyAround,coordinate:a,rotation:b||[0,90,0],distance:c||1E3,time:d||10},e)}enterWorld(a){return this.int.call({command:l.Camera_ExitWorldAnimation},
a)}exitWorld(a){return this.int.call({command:l.Camera_EnterWorldAnimation},a)}}class ec{constructor(a){this.int=a}screen2World(a,b,c){return this.int.call({command:l.Coord_Screen2World,screenPosition:[a,b]},c)}world2Screen(a,b,c,d){return this.int.call({command:l.Coord_World2Screen,worldlocation:[a,b,c]},d)}gcs2pcs(a,b,c){"function"==typeof b&&(c=b);S(b)&&(b=1);if(1==b)return this.int.call({command:l.Coord_GCS2PCS,coordinates:P(a)},c);2==b?this.transform(P(a),2,0,c):3==b?this.transform(P(a),3,0,
c):console.error("\u672a\u77e5\u5750\u6807\u7cfb\u7c7b\u578b")}pcs2gcs(a,b,c){"function"==typeof b&&(c=b);S(b)&&(b=1);if(1==b)return this.int.call({command:l.Coord_PCS2GCS,coordinates:P(a)},c);2==b?this.transform(P(a),0,2,c):3==b?this.transform(P(a),0,3,c):console.error("\u672a\u77e5\u5750\u6807\u7cfb\u7c7b\u578b")}transform(a,b,c,d){return this.int.call({command:l.Coord_Transform,coordinates:P(a),src:b,dest:c},d)}}class fc{constructor(a){this.int=a}start(a){return this.int.call0(l.EditHelper_Start,
a)}cancel(a){return this.int.call0(l.EditHelper_Quit,a)}finish(a,b){return this.int.call({command:l.EditHelper_Finish,withOffset:a||!0},b)}setParam(a,b,c,d){return this.int.call({command:l.EditHelper_SetParam,lineType:a,buildType:b,color:C(c)},d)}}class gc{constructor(a){this.int=a}setVisibility(a,b){return this.int.call({command:l.InfoTree_SetVisibility,layers:E(a)},b)}show(a,b){return this.int.call({command:l.InfoTree_Show,ids:I(a)},b)}hide(a,b){return this.int.call({command:l.InfoTree_Hide,ids:I(a)},
b)}enableXRay(a,b,c){return this.int.call({command:l.InfoTree_EnableXRay,ids:E(a),color:C(b)},c)}disableXRay(a,b){return this.int.call({command:l.InfoTree_DisableXRay,ids:E(a)},b)}showByGroupId(a,b){return this.int.call({command:l.InfoTree_ShowByGroupId,ids:I(a)},b)}hideByGroupId(a,b){return this.int.call({command:l.InfoTree_HideByGroupId,ids:I(a)},b)}highlightByGroupId(a,b){return this.int.call({command:l.InfoTree_HighlightByGroupId,ids:I(a)},b)}deleteByGroupId(a,b){return this.int.call({command:l.InfoTree_DeleteByGroupId,
ids:I(a)},b)}get(a){return this.int.call0(l.InfoTree_Get,a)}focus(a,b){return this.int.call({command:l.InfoTree_Focus,ids:I(a)},b)}}class hc{constructor(a){this.int=a;this.apiVersion="6.1";this.apiVersionServer=""}isApiVersionMatched(){return"1.0.0"==this.apiVersionServer||this.apiVersionServer==this.int.getVersion()}addImageButtons(a,b){return this.int.call({command:l.Misc_AddImageButton,data:E(a)},b)}deleteImageButtons(a,b){return this.int.call({command:l.Misc_DeleteImageButton,ids:I(a)},b)}addAnimatedImageButtons(a,
b){return this.int.call({command:l.Misc_AddAnimatedImageButton,data:E(a)},b)}setApiVersionReceived(a){this.int.onApiVersionReceived=a}playVideo(a,b,c,d,e,g,h){return this.int.call({command:l.Misc_PlayVideo,data:[{id:a.toString(),position:[b,c],size:[d,e],url:g}]},h)}stopPlayVideo(a,b){return this.int.call({command:l.Misc_StopPlayVideo,ids:I(a)},b)}playMovie(a,b,c){"function"==typeof b&&(c=b,b=!1);return this.int.call({command:l.Misc_PlayMovie,loop:b,url:a},c)}stopMovie(a){return this.int.call({command:l.Misc_StopMovie},
...
d.push(`--FormBorderStyle=${b.style}`),b.hasOwnProperty("hideBuffering")&&b.hideBuffering&&d.push("--HideBuffering"),b.hasOwnProperty("maximizeBox")&&b.maximizeBox&&d.push("--MaximizeBox"),b.hasOwnProperty("notTopmost")&&b.notTopmost&&d.push("--NotTopmost"));a=d.join(" ");return this.startProcess("$VlcPlayer",a,!0,c)}stopPlayVideoAlone(a,b){return this.int.test(2,a,b)}setWindowResolution(a,b,c){return this.int.call({command:l.Misc_SetWindowResolution,cx:a,cy:b,mode:0},c)}callBPFunction(a,b){return this.int.call({command:l.Misc_CallBPFunction,
data:E(a)},b)}enterReportMode(a){return this.int.call0(l.Misc_EnterReportMode)}exitReportMode(a){return this.int.call0(l.Misc_ExitReportMode,a)}showAllFoliages(a){return this.int.call0(l.Misc_ShowAllFoliages,a)}hideAllFoliages(a){return this.int.call0(l.Misc_HideAllFoliages,a)}startProcess(a,b,c,d){"function"==typeof c&&(d=c,c=!0);return this.int.call({command:l.Misc_StartProcess,appName:a,commandLine:b,visible:c},d)}enterMultiViewportMode(a,b,c,d){if(null==b||void 0==b)b="#DEA309";if(null==c||void 0==
c)c=2;return this.int.call({command:l.Misc_EnterMultiViewport,type:a,lineColor:C(b),lineThickness:c},d)}exitMultiViewportMode(a){return this.int.call({command:l.Misc_ExitMultiViewport},a)}setActiveViewport(a,b){return this.int.call({command:l.Misc_SetActivateMultiViewport,viewIndex:E(a)},b)}getActiveViewport(a){return this.int.call({command:l.Misc_GetActivateMultiViewport},a)}setMultiviewportInteractSync(a,b){this.setCameraFollow4Viewport(a,b)}setCameraFollow4Viewport(a,b){return this.int.call({command:l.Misc_UpdateMultiViewport,
moverTogether:a},b)}downloadPakFiles(a,b){return this.int.call({command:l.Misc_downloadPakFiles,ids:E(a)},b)}getConvexPolygon(a,b){return this.int.call({command:l.Misc_ConvexHull2D,data:E(a)},b)}getMaterial(a,b){return this.int.call({command:l.Misc_QueryActorOrMaterial,idOrPaths:E(a)},b)}getBPFunction(a,b){return this.int.call({command:l.Misc_QueryActorOrMaterial,idOrPaths:E(a)},b)}reloadPak(a){return this.int.call({command:l.Misc_ReloadPak},a)}download(a,b,c,d){return this.int.call({command:l.Misc_DownLoad,
data:E({url:a,filePath:b,fileName:c})},d)}projectAssetCount(a,b){return this.int.call({command:l.Misc_ProjectAssetCount,type:a},b)}projectAssetCountAll(a){return this.int.call({command:l.Misc_ProjectAssetCount,type:0},a)}switchShortcutKey(a,b){return this.int.call({command:l.Misc_SwitchShortcutKey,"switch":a},b)}startPolygonClip(a,b,c){return this.int.tools.startPolygonClip(a,b,c)}stopClip(a){return this.int.tools.stopClip(a)}playAnimation(a,b){return this.int.camera.playAnimation(a,b)}stopAnimation(a){return this.int.camera.stopAnimation(a)}setDateTime(a,
b,c,d,e,g,h){return this.int.weather.setDateTime(a,b,c,d,e,g,h)}setQueryToolState(a,b){return this.int.call({"c.ommand":l.Settings_SetMousePickMask,mouseClick:a},b)}setCampassVisible(a,b){return this.int.settings.setCampassVisible(a,b)}setMainUIVisibility(a,b){return this.int.settings.setMainUIVisibility(a,b)}setMousePickMask(a,b){return this.int.settings.setMousePickMask(a,b)}}class ic{constructor(a){this.int=a}setMapMode(a,b,c){b=b||{};return this.int.call({command:l.Settings_SetMapMode,mode:a,
serviceType:b.serviceType||0,coordType:b.coordType||0,mapPoint:b.mapPoint||[0,0],longitude:b.longitude||0,latitude:b.latitude||0,cache:b.cache||":memory:",style:b.style||"mapbox://styles/mapbox/streets-v10",groundHeight:b.groundHeight||0,renderMode:b.renderMode||0,decalMode:b.decalMode||1,serverURL:b.serverURL,coordOrder:b.coordOrder,maxLevel:b.maxLevel},c)}getMapMode(a){return this.int.call0(l.Settings_GetMapMode,a)}setWMTSLayerVisible(a,b){this.setwmtsLayerVisible(a,b)}setwmtsLayerVisible(a,b){return this.int.call({command:l.Settings_SetWMTSLayerVisible,
data:E(a)},b)}setWMTSLayerOpacity(a,b){return this.int.call({command:l.Settings_SetWMTSLayerOpacity,data:E(a)},b)}setMapURL(a,b){return this.int.call({command:l.Settings_SetMapURL,url:a},b)}highlightColor(a,b){return this.setHighlightColor(a,b)}setHighlightColor(a,b){return this.int.call({command:l.Settings_SetHighlightColor,color:C(a)},b)}setFovX(a,b){return this.int.call({command:l.Settings_SetFovX,value:a},b)}setOceanColor(a,b){return this.int.call({command:l.Settings_SetOceanColor,color:C(a)},
b)}setEnableInteract(a,b){return this.int.call({command:l.Settings_SetEnableInteract,enableInteract:a},b)}setInteractiveMode(a,b){return this.int.call({command:l.Settings_SetInteractiveMode,mode:a},b)}setCharacterRoaming(a,b,c,d){return this.int.call({command:l.Settings_SetInteractiveMode,mode:1,location:a,rotation:b,targetArmLength:c},d)}getInteractiveMode(a){return this.int.call({command:l.Settings_GetInteractiveMode},a)}setCampassVisible(a,b){return this.int.call({command:l.Settings_SetCampassVisible,
visible:a},b)}setCampassPosition(a,b,c){return this.int.call({command:l.Settings_SetCampassPosition,position:[a,b]},c)}setMainUIVisibility(a,b){return this.int.call({command:l.Settings_SetMainUIVisibility,visible:a},b)}setMousePickMask(a,b){let c=!1,d=!1,e=!1;a&ra.MouseClick&&(c=!0);a&ra.MouseMove&&(d=!0);a&ra.MouseHover&&(e=!0);return this.int.call({command:l.Settings_SetMousePickMask,mouseClick:c,mouseMove:d,mouseHover:e},b)}setTerrainAlpha(a,b){return this.int.call({command:l.Settings_SetTerrainAlpha,
alpha:a},b)}setEnableCameraMovingEvent(a,b,c){S(b)&&(b=20);return this.int.call({command:l.Settings_EnableCameraMovingEvent,bEnable:a,monitorThreshold:b},c)}setLabelLayer(a,b){return this.int.call({command:l.VTPKService_Set,vtpk:a},b)}getLabelLayer(a){return this.int.call({command:l.VTPKService_Get},a)}removeLabelLayer(a){return this.int.call({command:l.VTPKService_Set,vtpk:""},a)}setRenderedCursorVisible(a,b){this.setCursorAutoSync(a,b)}setCursorAutoSync(a,b){return this.int.call({command:l.Settings_CursorAutoSync,
useSoftwareCursor:a},b)}setScreenControlsVisible(a,b){return this.int.call({command:l.Settings_SetGameBoardVisible,visible:a},b)}getProjectWKT(a){return this.int.call({command:l.Settings_GetWKT},a)}setCharacterRotation(a,b){return this.int.call({command:l.Settings_SetCharacterRotation,rotation:a},b)}setGroundHeight(a,b){this.setGlobalHeight(a,b)}setGlobalHeight(a,b){return this.int.call({command:l.Settings_Update,height:a},b)}setLabelLayerScale(a,b){return this.int.call({command:l.Settings_Update,
symbolSize:a},b)}setImageLayerEnableDecal(a,b){return this.int.call({command:l.Settings_Update,receiveDecalMode:a},b)}}class jc{constructor(a){this.int=a}setReportMode(a,b,c,d){return this.int.call({command:l.Settings_SetReport,alignment:a,playMode:b,moveInOtherView:c},d)}getReportMode(a){return this.int.call({command:l.Settings_GetReport},a)}setControlMode(a,b,c,d,e){return this.int.call({command:l.Settings_SetControl,speed:a,yawSpeed:b,rotateSelf:c,useFemale:d},e)}getControlMode(a){return this.int.call({command:l.Settings_GetControl},
a)}setPostProcessMode(a,b){let c=1E3,d=1E3;0<=a.terrainGlobalAlpha&&1>=a.terrainGlobalAlpha&&(c=1E3*a.terrainGlobalAlpha);0<=a.osgbGlobalAlpha&&1>=a.osgbGlobalAlpha&&(d=1E3*a.osgbGlobalAlpha);return this.int.call({command:l.Settings_SetPostProcess,globalIllumination:a.globalIllumination,chromaticAberration:a.chromaticAberration,ambientRadius:a.ambientRadius,ambientFadeDistance:a.ambientFadeDistance,exposureEnabled:a.exposureEnabled,exposureCompensation:a.exposureCompensation,depthFiethSwitch:a.depthFiethSwitch,
...
postProcessEffects:a.postProcessEffects,dofMode:a.dofMode,wireThickness:a.wireThickness,receiveDecalMode:a.receiveDecalMode},b)}getPostProcessMode(a){return this.int.call({command:l.Settings_GetPostProcess},a)}setCameraMode(a,b,c,d,e){d&&"function"==typeof d&&(e=d);return this.int.call({command:l.Settings_SetCamera,nearClipPlane:a,fovH:b,minCamHeight:c,maxCamHeight:d},e)}getCameraMode(a){return this.int.call({command:l.Settings_GetCamera},a)}setMapMode(a,b,c){b=b||{};return this.int.call({command:l.Settings_SetMapMode,
mode:a,serviceType:b.serviceType||0,coordType:b.coordType||0,mapPoint:b.mapPoint||[0,0],longitude:b.longitude||0,latitude:b.latitude||0,cache:b.cache||":memory:",style:b.style||"mapbox://styles/mapbox/streets-v10",groundHeight:b.groundHeight||0,renderMode:b.renderMode||0,decalMode:b.decalMode||1,serverURL:b.serverURL,coordOrder:b.coordOrder,maxLevel:b.maxLevel},c)}getMapMode(a){return this.int.call0(l.Settings_GetMapMode,a)}}class kc{constructor(a){this.int=a}startPolygonClip(a,b,c){return this.int.call({command:l.Tools_StartPolygonClip,
data:E({id:"0",coordinates:K(a),toggleImageCut:b})},c)}startPlaneClip(a,b,c,d,e){return this.int.call({command:l.Tools_StartPlaneClip,location:a,rotation:b,isShowPlane:c,isEdit:d},e)}startVolumeClip(a,b,c,d,e,g){return this.int.call({command:l.Tools_StartVolumeClip,bbox:a,rotation:e,value:b,isShowPlane:c,isEdit:d},g)}updateVolumeClip(a,b,c,d,e,g){return this.int.call({command:l.Tools_UpdateVolumeClip,bbox:a,rotation:e,value:b,isShowPlane:c,isEdit:d},g)}stopClip(a){return this.stopPolygonClip(a)}stopPolygonClip(a){return this.int.call0(l.Tools_StopClip,
a)}stopPlaneClip(a){return this.int.call({command:l.Tools_StopPlaneClip},a)}stopVolumeClip(a){return this.int.call({command:l.Tools_StopVolumeClip},a)}setMeasurement(a,b,c){b=b||{};return this.int.call({command:l.Tools_SetMeasurement,type:a,pointSize:b.pointSize,textSize:b.textSize,textColor:C(b.textColor),pointColor:C(b.pointColor),lineColor:C(b.lineColor),areaColor:C(b.areaColor),showCoordinateText:b.showCoordinateText},c)}startMeasurement(a){return this.int.call0(l.Tools_StartMeasurement,a)}stopMeasurement(a){return this.int.call0(l.Tools_StopMeasurement,
a)}lineIntersect(a,b,c){return this.int.call({command:l.Tools_LineIntersect,data:[{start:a,end:b}],highPrecision:!1,returnDetails:!0},c)}linesIntersect(a,b,c,d){return this.int.call({command:l.Tools_LineIntersect,data:E(a),highPrecision:b,returnDetails:c},d)}startGeometryEdit(a,b,c){return this.int.call({command:l.Tools_StartGeometryEdit,id:a,type:b},c)}stopGeometryEdit(a){return this.int.call0(l.Tools_StopGeometryEdit,a)}startSkylineAnalysis(a,b){a=a||{};a.outlineColor&&(a.outlineColor=C(a.outlineColor));
a.sceneColor&&(a.sceneColor=C(a.sceneColor));a.skylineColor&&(a.skylineColor=C(a.skylineColor));a.backgroundColor&&(a.backgroundColor=C(a.backgroundColor));if(a.tileLayers){a.tileLayers=E(a.tileLayers);for(let c of a.tileLayers)c.hasOwnProperty("color")&&(c.color=C(c.color))}a.command=l.Tools_StartSkylineAnalysis;return this.int.call(a,b)}stopSkylineAnalysis(a){return this.int.call0(l.Tools_StopSkylineAnalysis,a)}exportSkyline(a,b,c,d){c=c||{};c.skylineColor&&(c.skylineColor=C(c.skylineColor));c.backgroundColor&&
(c.backgroundColor=C(c.backgroundColor));if(c.tileLayers){c.tileLayers=E(c.tileLayers);for(let e of c.tileLayer)e.hasOwnProperty("color")&&(e.color=C(e.color))}return this.int.call({command:l.Tools_ExportSkyline,path:a,size:b,skylineColor:c.skylineColor,backgroundColor:c.backgroundColor},d)}startViewshedAnalysis(a,b){a=a||{};a.visibleColor&&(a.visibleColor=C(a.visibleColor));a.invisibleColor&&(a.invisibleColor=C(a.invisibleColor));a.command=l.Tools_StartViewshedAnalysis;return this.int.call(a,b)}stopViewshedAnalysis(a){return this.int.call0(l.Tools_StopViewshedAnalysis,
a)}startVisiblityAnalysis(a,b){a=a||{};a.visibleColor&&(a.visibleColor=C(a.visibleColor));a.invisibleColor&&(a.invisibleColor=C(a.invisibleColor));a.command=l.Tools_StartVisiblityAnalysis;return this.int.call(a,b)}stopVisiblityAnalysis(a){return this.int.call0(l.Tools_StopVisiblityAnalysis,a)}startViewDomeAnalysis(a,b){a=a||{};a.visibleColor&&(a.visibleColor=C(a.visibleColor));a.invisibleColor&&(a.invisibleColor=C(a.invisibleColor));a.command=l.Tools_StartViewDomeAnalysis;return this.int.call(a,b)}stopViewDomeAnalysis(a){return this.int.call0(l.Tools_StopViewDomeAnalysis,
a)}startCutFillAnalysis(a,b){a=a||{};a.cutLineColor&&(a.cutLineColor=C(a.cutLineColor));a.fillLineColor&&(a.fillLineColor=C(a.fillLineColor));a.cutPointColor&&(a.cutPointColor=C(a.cutPointColor));a.fillPointColor&&(a.fillPointColor=C(a.fillPointColor));a.gridColor&&(a.gridColor=C(a.gridColor));a.command=l.Tools_StartCutFillAnalysis;return this.int.call(a,b)}stopCutFillAnalysis(a){return this.int.call0(l.Tools_StopCutFillAnalysis,a)}startSunshineAnalysis(a,b){var c=/^(0?[0-9]|1[0-9]|[2][0-3]):(0?[0-9]|[1-5][0-9])$/;
if(null==a||void 0==a)console.error("\u53c2\u6570\u4e0d\u80fd\u4e3a\u7a7a");else{let d=a.startTime,e=a.endTime;if(null==d||""==d||null==e||""==e)console.error("\u65f6\u95f4\u53c2\u6570\u683c\u5f0f\u4e0d\u6b63\u786e");else if(d.match(c)&&e.match(c))if(d.split(":"))if(a.startHour=parseInt(d.split(":")[0]),a.startMinute=parseInt(d.split(":")[1]),e.split(":"))if(a.endHour=parseInt(e.split(":")[0]),a.endMinute=parseInt(e.split(":")[1]),a.startHour>a.endHour)console.error("\u5f00\u59cb\u65f6\u95f4\u4e0d\u80fd\u5927\u4e8e\u7ed3\u675f\u65f6\u95f4");
else{if(a.startHour==a.endHour){if(a.startMinute==a.endMinute){console.error("\u5f00\u59cb\u65f6\u95f4\u4e0d\u80fd\u7b49\u4e8e\u7ed3\u675f\u65f6\u95f4");return}if(a.startMinute>a.endMinute){console.error("\u5f00\u59cb\u65f6\u95f4\u4e0d\u80fd\u5927\u4e8e\u7ed3\u675f\u65f6\u95f4");return}}!S(a.groundElevation)&&za(a.groundElevation)&&(a.undersideHeight=a.groundElevation,delete a.groundElevation);a.command=l.Tools_StartSunshineAnalysis;return this.int.call(a,b)}else console.error("\u53c2\u6570endTime\u65f6\u95f4\u683c\u5f0f\u4e0d\u6b63\u786e");
else console.error("\u53c2\u6570startTime\u65f6\u95f4\u683c\u5f0f\u4e0d\u6b63\u786e");else console.error("\u65f6\u95f4\u53c2\u6570\u683c\u5f0f\u4e0d\u6b63\u786e")}}stopSunshineAnalysis(a){return this.int.call0(l.Tools_StopSunshineAnalysis,a)}startTerrainSlopeAnalysis(a,b){a.command=l.Tools_StartTerrainSlopeAnalysis;a.arrowColor=C(a.arrowColor);return this.int.call(a,b)}stopTerrainSlopeAnalysis(a){return this.int.call0(l.Tools_StopTerrainSlopeAnalysis,a)}startContourLineAnalysis(a,b){a.command=l.Tools_StartContourLineAnalysis;
a.contourLineColor=C(a.contourLineColor);return this.int.call(a,b)}stopContourLineAnalysis(a){return this.int.call0(l.Tools_StopContourLineAnalysis,a)}startFloodFill(a,b){a=a||{};a.color&&(a.color=C(a.color));a.command=l.Tools_StartFloodFill;return this.int.call(a,b)}stopFloodFill(a){return this.int.call0(l.Tools_StopFloodFill,a)}replaceTextureByVideo(a,b,c){return this.int.call({command:l.Tools_ReplaceTexture,texturePackage:a,newTexture:b,type:1},c)}replaceTextureByImage(a,b,c){return this.int.call({command:l.Tools_ReplaceTexture,
texturePackage:a,newTexture:b,type:2},c)}replaceTextureByUrl(a,b,c){return this.int.call({command:l.Tools_ReplaceTexture,texturePackage:a,newTexture:b,type:3},c)}restoreTexture(a,b){return this.int.call({command:l.Tools_RestoreTexture,ids:E(a)},b)}showPanel(a,b,c){this.showAnalysisPanel(a,b,c)}hidePanel(a){this.hideAnalysisPanel(a)}showAnalysisPanel(a,b,c){return this.int.call({command:l.Tools_AnalysisPopupAttributes,type:a,position:b},c)}hideAnalysisPanel(a){return this.int.call({command:l.Tools_AnalysisCloseAttributes},
a)}showUIPanel(a,b,c){return this.int.call({command:l.Tools_FunctionNavBar,type:a,position:b},c)}hideUIPanel(a,b){return this.int.call({command:l.Tools_HideFunctionNavBar,type:a},b)}getUIPanel(a,b){return this.int.call({command:l.Tools_GetFunctionNavBar,type:a},b)}}class lc{constructor(a){this.int=a}getParams(a){return this.int.call0(l.Weather_GetParams,a)}_setParam(a,b){return this.int.call({command:l.Weather_SetParams,data:a},b)}setDateTime(a,b,c,d,e,g,h){return this.int.call({command:l.Weather_SetDate,
year:a,month:b,day:c,hour:d,minute:e,daynightLoop:g},h)}getDateTime(a){return this.int.call0(l.Weather_GetDate,a)}simulateTime(a,b,c,d){let e=0,g=0,h=0,q=0;a instanceof Array?(0<a.length&&(e=a[0]),1<a.length&&(g=a[1])):e=parseInt(a);b instanceof Array?(0<b.length&&(h=b[0]),1<b.length&&(q=b[1])):h=parseInt(b);return this.int.call({command:l.Weather_SimulateTime,startHour:e,startMinute:g,endHour:h,endMinute:q,duration:c},d)}setCloudThickness(a,b){return this.int.call({command:l.Weather_SetParams,lowCloudHeight:a},
b)}setCloudDensity(a,b){return this.int.call({command:l.Weather_SetParams,lowCloudDensity:a},b)}setCloudHeight(a,b){return this.int.call({command:l.Weather_SetParams,cloudHeight:a},b)}setRainParam(a,b,c,d,e,g,h){d&&"function"==typeof d&&(h=d);return this.int.call({command:l.Weather_SetParams,rainSnow:1,rainSnowStrength:a,rainSnowSpeed:b,raindropSize:c,rainSnowSize:c||null,rainSnowCamMotionAlignmentScale:e||null,rainSnowColor:d||null,rainSnowOvercastStrength:g||null},h)}setSnowParam(a,b,c,d,e,g,h){d&&
"function"==typeof d&&(h=d);return this.int.call({command:l.Weather_SetParams,rainSnow:2,rainSnowStrength:a,rainSnowSpeed:b,snowflakeSize:c,rainSnowSize:c||null,rainSnowCamMotionAlignmentScale:e||null,rainSnowColor:d||null,rainSnowOvercastStrength:g||null},h)}disableRainSnow(a){return this.int.call({command:l.Weather_SetParams,rainSnow:0},a)}setFogParam(a,b,c,d,e,g){return this.int.call({command:l.Weather_SetParams,fogDensity:a,fogColor:b,fogHeightFalloff:c,fogStartDistance:d,fogOpacity:e},g)}setSunIntensity(a,
b){return this.int.call({command:l.Weather_SetParams,sunIntensity:a},b)}setMoonIntensity(a,b){return this.int.call({command:l.Weather_SetParams,moonIntensity:a},b)}setAmbientLightIntensity(a,b){return this.int.call({command:l.Weather_SetParams,ambientLightIntensity:a},b)}setTemperature(a,b){return this.int.call({command:l.Weather_SetParams,temperature:a},b)}setShadowIntensity(a,b){return this.int.call({command:l.Weather_SetParams,shadowIntensity:a},b)}setShadowQuality(a,b){return this.int.call({command:l.Weather_SetParams,
shadowQuality:a},b)}setShadowDistance(a,b){return this.int.call({command:l.Weather_SetParams,shadowDistance:a},b)}setDarkMode(a,b){return this.int.call({command:l.Weather_SetParams,darkMode:!!a},b)}setSunSize(a,b){return this.int.call({command:l.Weather_SetParams,sunSize:a},b)}setMoonSize(a,b){return this.int.call({command:l.Weather_SetParams,moonSize:a},b)}setSkyVisibleMaxHeight(a,b){return this.int.call({command:l.Weather_SetParams,atmosphereVisibleHeight:a||1E5},b)}}var xa=null;class ta{constructor(a,
b){a||(xa=this);this.isReady=!1;this.options=b||{};(this.player=this.options.player)||H.setLanguage();"function"==typeof ta.__onApiConstructed&&ta.__onApiConstructed(this);if(this.isCalledInCEF=sa.valid())this.isReady=this.isConnected=!0;this.callbackMap=new Map;this.websocket=null;this.callbackIndex=0;this.tickMarkerId="___tick_delegate_marker___";!this.player&&a&&(this.url=`ws://${a}`,this.connectWebSocket());this.apiQueue=new nb(c=>this.sendApi(c))}getPlayer(){return this.player}setHost(a,b){this.url=
...
a}destroy(){this.isDestroyed=!0;this.player&&this.player.destroy();this.websocket&&(this.websocket.close(),this.websocket=null)}reset(a,b){return this.call({command:l.Reset,resetType:a||Da.ClearObjects},b)}saveProject(a){return this.call0(l.SaveProject,a)}registerTick(a,b,c){b=b||{};"__execute__"!=a&&(b.func="tick");this.call({command:l.RegisterJsCommunication,id:this.tickMarkerId,url:a,func:b.func,x:b.x||4,y:b.y||4,width:b.width||400,height:b.height||300,visible:b.visible||!1},c)}removeTick(a){this.call({command:l.UnRegisterJsCommunication,
ids:[this.tickMarkerId]},a)}showTickWindow(a,b){this.isCalledInCEF?sa.showTickWindow(a):a?this.registerTick("__show__",{},b):this.registerTick("",{},b)}executeJsInTickPage(a,b){this.registerTick("__execute__",{func:a},b)}getVersion(){return"6.1.0807.18518"}checkApiReady(){if(!this.isReady)throw console.error("The interface call is not ready!"),"The interface call is not ready!";return!0}setEnableAliases(){this.ct=this.cameraTour;this.tl=this.tileLayer;this.ctag=this.customTag;this.hdm2=this.hydrodynamicModel2;
...
this.eh=this.editHelper;this.sp=this.settingsPanel}get camera(){if(!this.checkApiReady())return null;this._camera||(this._camera=new dc(this));return this._camera}get coord(){if(!this.checkApiReady())return null;this._coord||(this._coord=new ec(this));return this._coord}get infoTree(){if(!this.checkApiReady())return null;this._infoTree||(this._infoTree=new gc(this));return this._infoTree}get cameraTour(){if(!this.checkApiReady())return null;this._cameraTour||(this._cameraTour=new pb(this));return this._cameraTour}get tileLayer(){if(!this.checkApiReady())return null;
this._tileLayer||(this._tileLayer=new Yb(this));return this._tileLayer}get tag(){if(!this.checkApiReady())return null;this._tag||(this._tag=new Wb(this));return this._tag}get marker(){if(!this.checkApiReady())return null;this._marker||(this._marker=new Kb(this));return this._marker}get marker3d(){if(!this.checkApiReady())return null;this._marker3d||(this._marker3d=new Lb(this));return this._marker3d}get customTag(){if(!this.checkApiReady())return null;this._customTag||(this._customTag=new tb(this));
return this._customTag}get radiationPoint(){if(!this.checkApiReady())return null;this._radiationPoint||(this._radiationPoint=new Sb(this));return this._radiationPoint}get customMesh(){if(!this.checkApiReady())return null;this._customMesh||(this._customMesh=new rb(this));return this._customMesh}get waterMesh(){if(!this.checkApiReady())return null;this._waterMesh||(this._waterMesh=new cc(this));return this._waterMesh}get waterFlowField(){if(!this.checkApiReady())return null;this._waterFlowField||(this._waterFlowField=
new bc(this));return this._waterFlowField}get vectorField(){if(!this.checkApiReady())return null;this._vectorField||(this._vectorField=new Zb(this));return this._vectorField}get hydrodynamicModel2(){if(!this.checkApiReady())return null;this._hydrodynamicModel2||(this._hydrodynamicModel2=new Db(this));return this._hydrodynamicModel2}get hydrodynamicModel(){if(!this.checkApiReady())return null;this._hydrodynamicModel||(this._hydrodynamicModel=new Hb(this));return this._hydrodynamicModel}get finiteElement(){if(!this.checkApiReady())return null;
this._finiteElement||(this._finiteElement=new wb(this));return this._finiteElement}get fluid(){if(!this.checkApiReady())return null;this._fluid||(this._fluid=new yb(this));return this._fluid}get polyline(){if(!this.checkApiReady())return null;this._polyline||(this._polyline=new Rb(this));return this._polyline}get odline(){if(!this.checkApiReady())return null;this._odline||(this._odline=new Nb(this));return this._odline}get polygon3d(){if(!this.checkApiReady())return null;this._polygon3d||(this._polygon3d=
new Qb(this));return this._polygon3d}get polygon(){if(!this.checkApiReady())return null;this._polygon||(this._polygon=new Pb(this));return this._polygon}get heatmap(){if(!this.checkApiReady())return null;this._heatmap||(this._heatmap=new Ab(this));return this._heatmap}get heatmap3d(){if(!this.checkApiReady())return null;this._heatmap3d||(this._heatmap3d=new Bb(this));return this._heatmap3d}get beam(){if(!this.checkApiReady())return null;this._beam||(this._beam=new ob(this));return this._beam}get highlightArea(){if(!this.checkApiReady())return null;
this._highlightArea||(this._highlightArea=new Cb(this));return this._highlightArea}get customObject(){if(!this.checkApiReady())return null;this._customObject||(this._customObject=new sb(this));return this._customObject}get videoProjection(){if(!this.checkApiReady())return null;this._videoProjection||(this._videoProjection=new ac(this));return this._videoProjection}get panorama(){if(!this.checkApiReady())return null;this._panorama||(this._panorama=new Ob(this));return this._panorama}get decal(){if(!this.checkApiReady())return null;
this._decal||(this._decal=new ub(this));return this._decal}get dynamicWater(){if(!this.checkApiReady())return null;this._dynamicWater||(this._dynamicWater=new vb(this));return this._dynamicWater}get floodFill(){if(!this.checkApiReady())return null;this._floodFill||(this._floodFill=new xb(this));return this._floodFill}get cesium3DTileset(){if(!this.checkApiReady())return null;this._cesium3DTileset||(this._cesium3DTileset=new qb(this));return this._cesium3DTileset}get shapeFileLayer(){if(!this.checkApiReady())return null;
this._shapeFileLayer||(this._shapeFileLayer=new Ub(this));return this._shapeFileLayer}get light(){if(!this.checkApiReady())return null;this._light||(this._light=new Jb(this));return this._light}get antenna(){if(!this.checkApiReady())return null;this._antenna||(this._antenna=new Eb(this));return this._antenna}get signalWave(){if(!this.checkApiReady())return null;this._signalWave||(this._signalWave=new Vb(this));return this._signalWave}get river(){if(!this.checkApiReady())return null;this._river||(this._river=
new Tb(this));return this._river}get hydrodynamic1d(){if(!this.checkApiReady())return null;this._hydrodynamic1d||(this._hydrodynamic1d=new Fb(this));return this._hydrodynamic1d}get hydrodynamic2d(){if(!this.checkApiReady())return null;this._hydrodynamic2d||(this._hydrodynamic2d=new Gb(this));return this._hydrodynamic2d}get imageryLayer(){if(!this.checkApiReady())return null;this._imageryLayer||(this._imageryLayer=new Ib(this));return this._imageryLayer}get geoJSONLayer(){if(!this.checkApiReady())return null;
this._geoJSONLayer||(this._geoJSONLayer=new zb(this));return this._geoJSONLayer}get vehicle(){if(!this.checkApiReady())return null;this._vehicle||(this._vehicle=new $b(this));return this._vehicle}get markerLayer(){if(!this.checkApiReady())return null;this._markerLayer||(this._markerLayer=new Mb(this));return this._markerLayer}get misc(){if(!this.checkApiReady())return null;this._misc||(this._misc=new hc(this));return this._misc}get tools(){if(!this.checkApiReady())return null;this._tools||(this._tools=
new kc(this));return this._tools}get settings(){if(!this.checkApiReady())return null;this._settings||(this._settings=new ic(this));return this._settings}get weather(){if(!this.checkApiReady())return null;this._weather||(this._weather=new lc(this));return this._weather}get editHelper(){if(!this.checkApiReady())return null;this._editHelper||(this._editHelper=new fc(this));return this._editHelper}get settingsPanel(){if(!this.checkApiReady())return null;this._settingsPanel||(this._settingsPanel=new jc(this));
return this._settingsPanel}_getCallbackIndex(){return++this.callbackIndex}call0(a,b){return this.call({command:a},b)}call(a,b){if(!this.isConnected)return this.logWithColor("red","Not connected!"),b?void 0:Promise.reject("Not connected!");if(void 0==a.command||a.command==l.None)return this.logWithColor("red","command is undefined or None"),b?void 0:Promise.reject("command is undefined or None");a.timestamp=Date.now();a.callbackIndex=this._getCallbackIndex();a.__command=l[a.command]||"Unknown";a.__version=
this.getVersion();null===b&&(a.__noResponse=!0);let c=a.command+"_"+a.callbackIndex;b&&"function"==typeof b&&(this.callbackMap[c]=b);if(this.isCalledInCEF&&null===b)return delete a.__noResponse,this.callbackMap[c]=null,this.sendApi(a),a;let d=JSON.stringify(a);this.log("");this.logWithColor("RoyalBlue",`Request: ${l[a.command]||"Unknown"}`,!0);this.logWithColor("green","\uff08"+(new Date(a.timestamp)).toLocaleTimeString()+"\uff09");this.logWithColor("gray",`${d}`);if(b||null===b)this.apiQueue.push(a);
else return new Promise(e=>{this.callbackMap[c]=e;this.apiQueue.push(a)})}sendApi(a){this.isCalledInCEF?sa.execute(JSON.stringify(a)):this.player?this.player.sendApi(a):this.sendStringByWS(a)}sendApiToCS(a,b){if(!this.player)return this.logWithColor("red","This method can only be called in the Cloud environment!"),Promise.reject("This method can only be called in the Cloud environment!");a.timestamp=Date.now();a.callbackIndex=this._getCallbackIndex();let c=JSON.stringify(a);this.log("");this.logWithColor("RoyalBlue",
`Request: ${a.command}`,!0);this.logWithColor("green","\uff08"+(new Date(a.timestamp)).toLocaleTimeString()+"\uff09");this.logWithColor("gray",`${c}`);let d=a.command+"_"+a.callbackIndex;if(b&&"function"==typeof b)this.callbackMap[d]=b,this.player.sendApi(a,!0);else return new Promise(e=>{this.callbackMap[d]=e;this.player.sendApi(a,!0)})}sendStringByWS(a){if(a){a=JSON.stringify(a);var b=a.length;if(16777216>=b)this.websocket.send(a);else{var c=Math.ceil(b/16777216),d=[];for(let e=0;e<c;e++)d[e]=(0==
e?"__MI_SECTION_START__":e==c-1?"__MI_SECTION_END__":"__MI_SECTION__")+a.substr(16777216*e,e==c-1?b-16777216*e:16777216);for(let e of d)this.websocket.send(e)}}}viewHome(a){switch(a){case 0:this.savedCamera?this.camera.set(this.savedCamera,0):this.initialCameraPosition&&this.camera.set(this.initialCameraPosition,0);break;case 1:this.savedCamera=null;this.viewHome(0);break;case 2:this.camera.get(b=>this.savedCamera=b.camera)}}onReady(){this.isReady=!0;if("function"==typeof this.options.onReady)this.options.onReady();
this.call({command:l.Misc_GetVersion});if(this.player)this.player.onApiReady()}log(a,b,c){if("function"==typeof this.options.onLog)this.options.onLog(a,b,c)}logWithColor(a,b,c){this.log(b,c,a)}onConnectionOpen(){this.isConnected=!0;this.logWithColor("blue","Connected!")}onConnectionClose(a){this.isConnected=!1;this.logWithColor("red",`Connection closed! code: ${a.code||"-"}, reason: ${1006==a.code?H.getString("Disconnect"):a.reason||a.message||"-"}`);this.log("");this.logWithColor("SpringGreen","Reconnecting...");
this.isDestroyed||this.player||this.connectWebSocket()}onConnectionError(a){console.error("WebSocket error observed")}onConnectionMessage(a,b){a=a.replace(/~!@~!@~!@/g,'\\"');this.log("");let c=null;try{c=JSON.parse(a)}catch(e){this.isCalledInCEF?(document.writeln(e.message),document.writeln("<hr>"),document.writeln(a)):(console.error(e.message),this.log("Response: [Unknown]"));return}if(c.command==l.Misc_GetVersion){this.misc.apiVersionServer=c.version;if(!this.misc.isApiVersionMatched()){var d=
H.getString("VersionMismatch").format(this.getVersion(),this.misc.apiVersionServer);console.warn(d);"undefined"!=typeof window&&alert(d)}if("function"==typeof this.options.onApiVersion)this.options.onApiVersion(this.misc.apiVersionServer)}if(c.command){"string"==typeof c.command?d=c.command:(this.apiQueue.callNext(c.callbackIndex),d=l[c.command]||"Unknown");let e=Date.now()-c.timestamp;this.logWithColor("RoyalBlue",`Response: ${d}`,!0);this.logWithColor("green",` (${H.getString("TimeConsuming")}${e}ms)`);
this.logWithColor("gray",`${H.getString("RequestTime")}${(new Date(c.timestamp)).toLocaleTimeString()}`,!0);this.logWithColor("gray",`  ${H.getString("ResponseTime")}${(new Date(Date.now())).toLocaleTimeString()}`,!0);this.logWithColor("gray",`  ${H.getString("MessageLength")}${a.length}`);a=c.command+"_"+c.callbackIndex;(d=this.callbackMap[a])?(d(c),delete this.callbackMap[a]):null===d&&"function"===typeof tick_next&&tick_next(c,b)}else if(c.eventtype)if(this.log("Response: Event"),"CompleteInitialization"==
c.eventtype)this.log("The initialization is complete, now you can call the interfaces in onReady callback function."),this.initialCameraPosition=c.InitialCamera,c.ResourcesPath&&(this.resourcesPath=c.ResourcesPath,this.log("ResourcesPath:"+this.resourcesPath)),this.onReady();else if("NodeConfiguration"==c.eventtype)this.resourcesPath=c.ResourcesPath,this.log("ResourcesPath:"+this.resourcesPath);else if("MainThreadBusy"==c.eventtype)this.apiQueue.onMainThreadBusy(c),this.player&&this.player.onMainThreadBusy(c);
else{if("function"==typeof this.options.onEvent)this.options.onEvent(c)}else this.log("Response: [Unknown]");b=JSON.stringify(c,(e,g)=>g instanceof Array?JSON.stringify(g):g,"\t").replace(/"\[/g,"[").replace(/\]"/g,"]").replace(/\\"/g,'"').replace(/""/g,'"');this.logWithColor("gray",b)}quit(){return this.call0(l.Quit)}test(a,b,c){return this.call({command:l.SimulateTest__,type:a,int32Val:b},c)}}const U={WS_Disconnected:0,WS_Connecting:1,WS_Connected:2,RTC_Opened:3,Video_LoadedMetaData:4,OnReady:5},
ba={StartingProcess:0,CheckingBusy:1,ConfirmBusy:2,ProcessStartFailed:3,ProcessStarted:4,LoadingProject:5,ProjectLoaded:6,UserAccessDenied:7,CheckingLicense:8};class mc{constructor(){"undefined"!=typeof navigator&&(this.isUnix="Mac68K"==navigator.platform||"MacPPC"==navigator.platform||"Macintosh"==navigator.platform||"MacIntel"==navigator.platform||-1!=navigator.platform.indexOf("Linux"),this.isChrome=-1!=navigator.userAgent.indexOf("Chrome"),this.isMobileDevice=/Android|Linux|webOS|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent),
this.isIOSDevice=/iPhone|iPad|iPod/i.test(navigator.userAgent),this.isSafari=/Safari/.test(navigator.userAgent)&&!/Chrome/.test(navigator.userAgent),this.isAndroidDevice=/Android/i.test(navigator.userAgent),this.isInWeixinBrowser)}fullscreen(a){a&&(a.requestFullscreen?a.requestFullscreen():a.mozRequestFullScreen?a.mozRequestFullScreen():a.msRequestFullscreen?a.msRequestFullscreen:a.webkitRequestFullscreen&&a.webkitRequestFullscreen())}exitFullscreen(){document.exitFullscreen?document.exitFullscreen():
document.msExitFullscreen||(document.mozCancelFullScreen?document.mozCancelFullScreen():document.webkitCancelFullScreen&&document.webkitCancelFullScreen())}isFullscreen(){return document.fullscreen||document.mozFullScreen||document.webkitIsFullScreen}isFunction(a){return"function"==typeof a}}var R=new mc;const ja={abnormal:1006,invalid_message:1008,out_of_control:4E3,instance_disconnected:4001,instance_not_found:4002,instance_start_failed:4003,webrtc_connection_error:4004,one_client_allowed:4005,
timeout:4006,iid_required:4007,locked:4008,invalid_project:4009,no_free_instance:4010,kicked:4100,syncing_data:4101,instance_killed_by_user:4102,invalid_password:4103,nodeservice_stopped:4105,instance_is_busy:4107,ip_no_access:4108,unknown_client:4109,num_of_instances_exceeded:4110,instance_not_auth:4111,permission_denied:4112,instance_was_preempted:4113,no_username_provided:4114,user_does_not_exist:4115,not_logged_in:4116};W.EMPTY_OBJECT=Object.freeze({});class la{}la.doParamsCompatibility=a=>{a.apiOptions=
a.apiOptions||{};a.events=a.events||{};a.ui=a.ui||{};"undefined"!=typeof a.showMarker&&(a.showStatus=a.showMarker,delete a.showMarker);"undefined"!=typeof a.actionEventHander&&(a.onaction=a.actionEventHander,delete a.actionEventHander);"undefined"!=typeof a.useBuiltinCursor&&(a.useBuiltinCursors=a.useBuiltinCursor,delete a.useBuiltinCursor);"undefined"!=typeof a.keyEventReceiver&&(a.keyEventTarget=a.keyEventReceiver,delete a.keyEventReceiver);"undefined"!=typeof a.ui.debugTouchPanel&&(a.ui.debugEventsPanel=
a.ui.debugTouchPanel,delete a.ui.debugTouchPanel);var b=(c,d)=>{let e=a[c];e&&(a.events[d]=e,delete a[c])};b("onclose","onConnClose");b("onloaded","onVideoLoaded");b("onvideostatus","onRtcStatsReport");b("onaction","mouseKeyListener");b=(c,d)=>{let e=a.events.mouseKeyListener[c];e&&(a.events.mouseKeyListener[d]=e,delete a.events.mouseKeyListener[c])};a.events.mouseKeyListener&&(b("onmouseenter","onMouseEnter"),b("onmouseleave","onMouseLeave"),b("onmousemove","onMouseMove"),b("onmousedown","onMouseDown"),
b("onmouseup","onMouseUp"),b("onkeydown","onKeyDown"),b("onkeyup","onKeyUp"),b("onkeypress","onKeyPress"));b=(c,d)=>{"undefined"!=typeof a[c]&&(a.ui[d]=a[c],delete a[c])};b("showStartupInfo","startupInfo");b("showStatus","statusButton");b("showFullscreenButton","fullscreenButton");b("showHomeButton","homeButton");b("showTaskList","taskListBar")};la.setDefaultParamValues=a=>{a.disableResizeObserver=W(a.disableResizeObserver,!1);a.enableApiCallLog=W(a.enableApiCallLog,!1);a.receiveRenderEvents=W(a.receiveRenderEvents,
!0);a.registerEvents=W(a.registerEvents,!0);a.keyEventTarget=W(a.keyEventTarget,"video");a.useBuiltinCursors=W(a.useBuiltinCursors,!0);a.ui.startupInfo=W(a.ui.startupInfo,!0);a.ui.statusIndicator=W(a.ui.statusIndicator,!0);a.ui.statusButton=W(a.ui.statusButton,!1);a.ui.fullscreenButton=W(a.ui.fullscreenButton,!1);a.ui.homeButton=W(a.ui.homeButton,!1);a.ui.taskListBar=W(a.ui.taskListBar,1);a.ui.debugEventsPanel=W(a.ui.debugEventsPanel,!1);a.offer=1};la.processParams=a=>{la.doParamsCompatibility(a);
la.setDefaultParamValues(a)};V.prototype.reset=function(){this.reg[0]=1937774191;this.reg[1]=1226093241;this.reg[2]=388252375;this.reg[3]=3666478592;this.reg[4]=2842636476;this.reg[5]=372324522;this.reg[6]=3817729613;this.reg[7]=2969243214;this.chunk=[];this.size=0};V.prototype.strToBytes=function(a){for(var b,c,d=[],e=0;e<a.length;e++){b=a.charCodeAt(e);c=[];do c.push(b&255),b>>=8;while(b);d=d.concat(c.reverse())}return d};V.prototype.write=function(a){a="string"===typeof a?this.strToBytes(a):a;
this.size+=a.length;var b=64-this.chunk.length;if(a.length<b)this.chunk=this.chunk.concat(a);else for(this.chunk=this.chunk.concat(a.slice(0,b));64<=this.chunk.length;)this._compress(this.chunk),this.chunk=b<a.length?a.slice(b,Math.min(b+64,a.length)):[],b+=64};V.prototype.sum=function(a,b){a&&(this.reset(),this.write(a));this._fill();for(a=0;a<this.chunk.length;a+=64)this._compress(this.chunk.slice(a,a+64));if("hex"==b)for(b="",a=0;8>a;a++)b+=this.reg[a].toString(16);else for(b=Array(32),a=0;8>a;a++){var c=
this.reg[a];b[4*a+3]=(c&255)>>>0;c>>>=8;b[4*a+2]=(c&255)>>>0;c>>>=8;b[4*a+1]=(c&255)>>>0;c>>>=8;b[4*a]=(c&255)>>>0}this.reset();return b};V.prototype._compress=function(a){if(64>a)console.error("compress error: not enough data");else{var b=this._expand(a);a=this.reg.slice(0);for(var c=0;64>c;c++){var d=this._rotl(a[0],12)+a[4]+this._rotl(this._t(c),c);d=(d&4294967295)>>>0;d=this._rotl(d,7);var e=(d^this._rotl(a[0],12))>>>0,g=this._ff(c,a[0],a[1],a[2]);g=g+a[3]+e+b[c+68];g=(g&4294967295)>>>0;e=this._gg(c,
a[4],a[5],a[6]);e=e+a[7]+d+b[c];e=(e&4294967295)>>>0;a[3]=a[2];a[2]=this._rotl(a[1],9);a[1]=a[0];a[0]=g;a[7]=a[6];a[6]=this._rotl(a[5],19);a[5]=a[4];a[4]=(e^this._rotl(e,9)^this._rotl(e,17))>>>0}for(b=0;8>b;b++)this.reg[b]=(this.reg[b]^a[b])>>>0}};V.prototype._fill=function(){var a=8*this.size,b=this.chunk.push(128)%64;for(8>64-b&&(b-=64);56>b;b++)this.chunk.push(0);for(b=0;4>b;b++)this.chunk.push(Math.floor(a/4294967296)>>>8*(3-b)&255);for(b=0;4>b;b++)this.chunk.push(a>>>8*(3-b)&255)};V.prototype._expand=
function(a){for(var b=Array(132),c=0;16>c;c++)b[c]=a[4*c]<<24,b[c]|=a[4*c+1]<<16,b[c]|=a[4*c+2]<<8,b[c]|=a[4*c+3],b[c]>>>=0;for(a=16;68>a;a++)c=b[a-16]^b[a-9]^this._rotl(b[a-3],15),c=c^this._rotl(c,15)^this._rotl(c,23),b[a]=(c^this._rotl(b[a-13],7)^b[a-6])>>>0;for(a=0;64>a;a++)b[a+68]=(b[a]^b[a+4])>>>0;return b};V.prototype._rotl=function(a,b){b%=32;return(a<<b|a>>>32-b)>>>0};V.prototype._t=function(a){if(0<=a&&16>a)return 2043430169;if(16<=a&&64>a)return 2055708042;console.error("invalid j for constant Tj")};
V.prototype._ff=function(a,b,c,d){if(0<=a&&16>a)return(b^c^d)>>>0;if(16<=a&&64>a)return(b&c|b&d|c&d)>>>0;console.error("invalid j for bool function FF");return 0};V.prototype._gg=function(a,b,c,d){if(0<=a&&16>a)return(b^c^d)>>>0;if(16<=a&&64>a)return(b&c|~b&d)>>>0;console.error("invalid j for bool function GG");return 0};V.prototype.toArray=function(a,b){for(var c=[],d=0;d<a.length;d++){var e=a[d];b&&(e=b(e));c.push(e)}return c};class nc{constructor(a){this.options=a;this.checkParamsMap=new Map}resetInteractTimestamp(a){this.timeOfLastInteraction=
a}connect(a){window.WebSocket=window.WebSocket||window.MozWebSocket;window.WebSocket?(this.websocket=new WebSocket(a),this.websocket.onopen=()=>{if(this.options.onopen)this.options.onopen();this.timerPing=setInterval(()=>{this.timeOfLastInteraction&&this.send({type:"ping",time:this.timeOfLastInteraction})},3E3);"string"==typeof this.options.customString&&this.send({type:"customString",content:this.options.customString})},this.websocket.onmessage=b=>{if(b=JSON.parse(b.data)){switch(b.type){case "checkParamsResult":this.onCheckParamsResponse(b);
...
" "}`);this.isOpened()&&(this.websocket.close(a),this.websocket=null)}sendReady(){this.send({type:"ready"})}sendCustomString(a){"string"==typeof a&&this.send({type:"customString",content:a})}sendCandidate(a){a.candidate&&a.candidate.candidate&&this.send({type:"iceCandidate",candidate:a.candidate})}sendOffer(a,b){this.send({type:"offer",sdp:a,hasVideo:b})}sendApi(a){"api"==(null==a?void 0:a.type)?this.send(a):console.error("Invalid API call format!")}sendInstancePassword(a){"string"==typeof a&&0<a.length&&
this.send({type:"inst_sec",p:Oa(a)})}updateParams(a){this.send({type:"updateParams",data:a})}checkParams(a){a.timestamp=Date.now();return new Promise(b=>{this.checkParamsMap[a.timestamp]=b;this.send({type:"checkParams",data:a});this.timerOfCheckParams=setTimeout(()=>{let c=this.checkParamsMap[a.timestamp];c&&(delete this.checkParamsMap[a.timestamp],c(null))},1E3)})}onCheckParamsResponse(a){let b=this.checkParamsMap[a.timestamp];b&&(clearTimeout(this.timerOfCheckParams),delete this.checkParamsMap[a.timestamp],
b(a))}}(function(a){"object"===typeof u&&"undefined"!==typeof module?module.exports=a():"function"===typeof define&&define.amd?define([],a):("undefined"!==typeof window?window:"undefined"!==typeof global?global:"undefined"!==typeof self?self:this).adapter=a()})(function(){return function(){function a(b,c,d){function e(q,k){if(!c[q]){if(!b[q]){var f="function"==typeof require&&require;if(!k&&f)return f(q,!0);if(g)return g(q,!0);k=Error("Cannot find module '"+q+"'");throw k.code="MODULE_NOT_FOUND",
k;}k=c[q]={exports:{}};b[q][0].call(k.exports,function(m){return e(b[q][1][m]||m)},k,k.exports,a,b,c,d)}return c[q].exports}for(var g="function"==typeof require&&require,h=0;h<d.length;h++)e(d[h]);return e}return a}()({1:[function(a,b,c){a=(0,a("./adapter_factory.js").adapterFactory)({window:"undefined"==typeof window?{}:window});b.exports=a},{"./adapter_factory.js":2}],2:[function(a,b,c){function d(m){if(m&&m.__esModule)return m;var t={};if(null!=m)for(var x in m)Object.prototype.hasOwnProperty.call(m,
x)&&(t[x]=m[x]);t.default=m;return t}Object.defineProperty(c,"__esModule",{value:!0});c.adapterFactory=function(){var m=(0<arguments.length&&void 0!==arguments[0]?arguments[0]:{}).window,t=1<arguments.length&&void 0!==arguments[1]?arguments[1]:{shimChrome:!0,shimFirefox:!0,shimEdge:!0,shimSafari:!0},x=e.log,r=e.detectBrowser(m),y={browserDetails:r,commonShim:f,extractVersion:e.extractVersion,disableLog:e.disableLog,disableWarnings:e.disableWarnings};switch(r.browser){case "chrome":if(!g||!g.shimPeerConnection||
!t.shimChrome){x("Chrome shim is not included in this adapter release.");break}if(null===r.version){x("Chrome shim can not determine version, not shimming.");break}x("adapter.js shimming chrome.");y.browserShim=g;g.shimGetUserMedia(m);g.shimMediaStream(m);g.shimPeerConnection(m);g.shimOnTrack(m);g.shimAddTrackRemoveTrack(m);g.shimGetSendersWithDtmf(m);g.shimGetStats(m);g.shimSenderReceiverGetStats(m);g.fixNegotiationNeeded(m);f.shimRTCIceCandidate(m);f.shimConnectionState(m);f.shimMaxMessageSize(m);
f.shimSendThrowTypeError(m);f.removeAllowExtmapMixed(m);break;case "firefox":if(!q||!q.shimPeerConnection||!t.shimFirefox){x("Firefox shim is not included in this adapter release.");break}x("adapter.js shimming firefox.");y.browserShim=q;q.shimGetUserMedia(m);q.shimPeerConnection(m);q.shimOnTrack(m);q.shimRemoveStream(m);q.shimSenderGetStats(m);q.shimReceiverGetStats(m);q.shimRTCDataChannel(m);q.shimAddTransceiver(m);q.shimGetParameters(m);q.shimCreateOffer(m);q.shimCreateAnswer(m);f.shimRTCIceCandidate(m);
f.shimConnectionState(m);f.shimMaxMessageSize(m);f.shimSendThrowTypeError(m);break;case "edge":if(!h||!h.shimPeerConnection||!t.shimEdge){x("MS edge shim is not included in this adapter release.");break}x("adapter.js shimming edge.");y.browserShim=h;h.shimGetUserMedia(m);h.shimGetDisplayMedia(m);h.shimPeerConnection(m);h.shimReplaceTrack(m);f.shimMaxMessageSize(m);f.shimSendThrowTypeError(m);break;case "safari":if(!k||!t.shimSafari){x("Safari shim is not included in this adapter release.");break}x("adapter.js shimming safari.");
y.browserShim=k;k.shimRTCIceServerUrls(m);k.shimCreateOfferLegacy(m);k.shimCallbacksAPI(m);k.shimLocalStreamsAPI(m);k.shimRemoteStreamsAPI(m);k.shimTrackEventTransceiver(m);k.shimGetUserMedia(m);k.shimAudioContext(m);f.shimRTCIceCandidate(m);f.shimMaxMessageSize(m);f.shimSendThrowTypeError(m);f.removeAllowExtmapMixed(m);break;default:x("Unsupported browser!")}return y};b=a("./utils");var e=d(b);b=a("./chrome/chrome_shim");var g=d(b);b=a("./edge/edge_shim");var h=d(b);b=a("./firefox/firefox_shim");
var q=d(b);b=a("./safari/safari_shim");var k=d(b);a=a("./common_shim");var f=d(a)},{"./chrome/chrome_shim":3,"./common_shim":6,"./edge/edge_shim":7,"./firefox/firefox_shim":11,"./safari/safari_shim":14,"./utils":15}],3:[function(a,b,c){function d(f,m,t){m in f?Object.defineProperty(f,m,{value:t,enumerable:!0,configurable:!0,writable:!0}):f[m]=t;return f}function e(f){f.RTCPeerConnection.prototype.getLocalStreams=function(){var y=this;this._shimmedLocalStreams=this._shimmedLocalStreams||{};return Object.keys(this._shimmedLocalStreams).map(function(v){return y._shimmedLocalStreams[v][0]})};
var m=f.RTCPeerConnection.prototype.addTrack;f.RTCPeerConnection.prototype.addTrack=function(y,v){if(!v)return m.apply(this,arguments);this._shimmedLocalStreams=this._shimmedLocalStreams||{};var A=m.apply(this,arguments);this._shimmedLocalStreams[v.id]?-1===this._shimmedLocalStreams[v.id].indexOf(A)&&this._shimmedLocalStreams[v.id].push(A):this._shimmedLocalStreams[v.id]=[v,A];return A};var t=f.RTCPeerConnection.prototype.addStream;f.RTCPeerConnection.prototype.addStream=function(y){var v=this;this._shimmedLocalStreams=
this._shimmedLocalStreams||{};y.getTracks().forEach(function(p){if(v.getSenders().find(function(w){return w.track===p}))throw new DOMException("Track already exists.","InvalidAccessError");});var A=this.getSenders();t.apply(this,arguments);var n=this.getSenders().filter(function(p){return-1===A.indexOf(p)});this._shimmedLocalStreams[y.id]=[y].concat(n)};var x=f.RTCPeerConnection.prototype.removeStream;f.RTCPeerConnection.prototype.removeStream=function(y){this._shimmedLocalStreams=this._shimmedLocalStreams||
{};delete this._shimmedLocalStreams[y.id];return x.apply(this,arguments)};var r=f.RTCPeerConnection.prototype.removeTrack;f.RTCPeerConnection.prototype.removeTrack=function(y){var v=this;this._shimmedLocalStreams=this._shimmedLocalStreams||{};y&&Object.keys(this._shimmedLocalStreams).forEach(function(A){var n=v._shimmedLocalStreams[A].indexOf(y);-1!==n&&v._shimmedLocalStreams[A].splice(n,1);1===v._shimmedLocalStreams[A].length&&delete v._shimmedLocalStreams[A]});return r.apply(this,arguments)}}Object.defineProperty(c,
"__esModule",{value:!0});c.shimGetDisplayMedia=c.shimGetUserMedia=void 0;var g="function"===typeof Symbol&&"symbol"===typeof Symbol.iterator?function(f){return typeof f}:function(f){return f&&"function"===typeof Symbol&&f.constructor===Symbol&&f!==Symbol.prototype?"symbol":typeof f},h=a("./getusermedia");Object.defineProperty(c,"shimGetUserMedia",{enumerable:!0,get:function(){return h.shimGetUserMedia}});var q=a("./getdisplaymedia");Object.defineProperty(c,"shimGetDisplayMedia",{enumerable:!0,get:function(){return q.shimGetDisplayMedia}});
...
this.removeEventListener("track",this._ontrack);this.addEventListener("track",this._ontrack=t)},enumerable:!0,configurable:!0});var m=f.RTCPeerConnection.prototype.setRemoteDescription;f.RTCPeerConnection.prototype.setRemoteDescription=function(){var t=this;this._ontrackpoly||(this._ontrackpoly=function(x){x.stream.addEventListener("addtrack",function(r){var y=void 0;y=f.RTCPeerConnection.prototype.getReceivers?t.getReceivers().find(function(A){return A.track&&A.track.id===r.track.id}):{track:r.track};
var v=new Event("track");v.track=r.track;v.receiver=y;v.transceiver={receiver:y};v.streams=[x.stream];t.dispatchEvent(v)});x.stream.getTracks().forEach(function(r){var y=void 0;y=f.RTCPeerConnection.prototype.getReceivers?t.getReceivers().find(function(A){return A.track&&A.track.id===r.id}):{track:r};var v=new Event("track");v.track=r;v.receiver=y;v.transceiver={receiver:y};v.streams=[x.stream];t.dispatchEvent(v)})},this.addEventListener("addstream",this._ontrackpoly));return m.apply(this,arguments)}}};
...
f.RTCPeerConnection.prototype.getStats;f.RTCPeerConnection.prototype.getStats=function(){var t=this,x=Array.prototype.slice.call(arguments),r=x[0],y=x[1];x=x[2];if(0<arguments.length&&"function"===typeof r)return m.apply(this,arguments);if(0===m.length&&(0===arguments.length||"function"!==typeof r))return m.apply(this,[]);var v=function(n){var p={};n.result().forEach(function(w){var z={id:w.id,timestamp:w.timestamp,type:{localcandidate:"local-candidate",remotecandidate:"remote-candidate"}[w.type]||
w.type};w.names().forEach(function(B){z[B]=w.stat(B)});p[z.id]=z});return p},A=function(n){return new Map(Object.keys(n).map(function(p){return[p,n[p]]}))};return 2<=arguments.length?m.apply(this,[function(n){y(A(v(n)))},r]):(new Promise(function(n,p){m.apply(t,[function(w){n(A(v(w)))},p])})).then(y,x)}}};c.shimSenderReceiverGetStats=function(f){if("object"===("undefined"===typeof f?"undefined":g(f))&&f.RTCPeerConnection&&f.RTCRtpSender&&f.RTCRtpReceiver){if(!("getStats"in f.RTCRtpSender.prototype)){var m=
f.RTCPeerConnection.prototype.getSenders;m&&(f.RTCPeerConnection.prototype.getSenders=function(){var y=this,v=m.apply(this,[]);v.forEach(function(A){return A._pc=y});return v});var t=f.RTCPeerConnection.prototype.addTrack;t&&(f.RTCPeerConnection.prototype.addTrack=function(){var y=t.apply(this,arguments);y._pc=this;return y});f.RTCRtpSender.prototype.getStats=function(){var y=this;return this._pc.getStats().then(function(v){return k.filterStats(v,y.track,!0)})}}if(!("getStats"in f.RTCRtpReceiver.prototype)){var x=
f.RTCPeerConnection.prototype.getReceivers;x&&(f.RTCPeerConnection.prototype.getReceivers=function(){var y=this,v=x.apply(this,[]);v.forEach(function(A){return A._pc=y});return v});k.wrapPeerConnectionEvent(f,"track",function(y){y.receiver._pc=y.srcElement;return y});f.RTCRtpReceiver.prototype.getStats=function(){var y=this;return this._pc.getStats().then(function(v){return k.filterStats(v,y.track,!1)})}}if("getStats"in f.RTCRtpSender.prototype&&"getStats"in f.RTCRtpReceiver.prototype){var r=f.RTCPeerConnection.prototype.getStats;
f.RTCPeerConnection.prototype.getStats=function(){if(0<arguments.length&&arguments[0]instanceof f.MediaStreamTrack){var y=arguments[0],v=void 0,A=void 0,n=void 0;this.getSenders().forEach(function(p){p.track===y&&(v?n=!0:v=p)});this.getReceivers().forEach(function(p){p.track===y&&(A?n=!0:A=p);return p.track===y});return n||v&&A?Promise.reject(new DOMException("There are more than one sender or receiver for the track.","InvalidAccessError")):v?v.getStats():A?A.getStats():Promise.reject(new DOMException("There is no sender or receiver for the track.",
"InvalidAccessError"))}return r.apply(this,arguments)}}}};c.shimAddTrackRemoveTrackWithNative=e;c.shimAddTrackRemoveTrack=function(f){function m(p,w){var z=w.sdp;Object.keys(p._reverseStreams||[]).forEach(function(B){B=p._reverseStreams[B];z=z.replace(new RegExp(p._streams[B.id].id,"g"),B.id)});return new RTCSessionDescription({type:w.type,sdp:z})}function t(p,w){var z=w.sdp;Object.keys(p._reverseStreams||[]).forEach(function(B){B=p._reverseStreams[B];z=z.replace(new RegExp(B.id,"g"),p._streams[B.id].id)});
return new RTCSessionDescription({type:w.type,sdp:z})}if(f.RTCPeerConnection){var x=k.detectBrowser(f);if(f.RTCPeerConnection.prototype.addTrack&&65<=x.version)return e(f);var r=f.RTCPeerConnection.prototype.getLocalStreams;f.RTCPeerConnection.prototype.getLocalStreams=function(){var p=this,w=r.apply(this);this._reverseStreams=this._reverseStreams||{};return w.map(function(z){return p._reverseStreams[z.id]})};var y=f.RTCPeerConnection.prototype.addStream;f.RTCPeerConnection.prototype.addStream=function(p){var w=
this;this._streams=this._streams||{};this._reverseStreams=this._reverseStreams||{};p.getTracks().forEach(function(B){if(w.getSenders().find(function(D){return D.track===B}))throw new DOMException("Track already exists.","InvalidAccessError");});if(!this._reverseStreams[p.id]){var z=new f.MediaStream(p.getTracks());this._streams[p.id]=z;this._reverseStreams[z.id]=p;p=z}y.apply(this,[p])};var v=f.RTCPeerConnection.prototype.removeStream;f.RTCPeerConnection.prototype.removeStream=function(p){this._streams=
this._streams||{};this._reverseStreams=this._reverseStreams||{};v.apply(this,[this._streams[p.id]||p]);delete this._reverseStreams[this._streams[p.id]?this._streams[p.id].id:p.id];delete this._streams[p.id]};f.RTCPeerConnection.prototype.addTrack=function(p,w){var z=this;if("closed"===this.signalingState)throw new DOMException("The RTCPeerConnection's signalingState is 'closed'.","InvalidStateError");var B=[].slice.call(arguments,1);if(1!==B.length||!B[0].getTracks().find(function(D){return D===p}))throw new DOMException("The adapter.js addTrack polyfill only supports a single  stream which is associated with the specified track.",
"NotSupportedError");if(this.getSenders().find(function(D){return D.track===p}))throw new DOMException("Track already exists.","InvalidAccessError");this._streams=this._streams||{};this._reverseStreams=this._reverseStreams||{};(B=this._streams[w.id])?(B.addTrack(p),Promise.resolve().then(function(){z.dispatchEvent(new Event("negotiationneeded"))})):(B=new f.MediaStream([p]),this._streams[w.id]=B,this._reverseStreams[B.id]=w,this.addStream(B));return this.getSenders().find(function(D){return D.track===
p})};["createOffer","createAnswer"].forEach(function(p){var w=f.RTCPeerConnection.prototype[p],z=d({},p,function(){var B=this,D=arguments;return arguments.length&&"function"===typeof arguments[0]?w.apply(this,[function(G){G=m(B,G);D[0].apply(null,[G])},function(G){D[1]&&D[1].apply(null,G)},arguments[2]]):w.apply(this,arguments).then(function(G){return m(B,G)})});f.RTCPeerConnection.prototype[p]=z[p]});var A=f.RTCPeerConnection.prototype.setLocalDescription;f.RTCPeerConnection.prototype.setLocalDescription=
...
"InvalidStateError");if(!p._pc)throw new DOMException("Argument 1 of RTCPeerConnection.removeTrack does not implement interface RTCRtpSender.","TypeError");if(p._pc!==this)throw new DOMException("Sender was not created by this connection.","InvalidAccessError");this._streams=this._streams||{};var z=void 0;Object.keys(this._streams).forEach(function(B){w._streams[B].getTracks().find(function(D){return p.track===D})&&(z=w._streams[B])});z&&(1===z.getTracks().length?this.removeStream(this._reverseStreams[z.id]):
z.removeTrack(p.track),this.dispatchEvent(new Event("negotiationneeded")))}}};c.shimPeerConnection=function(f){var m=k.detectBrowser(f);!f.RTCPeerConnection&&f.webkitRTCPeerConnection&&(f.RTCPeerConnection=f.webkitRTCPeerConnection);if(f.RTCPeerConnection){var t=0===f.RTCPeerConnection.prototype.addIceCandidate.length;53>m.version&&["setLocalDescription","setRemoteDescription","addIceCandidate"].forEach(function(r){var y=f.RTCPeerConnection.prototype[r],v=d({},r,function(){arguments[0]=new ("addIceCandidate"===
r?f.RTCIceCandidate:f.RTCSessionDescription)(arguments[0]);return y.apply(this,arguments)});f.RTCPeerConnection.prototype[r]=v[r]});var x=f.RTCPeerConnection.prototype.addIceCandidate;f.RTCPeerConnection.prototype.addIceCandidate=function(){return t||arguments[0]?78>m.version&&arguments[0]&&""===arguments[0].candidate?Promise.resolve():x.apply(this,arguments):(arguments[1]&&arguments[1].apply(null),Promise.resolve())}}};c.fixNegotiationNeeded=function(f){var m=k.detectBrowser(f);k.wrapPeerConnectionEvent(f,
"negotiationneeded",function(t){var x=t.target;if(!(72>m.version||x.getConfiguration&&"plan-b"===x.getConfiguration().sdpSemantics)||"stable"===x.signalingState)return t})};var k=function(f){if(f&&f.__esModule)return f;var m={};if(null!=f)for(var t in f)Object.prototype.hasOwnProperty.call(f,t)&&(m[t]=f[t]);m.default=f;return m}(a("../utils.js"))},{"../utils.js":15,"./getdisplaymedia":4,"./getusermedia":5}],4:[function(a,b,c){Object.defineProperty(c,"__esModule",{value:!0});c.shimGetDisplayMedia=
function(d,e){d.navigator.mediaDevices&&"getDisplayMedia"in d.navigator.mediaDevices||!d.navigator.mediaDevices||("function"!==typeof e?console.error("shimGetDisplayMedia: getSourceId argument is not a function"):d.navigator.mediaDevices.getDisplayMedia=function(g){return e(g).then(function(h){var q=g.video&&g.video.width,k=g.video&&g.video.height;g.video={mandatory:{chromeMediaSource:"desktop",chromeMediaSourceId:h,maxFrameRate:g.video&&g.video.frameRate||3}};q&&(g.video.mandatory.maxWidth=q);k&&
(g.video.mandatory.maxHeight=k);return d.navigator.mediaDevices.getUserMedia(g)})})}},{}],5:[function(a,b,c){Object.defineProperty(c,"__esModule",{value:!0});var d="function"===typeof Symbol&&"symbol"===typeof Symbol.iterator?function(h){return typeof h}:function(h){return h&&"function"===typeof Symbol&&h.constructor===Symbol&&h!==Symbol.prototype?"symbol":typeof h};c.shimGetUserMedia=function(h){var q=h&&h.navigator;if(q.mediaDevices){var k=e.detectBrowser(h),f=function(r){if("object"!==("undefined"===
typeof r?"undefined":d(r))||r.mandatory||r.optional)return r;var y={};Object.keys(r).forEach(function(v){if("require"!==v&&"advanced"!==v&&"mediaSource"!==v){var A="object"===d(r[v])?r[v]:{ideal:r[v]};void 0!==A.exact&&"number"===typeof A.exact&&(A.min=A.max=A.exact);var n=function(w,z){return w?w+z.charAt(0).toUpperCase()+z.slice(1):"deviceId"===z?"sourceId":z};if(void 0!==A.ideal){y.optional=y.optional||[];var p={};"number"===typeof A.ideal?(p[n("min",v)]=A.ideal,y.optional.push(p),p={},p[n("max",
v)]=A.ideal):p[n("",v)]=A.ideal;y.optional.push(p)}void 0!==A.exact&&"number"!==typeof A.exact?(y.mandatory=y.mandatory||{},y.mandatory[n("",v)]=A.exact):["min","max"].forEach(function(w){void 0!==A[w]&&(y.mandatory=y.mandatory||{},y.mandatory[n(w,v)]=A[w])})}});r.advanced&&(y.optional=(y.optional||[]).concat(r.advanced));return y},m=function(r,y){if(61<=k.version)return y(r);if((r=JSON.parse(JSON.stringify(r)))&&"object"===d(r.audio)){var v=function(p,w,z){w in p&&!(z in p)&&(p[z]=p[w],delete p[w])};
r=JSON.parse(JSON.stringify(r));v(r.audio,"autoGainControl","googAutoGainControl");v(r.audio,"noiseSuppression","googNoiseSuppression");r.audio=f(r.audio)}if(r&&"object"===d(r.video)){var A=r.video.facingMode;A=A&&("object"===("undefined"===typeof A?"undefined":d(A))?A:{ideal:A});v=66>k.version;if(!(!A||"user"!==A.exact&&"environment"!==A.exact&&"user"!==A.ideal&&"environment"!==A.ideal||q.mediaDevices.getSupportedConstraints&&q.mediaDevices.getSupportedConstraints().facingMode&&!v)){delete r.video.facingMode;
var n=void 0;if("environment"===A.exact||"environment"===A.ideal)n=["back","rear"];else if("user"===A.exact||"user"===A.ideal)n=["front"];if(n)return q.mediaDevices.enumerateDevices().then(function(p){p=p.filter(function(z){return"videoinput"===z.kind});var w=p.find(function(z){return n.some(function(B){return z.label.toLowerCase().includes(B)})});!w&&p.length&&n.includes("back")&&(w=p[p.length-1]);w&&(r.video.deviceId=A.exact?{exact:w.deviceId}:{ideal:w.deviceId});r.video=f(r.video);g("chrome: "+
...
!v.getAudioTracks().length||y.video&&!v.getVideoTracks().length)throw v.getTracks().forEach(function(A){A.stop()}),new DOMException("","NotFoundError");return v},function(v){return Promise.reject(t(v))})})}}}};var e=function(h){if(h&&h.__esModule)return h;var q={};if(null!=h)for(var k in h)Object.prototype.hasOwnProperty.call(h,k)&&(q[k]=h[k]);q.default=h;return q}(a("../utils.js")),g=e.log},{"../utils.js":15}],6:[function(a,b,c){Object.defineProperty(c,"__esModule",{value:!0});var d="function"===
typeof Symbol&&"symbol"===typeof Symbol.iterator?function(h){return typeof h}:function(h){return h&&"function"===typeof Symbol&&h.constructor===Symbol&&h!==Symbol.prototype?"symbol":typeof h};c.shimRTCIceCandidate=function(h){if(h.RTCIceCandidate&&!(h.RTCIceCandidate&&"foundation"in h.RTCIceCandidate.prototype)){var q=h.RTCIceCandidate;h.RTCIceCandidate=function(k){"object"===("undefined"===typeof k?"undefined":d(k))&&k.candidate&&0===k.candidate.indexOf("a=")&&(k=JSON.parse(JSON.stringify(k)),k.candidate=
k.candidate.substr(2));if(k.candidate&&k.candidate.length){var f=new q(k);k=e.default.parseCandidate(k.candidate);var m=Object.assign(f,k);m.toJSON=function(){return{candidate:m.candidate,sdpMid:m.sdpMid,sdpMLineIndex:m.sdpMLineIndex,usernameFragment:m.usernameFragment}};return m}return new q(k)};h.RTCIceCandidate.prototype=q.prototype;g.wrapPeerConnectionEvent(h,"icecandidate",function(k){k.candidate&&Object.defineProperty(k,"candidate",{value:new h.RTCIceCandidate(k.candidate),writable:"false"});
return k})}};c.shimMaxMessageSize=function(h){if(h.RTCPeerConnection){var q=g.detectBrowser(h);"sctp"in h.RTCPeerConnection.prototype||Object.defineProperty(h.RTCPeerConnection.prototype,"sctp",{get:function(){return"undefined"===typeof this._sctp?null:this._sctp}});var k=function(r){if(!r||!r.sdp)return!1;r=e.default.splitSections(r.sdp);r.shift();return r.some(function(y){return(y=e.default.parseMLine(y))&&"application"===y.kind&&-1!==y.protocol.indexOf("SCTP")})},f=function(r){r=r.sdp.match(/mozilla...THIS_IS_SDPARTA-(\d+)/);
if(null===r||2>r.length)return-1;r=parseInt(r[1],10);return r!==r?-1:r},m=function(r){var y=65536;"firefox"===q.browser&&(y=57>q.version?-1===r?16384:2147483637:60>q.version?57===q.version?65535:65536:2147483637);return y},t=function(r,y){var v=65536;"firefox"===q.browser&&57===q.version&&(v=65535);r=e.default.matchPrefix(r.sdp,"a=max-message-size:");0<r.length?v=parseInt(r[0].substr(19),10):"firefox"===q.browser&&-1!==y&&(v=2147483637);return v},x=h.RTCPeerConnection.prototype.setRemoteDescription;
...
71<=q.version||"safari"===q.browser&&605<=q.version)){var k=h.RTCPeerConnection.prototype.setRemoteDescription;h.RTCPeerConnection.prototype.setRemoteDescription=function(f){f&&f.sdp&&-1!==f.sdp.indexOf("\na=extmap-allow-mixed")&&(f.sdp=f.sdp.split("\n").filter(function(m){return"a=extmap-allow-mixed"!==m.trim()}).join("\n"));return k.apply(this,arguments)}}}};var e=(b=a("sdp"))&&b.__esModule?b:{default:b},g=function(h){if(h&&h.__esModule)return h;var q={};if(null!=h)for(var k in h)Object.prototype.hasOwnProperty.call(h,
k)&&(q[k]=h[k]);q.default=h;return q}(a("./utils"))},{"./utils":15,sdp:17}],7:[function(a,b,c){Object.defineProperty(c,"__esModule",{value:!0});c.shimGetDisplayMedia=c.shimGetUserMedia=void 0;var d=a("./getusermedia");Object.defineProperty(c,"shimGetUserMedia",{enumerable:!0,get:function(){return d.shimGetUserMedia}});var e=a("./getdisplaymedia");Object.defineProperty(c,"shimGetDisplayMedia",{enumerable:!0,get:function(){return e.shimGetDisplayMedia}});c.shimPeerConnection=function(k){var f=g.detectBrowser(k);
if(k.RTCIceGatherer&&(k.RTCIceCandidate||(k.RTCIceCandidate=function(x){return x}),k.RTCSessionDescription||(k.RTCSessionDescription=function(x){return x}),15025>f.version)){var m=Object.getOwnPropertyDescriptor(k.MediaStreamTrack.prototype,"enabled");Object.defineProperty(k.MediaStreamTrack.prototype,"enabled",{set:function(x){m.set.call(this,x);var r=new Event("enabled");r.enabled=x;this.dispatchEvent(r)}})}!k.RTCRtpSender||"dtmf"in k.RTCRtpSender.prototype||Object.defineProperty(k.RTCRtpSender.prototype,
"dtmf",{get:function(){void 0===this._dtmf&&("audio"===this.track.kind?this._dtmf=new k.RTCDtmfSender(this):"video"===this.track.kind&&(this._dtmf=null));return this._dtmf}});k.RTCDtmfSender&&!k.RTCDTMFSender&&(k.RTCDTMFSender=k.RTCDtmfSender);var t=(0,q.default)(k,f.version);k.RTCPeerConnection=function(x){x&&x.iceServers&&(x.iceServers=(0,h.filterIceServers)(x.iceServers,f.version),g.log("ICE servers after filtering:",x.iceServers));return new t(x)};k.RTCPeerConnection.prototype=t.prototype};c.shimReplaceTrack=
function(k){!k.RTCRtpSender||"replaceTrack"in k.RTCRtpSender.prototype||(k.RTCRtpSender.prototype.replaceTrack=k.RTCRtpSender.prototype.setTrack)};var g=function(k){if(k&&k.__esModule)return k;var f={};if(null!=k)for(var m in k)Object.prototype.hasOwnProperty.call(k,m)&&(f[m]=k[m]);f.default=k;return f}(a("../utils")),h=a("./filtericeservers"),q=(a=a("rtcpeerconnection-shim"))&&a.__esModule?a:{default:a}},{"../utils":15,"./filtericeservers":8,"./getdisplaymedia":9,"./getusermedia":10,"rtcpeerconnection-shim":16}],
8:[function(a,b,c){Object.defineProperty(c,"__esModule",{value:!0});c.filterIceServers=function(e,g){var h=!1;e=JSON.parse(JSON.stringify(e));return e.filter(function(q){if(q&&(q.urls||q.url)){var k=q.urls||q.url;q.url&&!q.urls&&d.deprecated("RTCIceServer.url","RTCIceServer.urls");var f="string"===typeof k;f&&(k=[k]);k=k.filter(function(m){return 0===m.indexOf("stun:")?!1:(m=m.startsWith("turn")&&!m.startsWith("turn:[")&&m.includes("transport=udp"))&&!h?h=!0:m&&!h});delete q.url;q.urls=f?k[0]:k;return!!k.length}})};
var d=function(e){if(e&&e.__esModule)return e;var g={};if(null!=e)for(var h in e)Object.prototype.hasOwnProperty.call(e,h)&&(g[h]=e[h]);g.default=e;return g}(a("../utils"))},{"../utils":15}],9:[function(a,b,c){Object.defineProperty(c,"__esModule",{value:!0});c.shimGetDisplayMedia=function(d){"getDisplayMedia"in d.navigator&&d.navigator.mediaDevices&&!(d.navigator.mediaDevices&&"getDisplayMedia"in d.navigator.mediaDevices)&&(d.navigator.mediaDevices.getDisplayMedia=d.navigator.getDisplayMedia.bind(d.navigator))}},
{}],10:[function(a,b,c){Object.defineProperty(c,"__esModule",{value:!0});c.shimGetUserMedia=function(d){d=d&&d.navigator;var e=function(h){return{name:{PermissionDeniedError:"NotAllowedError"}[h.name]||h.name,message:h.message,constraint:h.constraint,toString:function(){return this.name}}},g=d.mediaDevices.getUserMedia.bind(d.mediaDevices);d.mediaDevices.getUserMedia=function(h){return g(h).catch(function(q){return Promise.reject(e(q))})}}},{}],11:[function(a,b,c){function d(k,f,m){f in k?Object.defineProperty(k,
f,{value:m,enumerable:!0,configurable:!0,writable:!0}):k[f]=m;return k}Object.defineProperty(c,"__esModule",{value:!0});c.shimGetDisplayMedia=c.shimGetUserMedia=void 0;var e="function"===typeof Symbol&&"symbol"===typeof Symbol.iterator?function(k){return typeof k}:function(k){return k&&"function"===typeof Symbol&&k.constructor===Symbol&&k!==Symbol.prototype?"symbol":typeof k},g=a("./getusermedia");Object.defineProperty(c,"shimGetUserMedia",{enumerable:!0,get:function(){return g.shimGetUserMedia}});
var h=a("./getdisplaymedia");Object.defineProperty(c,"shimGetDisplayMedia",{enumerable:!0,get:function(){return h.shimGetDisplayMedia}});c.shimOnTrack=function(k){"object"===("undefined"===typeof k?"undefined":e(k))&&k.RTCTrackEvent&&"receiver"in k.RTCTrackEvent.prototype&&!("transceiver"in k.RTCTrackEvent.prototype)&&Object.defineProperty(k.RTCTrackEvent.prototype,"transceiver",{get:function(){return{receiver:this.receiver}}})};c.shimPeerConnection=function(k){var f=q.detectBrowser(k);if("object"===
("undefined"===typeof k?"undefined":e(k))&&(k.RTCPeerConnection||k.mozRTCPeerConnection)){!k.RTCPeerConnection&&k.mozRTCPeerConnection&&(k.RTCPeerConnection=k.mozRTCPeerConnection);53>f.version&&["setLocalDescription","setRemoteDescription","addIceCandidate"].forEach(function(r){var y=k.RTCPeerConnection.prototype[r],v=d({},r,function(){arguments[0]=new ("addIceCandidate"===r?k.RTCIceCandidate:k.RTCSessionDescription)(arguments[0]);return y.apply(this,arguments)});k.RTCPeerConnection.prototype[r]=
v[r]});if(68>f.version){var m=k.RTCPeerConnection.prototype.addIceCandidate;k.RTCPeerConnection.prototype.addIceCandidate=function(){return arguments[0]?arguments[0]&&""===arguments[0].candidate?Promise.resolve():m.apply(this,arguments):(arguments[1]&&arguments[1].apply(null),Promise.resolve())}}var t={inboundrtp:"inbound-rtp",outboundrtp:"outbound-rtp",candidatepair:"candidate-pair",localcandidate:"local-candidate",remotecandidate:"remote-candidate"},x=k.RTCPeerConnection.prototype.getStats;k.RTCPeerConnection.prototype.getStats=
function(){var r=Array.prototype.slice.call(arguments),y=r[1],v=r[2];return x.apply(this,[r[0]||null]).then(function(A){if(53>f.version&&!y)try{A.forEach(function(n){n.type=t[n.type]||n.type})}catch(n){if("TypeError"!==n.name)throw n;A.forEach(function(p,w){A.set(w,Object.assign({},p,{type:t[p.type]||p.type}))})}return A}).then(y,v)}}};c.shimSenderGetStats=function(k){if("object"===("undefined"===typeof k?"undefined":e(k))&&k.RTCPeerConnection&&k.RTCRtpSender&&!(k.RTCRtpSender&&"getStats"in k.RTCRtpSender.prototype)){var f=
k.RTCPeerConnection.prototype.getSenders;f&&(k.RTCPeerConnection.prototype.getSenders=function(){var t=this,x=f.apply(this,[]);x.forEach(function(r){return r._pc=t});return x});var m=k.RTCPeerConnection.prototype.addTrack;m&&(k.RTCPeerConnection.prototype.addTrack=function(){var t=m.apply(this,arguments);t._pc=this;return t});k.RTCRtpSender.prototype.getStats=function(){return this.track?this._pc.getStats(this.track):Promise.resolve(new Map)}}};c.shimReceiverGetStats=function(k){if("object"===("undefined"===
typeof k?"undefined":e(k))&&k.RTCPeerConnection&&k.RTCRtpSender&&!(k.RTCRtpSender&&"getStats"in k.RTCRtpReceiver.prototype)){var f=k.RTCPeerConnection.prototype.getReceivers;f&&(k.RTCPeerConnection.prototype.getReceivers=function(){var m=this,t=f.apply(this,[]);t.forEach(function(x){return x._pc=m});return t});q.wrapPeerConnectionEvent(k,"track",function(m){m.receiver._pc=m.srcElement;return m});k.RTCRtpReceiver.prototype.getStats=function(){return this._pc.getStats(this.track)}}};c.shimRemoveStream=
function(k){!k.RTCPeerConnection||"removeStream"in k.RTCPeerConnection.prototype||(k.RTCPeerConnection.prototype.removeStream=function(f){var m=this;q.deprecated("removeStream","removeTrack");this.getSenders().forEach(function(t){t.track&&f.getTracks().includes(t.track)&&m.removeTrack(t)})})};c.shimRTCDataChannel=function(k){k.DataChannel&&!k.RTCDataChannel&&(k.RTCDataChannel=k.DataChannel)};c.shimAddTransceiver=function(k){if("object"===("undefined"===typeof k?"undefined":e(k))&&k.RTCPeerConnection){var f=
...
});var x=f.apply(this,arguments);if(t){var r=x.sender;t=r.getParameters();"encodings"in t||(t.encodings=m.sendEncodings,r.sendEncodings=m.sendEncodings,this.setParametersPromises.push(r.setParameters(t).then(function(){delete r.sendEncodings}).catch(function(){delete r.sendEncodings})))}return x})}};c.shimGetParameters=function(k){if("object"===("undefined"===typeof k?"undefined":e(k))&&k.RTCRtpSender){var f=k.RTCRtpSender.prototype.getParameters;f&&(k.RTCRtpSender.prototype.getParameters=function(){var m=
f.apply(this,arguments);return"sendEncodings"in this?Object.assign({},{encodings:this.sendEncodings},m):m})}};c.shimCreateOffer=function(k){if("object"===("undefined"===typeof k?"undefined":e(k))&&k.RTCPeerConnection){var f=k.RTCPeerConnection.prototype.createOffer;k.RTCPeerConnection.prototype.createOffer=function(){var m=this,t=arguments;return this.setParametersPromises&&this.setParametersPromises.length?Promise.all(this.setParametersPromises).then(function(){return f.apply(m,t)}).finally(function(){m.setParametersPromises=
[]}):f.apply(this,arguments)}}};c.shimCreateAnswer=function(k){if("object"===("undefined"===typeof k?"undefined":e(k))&&k.RTCPeerConnection){var f=k.RTCPeerConnection.prototype.createAnswer;k.RTCPeerConnection.prototype.createAnswer=function(){var m=this,t=arguments;return this.setParametersPromises&&this.setParametersPromises.length?Promise.all(this.setParametersPromises).then(function(){return f.apply(m,t)}).finally(function(){m.setParametersPromises=[]}):f.apply(this,arguments)}}};var q=function(k){if(k&&
k.__esModule)return k;var f={};if(null!=k)for(var m in k)Object.prototype.hasOwnProperty.call(k,m)&&(f[m]=k[m]);f.default=k;return f}(a("../utils"))},{"../utils":15,"./getdisplaymedia":12,"./getusermedia":13}],12:[function(a,b,c){Object.defineProperty(c,"__esModule",{value:!0});c.shimGetDisplayMedia=function(d,e){d.navigator.mediaDevices&&"getDisplayMedia"in d.navigator.mediaDevices||!d.navigator.mediaDevices||(d.navigator.mediaDevices.getDisplayMedia=function(g){if(!g||!g.video)return g=new DOMException("getDisplayMedia without video constraints is undefined"),
g.name="NotFoundError",g.code=8,Promise.reject(g);!0===g.video?g.video={mediaSource:e}:g.video.mediaSource=e;return d.navigator.mediaDevices.getUserMedia(g)})}},{}],13:[function(a,b,c){Object.defineProperty(c,"__esModule",{value:!0});var d="function"===typeof Symbol&&"symbol"===typeof Symbol.iterator?function(g){return typeof g}:function(g){return g&&"function"===typeof Symbol&&g.constructor===Symbol&&g!==Symbol.prototype?"symbol":typeof g};c.shimGetUserMedia=function(g){var h=e.detectBrowser(g),
q=g&&g.navigator;g=g&&g.MediaStreamTrack;q.getUserMedia=function(x,r,y){e.deprecated("navigator.getUserMedia","navigator.mediaDevices.getUserMedia");q.mediaDevices.getUserMedia(x).then(r,y)};if(!(55<h.version&&"autoGainControl"in q.mediaDevices.getSupportedConstraints())){var k=function(x,r,y){r in x&&!(y in x)&&(x[y]=x[r],delete x[r])},f=q.mediaDevices.getUserMedia.bind(q.mediaDevices);q.mediaDevices.getUserMedia=function(x){"object"===("undefined"===typeof x?"undefined":d(x))&&"object"===d(x.audio)&&
(x=JSON.parse(JSON.stringify(x)),k(x.audio,"autoGainControl","mozAutoGainControl"),k(x.audio,"noiseSuppression","mozNoiseSuppression"));return f(x)};if(g&&g.prototype.getSettings){var m=g.prototype.getSettings;g.prototype.getSettings=function(){var x=m.apply(this,arguments);k(x,"mozAutoGainControl","autoGainControl");k(x,"mozNoiseSuppression","noiseSuppression");return x}}if(g&&g.prototype.applyConstraints){var t=g.prototype.applyConstraints;g.prototype.applyConstraints=function(x){"audio"===this.kind&&
"object"===("undefined"===typeof x?"undefined":d(x))&&(x=JSON.parse(JSON.stringify(x)),k(x,"autoGainControl","mozAutoGainControl"),k(x,"noiseSuppression","mozNoiseSuppression"));return t.apply(this,[x])}}}};var e=function(g){if(g&&g.__esModule)return g;var h={};if(null!=g)for(var q in g)Object.prototype.hasOwnProperty.call(g,q)&&(h[q]=g[q]);h.default=g;return h}(a("../utils"))},{"../utils":15}],14:[function(a,b,c){function d(h){return h&&void 0!==h.video?Object.assign({},h,{video:g.compactObject(h.video)}):
h}Object.defineProperty(c,"__esModule",{value:!0});var e="function"===typeof Symbol&&"symbol"===typeof Symbol.iterator?function(h){return typeof h}:function(h){return h&&"function"===typeof Symbol&&h.constructor===Symbol&&h!==Symbol.prototype?"symbol":typeof h};c.shimLocalStreamsAPI=function(h){if("object"===("undefined"===typeof h?"undefined":e(h))&&h.RTCPeerConnection){"getLocalStreams"in h.RTCPeerConnection.prototype||(h.RTCPeerConnection.prototype.getLocalStreams=function(){this._localStreams||
(this._localStreams=[]);return this._localStreams});if(!("addStream"in h.RTCPeerConnection.prototype)){var q=h.RTCPeerConnection.prototype.addTrack;h.RTCPeerConnection.prototype.addStream=function(k){var f=this;this._localStreams||(this._localStreams=[]);this._localStreams.includes(k)||this._localStreams.push(k);k.getAudioTracks().forEach(function(m){return q.call(f,m,k)});k.getVideoTracks().forEach(function(m){return q.call(f,m,k)})};h.RTCPeerConnection.prototype.addTrack=function(k){for(var f=this,
m=arguments.length,t=Array(1<m?m-1:0),x=1;x<m;x++)t[x-1]=arguments[x];t&&t.forEach(function(r){f._localStreams?f._localStreams.includes(r)||f._localStreams.push(r):f._localStreams=[r]});return q.apply(this,arguments)}}"removeStream"in h.RTCPeerConnection.prototype||(h.RTCPeerConnection.prototype.removeStream=function(k){var f=this;this._localStreams||(this._localStreams=[]);var m=this._localStreams.indexOf(k);if(-1!==m){this._localStreams.splice(m,1);var t=k.getTracks();this.getSenders().forEach(function(x){t.includes(x.track)&&
f.removeTrack(x)})}})}};c.shimRemoteStreamsAPI=function(h){if("object"===("undefined"===typeof h?"undefined":e(h))&&h.RTCPeerConnection&&("getRemoteStreams"in h.RTCPeerConnection.prototype||(h.RTCPeerConnection.prototype.getRemoteStreams=function(){return this._remoteStreams?this._remoteStreams:[]}),!("onaddstream"in h.RTCPeerConnection.prototype))){Object.defineProperty(h.RTCPeerConnection.prototype,"onaddstream",{get:function(){return this._onaddstream},set:function(k){var f=this;this._onaddstream&&
...
function(){var k=this;this._onaddstreampoly||this.addEventListener("track",this._onaddstreampoly=function(f){f.streams.forEach(function(m){k._remoteStreams||(k._remoteStreams=[]);if(!(0<=k._remoteStreams.indexOf(m))){k._remoteStreams.push(m);var t=new Event("addstream");t.stream=m;k.dispatchEvent(t)}})});return q.apply(k,arguments)}}};c.shimCallbacksAPI=function(h){if("object"===("undefined"===typeof h?"undefined":e(h))&&h.RTCPeerConnection){h=h.RTCPeerConnection.prototype;var q=h.createOffer,k=h.createAnswer,
f=h.setLocalDescription,m=h.setRemoteDescription,t=h.addIceCandidate;h.createOffer=function(r,y){var v=q.apply(this,[2<=arguments.length?arguments[2]:arguments[0]]);if(!y)return v;v.then(r,y);return Promise.resolve()};h.createAnswer=function(r,y){var v=k.apply(this,[2<=arguments.length?arguments[2]:arguments[0]]);if(!y)return v;v.then(r,y);return Promise.resolve()};var x=function(r,y,v){r=f.apply(this,[r]);if(!v)return r;r.then(y,v);return Promise.resolve()};h.setLocalDescription=x;x=function(r,y,
v){r=m.apply(this,[r]);if(!v)return r;r.then(y,v);return Promise.resolve()};h.setRemoteDescription=x;x=function(r,y,v){r=t.apply(this,[r]);if(!v)return r;r.then(y,v);return Promise.resolve()};h.addIceCandidate=x}};c.shimGetUserMedia=function(h){var q=h&&h.navigator;if(q.mediaDevices&&q.mediaDevices.getUserMedia){h=q.mediaDevices;var k=h.getUserMedia.bind(h);q.mediaDevices.getUserMedia=function(f){return k(d(f))}}!q.getUserMedia&&q.mediaDevices&&q.mediaDevices.getUserMedia&&(q.getUserMedia=function(f,
m,t){q.mediaDevices.getUserMedia(f).then(m,t)}.bind(q))};c.shimConstraints=d;c.shimRTCIceServerUrls=function(h){var q=h.RTCPeerConnection;h.RTCPeerConnection=function(k,f){if(k&&k.iceServers){for(var m=[],t=0;t<k.iceServers.length;t++){var x=k.iceServers[t];!x.hasOwnProperty("urls")&&x.hasOwnProperty("url")?(g.deprecated("RTCIceServer.url","RTCIceServer.urls"),x=JSON.parse(JSON.stringify(x)),x.urls=x.url,delete x.url,m.push(x)):m.push(k.iceServers[t])}k.iceServers=m}return new q(k,f)};h.RTCPeerConnection.prototype=
q.prototype;"generateCertificate"in h.RTCPeerConnection&&Object.defineProperty(h.RTCPeerConnection,"generateCertificate",{get:function(){return q.generateCertificate}})};c.shimTrackEventTransceiver=function(h){"object"===("undefined"===typeof h?"undefined":e(h))&&h.RTCTrackEvent&&"receiver"in h.RTCTrackEvent.prototype&&!("transceiver"in h.RTCTrackEvent.prototype)&&Object.defineProperty(h.RTCTrackEvent.prototype,"transceiver",{get:function(){return{receiver:this.receiver}}})};c.shimCreateOfferLegacy=
function(h){var q=h.RTCPeerConnection.prototype.createOffer;h.RTCPeerConnection.prototype.createOffer=function(k){if(k){"undefined"!==typeof k.offerToReceiveAudio&&(k.offerToReceiveAudio=!!k.offerToReceiveAudio);var f=this.getTransceivers().find(function(m){return"audio"===m.receiver.track.kind});!1===k.offerToReceiveAudio&&f?"sendrecv"===f.direction?f.setDirection?f.setDirection("sendonly"):f.direction="sendonly":"recvonly"===f.direction&&(f.setDirection?f.setDirection("inactive"):f.direction="inactive"):
!0!==k.offerToReceiveAudio||f||this.addTransceiver("audio");"undefined"!==typeof k.offerToReceiveVideo&&(k.offerToReceiveVideo=!!k.offerToReceiveVideo);f=this.getTransceivers().find(function(m){return"video"===m.receiver.track.kind});!1===k.offerToReceiveVideo&&f?"sendrecv"===f.direction?f.setDirection?f.setDirection("sendonly"):f.direction="sendonly":"recvonly"===f.direction&&(f.setDirection?f.setDirection("inactive"):f.direction="inactive"):!0!==k.offerToReceiveVideo||f||this.addTransceiver("video")}return q.apply(this,
arguments)}};c.shimAudioContext=function(h){"object"!==("undefined"===typeof h?"undefined":e(h))||h.AudioContext||(h.AudioContext=h.webkitAudioContext)};var g=function(h){if(h&&h.__esModule)return h;var q={};if(null!=h)for(var k in h)Object.prototype.hasOwnProperty.call(h,k)&&(q[k]=h[k]);q.default=h;return q}(a("../utils"))},{"../utils":15}],15:[function(a,b,c){function d(f,m,t){return(f=f.match(m))&&f.length>=t&&parseInt(f[t],10)}function e(f){return"[object Object]"!==Object.prototype.toString.call(f)?
f:Object.keys(f).reduce(function(m,t){var x="[object Object]"===Object.prototype.toString.call(f[t]),r=x?e(f[t]):f[t];x=x&&!Object.keys(r).length;if(void 0===r||x)return m;x=Object;var y=x.assign,v={};t in v?Object.defineProperty(v,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):v[t]=r;return y.call(x,m,v)},{})}function g(f,m,t){m&&!t.has(m.id)&&(t.set(m.id,m),Object.keys(m).forEach(function(x){x.endsWith("Id")?g(f,f.get(m[x]),t):x.endsWith("Ids")&&m[x].forEach(function(r){g(f,f.get(r),t)})}))}
Object.defineProperty(c,"__esModule",{value:!0});var h="function"===typeof Symbol&&"symbol"===typeof Symbol.iterator?function(f){return typeof f}:function(f){return f&&"function"===typeof Symbol&&f.constructor===Symbol&&f!==Symbol.prototype?"symbol":typeof f};c.extractVersion=d;c.wrapPeerConnectionEvent=function(f,m,t){if(f.RTCPeerConnection){f=f.RTCPeerConnection.prototype;var x=f.addEventListener;f.addEventListener=function(y,v){if(y!==m)return x.apply(this,arguments);var A=function(n){(n=t(n))&&
...
function(f){if("boolean"!==typeof f)return Error("Argument type: "+("undefined"===typeof f?"undefined":h(f))+". Please use a boolean.");k=!f;return"adapter.js deprecation warnings "+(f?"disabled":"enabled")};c.log=function(){"object"!==("undefined"===typeof window?"undefined":h(window))||q||"undefined"!==typeof console&&"function"===typeof console.log&&console.log.apply(console,arguments)};c.deprecated=function(f,m){k&&console.warn(f+" is deprecated, please use "+m+" instead.")};c.detectBrowser=function(f){var m=
f.navigator,t={browser:null,version:null};if("undefined"===typeof f||!f.navigator)return t.browser="Not a browser.",t;m.mozGetUserMedia?(t.browser="firefox",t.version=d(m.userAgent,/Firefox\/(\d+)\./,1)):m.webkitGetUserMedia||!1===f.isSecureContext&&f.webkitRTCPeerConnection&&!f.RTCIceGatherer?(t.browser="chrome",t.version=d(m.userAgent,/Chrom(e|ium)\/(\d+)\./,2)):m.mediaDevices&&m.userAgent.match(/Edge\/(\d+).(\d+)$/)?(t.browser="edge",t.version=d(m.userAgent,/Edge\/(\d+).(\d+)$/,2)):f.RTCPeerConnection&&
m.userAgent.match(/AppleWebKit\/(\d+)\./)?(t.browser="safari",t.version=d(m.userAgent,/AppleWebKit\/(\d+)\./,1),t.supportsUnifiedPlan=f.RTCRtpTransceiver&&"currentDirection"in f.RTCRtpTransceiver.prototype):t.browser="Not a supported browser.";return t};c.compactObject=e;c.walkStats=g;c.filterStats=function(f,m,t){var x=t?"outbound-rtp":"inbound-rtp",r=new Map;if(null===m)return r;var y=[];f.forEach(function(v){"track"===v.type&&v.trackIdentifier===m.id&&y.push(v)});y.forEach(function(v){f.forEach(function(A){A.type===
x&&A.trackId===v.id&&g(f,A,r)})});return r};var q=!0,k=!0},{}],16:[function(a,b,c){function d(m,t,x,r,y){t=f.writeRtpDescription(m.kind,t);t+=f.writeIceParameters(m.iceGatherer.getLocalParameters());t+=f.writeDtlsParameters(m.dtlsTransport.getLocalParameters(),"offer"===x?"actpass":y||"active");t+="a=mid:"+m.mid+"\r\n";t=m.rtpSender&&m.rtpReceiver?t+"a=sendrecv\r\n":m.rtpSender?t+"a=sendonly\r\n":m.rtpReceiver?t+"a=recvonly\r\n":t+"a=inactive\r\n";m.rtpSender&&(x=m.rtpSender._initialTrackId||m.rtpSender.track.id,
...
return n};v.prototype.addTrack=function(n,p){if(this._isClosed)throw k("InvalidStateError","Attempted to call addTrack on a closed peerconnection.");if(this.transceivers.find(function(B){return B.track===n}))throw k("InvalidAccessError","Track already exists.");for(var w,z=0;z<this.transceivers.length;z++)this.transceivers[z].track||this.transceivers[z].kind!==n.kind||(w=this.transceivers[z]);w||(w=this._createTransceiver(n.kind));this._maybeFireNegotiationNeeded();-1===this.localStreams.indexOf(p)&&
this.localStreams.push(p);w.track=n;w.stream=p;w.rtpSender=new m.RTCRtpSender(n,w.dtlsTransport);return w.rtpSender};v.prototype.addStream=function(n){var p=this;if(15025<=t)n.getTracks().forEach(function(z){p.addTrack(z,n)});else{var w=n.clone();n.getTracks().forEach(function(z,B){var D=w.getTracks()[B];z.addEventListener("enabled",function(G){D.enabled=G.enabled})});w.getTracks().forEach(function(z){p.addTrack(z,w)})}};v.prototype.removeTrack=function(n){if(this._isClosed)throw k("InvalidStateError",
"Attempted to call removeTrack on a closed peerconnection.");if(!(n instanceof m.RTCRtpSender))throw new TypeError("Argument 1 of RTCPeerConnection.removeTrack does not implement interface RTCRtpSender.");var p=this.transceivers.find(function(z){return z.rtpSender===n});if(!p)throw k("InvalidAccessError","Sender was not created by this connection.");var w=p.stream;p.rtpSender.stop();p.rtpSender=null;p.track=null;p.stream=null;-1===this.transceivers.map(function(z){return z.stream}).indexOf(w)&&-1<
this.localStreams.indexOf(w)&&this.localStreams.splice(this.localStreams.indexOf(w),1);this._maybeFireNegotiationNeeded()};v.prototype.removeStream=function(n){var p=this;n.getTracks().forEach(function(w){var z=p.getSenders().find(function(B){return B.track===w});z&&p.removeTrack(z)})};v.prototype.getSenders=function(){return this.transceivers.filter(function(n){return!!n.rtpSender}).map(function(n){return n.rtpSender})};v.prototype.getReceivers=function(){return this.transceivers.filter(function(n){return!!n.rtpReceiver}).map(function(n){return n.rtpReceiver})};
...
"completed":"gathering";null!==w.transceivers[n].bufferedCandidateEvents&&w.transceivers[n].bufferedCandidateEvents.push(B)};z.addEventListener("localcandidate",this.transceivers[n].bufferCandidates);return z};v.prototype._gather=function(n,p){var w=this,z=this.transceivers[p].iceGatherer;if(!z.onlocalcandidate){var B=this.transceivers[p].bufferedCandidateEvents;this.transceivers[p].bufferedCandidateEvents=null;z.removeEventListener("localcandidate",this.transceivers[p].bufferCandidates);z.onlocalcandidate=
function(D){if(!(w.usingBundle&&0<p)){var G=new Event("icecandidate");G.candidate={sdpMid:n,sdpMLineIndex:p};var M=D.candidate;if(D=!M||0===Object.keys(M).length){if("new"===z.state||"gathering"===z.state)z.state="completed"}else"new"===z.state&&(z.state="gathering"),M.component=1,M.ufrag=z.getLocalParameters().usernameFragment,M=f.writeCandidate(M),G.candidate=Object.assign(G.candidate,f.parseCandidate(M)),G.candidate.candidate=M,G.candidate.toJSON=function(){return{candidate:G.candidate.candidate,
sdpMid:G.candidate.sdpMid,sdpMLineIndex:G.candidate.sdpMLineIndex,usernameFragment:G.candidate.usernameFragment}};M=f.getMediaSections(w._localDescription.sdp);M[G.candidate.sdpMLineIndex]=D?M[G.candidate.sdpMLineIndex]+"a=end-of-candidates\r\n":M[G.candidate.sdpMLineIndex]+("a="+G.candidate.candidate+"\r\n");w._localDescription.sdp=f.getDescription(w._localDescription.sdp)+M.join("");M=w.transceivers.every(function(Z){return Z.iceGatherer&&"completed"===Z.iceGatherer.state});"gathering"!==w.iceGatheringState&&
(w.iceGatheringState="gathering",w._emitGatheringStateChange());D||w._dispatchEvent("icecandidate",G);M&&(w._dispatchEvent("icecandidate",new Event("icecandidate")),w.iceGatheringState="complete",w._emitGatheringStateChange())}};m.setTimeout(function(){B.forEach(function(D){z.onlocalcandidate(D)})},0)}};v.prototype._createIceAndDtlsTransports=function(){var n=this,p=new m.RTCIceTransport(null);p.onicestatechange=function(){n._updateIceConnectionState();n._updateConnectionState()};var w=new m.RTCDtlsTransport(p);
...
p._isClosed)return Promise.reject(k("InvalidStateError","Can not set local "+n.type+" in state "+p.signalingState));if("offer"===n.type){var w=f.splitSections(n.sdp);var z=w.shift();w.forEach(function(D,G){D=f.parseRtpParameters(D);p.transceivers[G].localCapabilities=D});p.transceivers.forEach(function(D,G){p._gather(D.mid,G)})}else if("answer"===n.type){w=f.splitSections(p._remoteDescription.sdp);z=w.shift();var B=0<f.matchPrefix(z,"a=ice-lite").length;w.forEach(function(D,G){var M=p.transceivers[G],
...
ma||"UDP/DTLS/SCTP"===ma))p.transceivers[J]={mid:oa,kind:T,protocol:ma,rejected:!0};else{!aa&&p.transceivers[J]&&p.transceivers[J].rejected&&(p.transceivers[J]=p._createTransceiver(T,!0));var Ga=f.parseRtpParameters(L);if(!aa){var pa=f.getIceParameters(L,D);var Ha=f.getDtlsParameters(L,D);Ha.role="client"}ma=f.parseRtpEncodingParameters(L);var Ia=f.parseRtcpParameters(L),Ja=0<f.matchPrefix(L,"a=end-of-candidates",D).length,na=f.matchPrefix(L,"a=candidate:").map(function(Y){return f.parseCandidate(Y)}).filter(function(Y){return 1===
...
ha,w.default]))));else{var O=p.transceivers[J]||p._createTransceiver(T);O.mid=oa;O.iceGatherer||(O.iceGatherer=p._createIceGatherer(J,M));na.length&&"new"===O.iceTransport.state&&(!Ja||M&&0!==J?na.forEach(function(Y){q(O.iceTransport,Y)}):O.iceTransport.setRemoteCandidates(na));L=m.RTCRtpReceiver.getCapabilities(T);15019>t&&(L.codecs=L.codecs.filter(function(Y){return"rtx"!==Y.name}));aa=O.sendEncodingParameters||[{ssrc:1001*(2*J+2)}];pa=!1;if("sendrecv"===Q||"sendonly"===Q){pa=!O.rtpReceiver;var ha=
...
function(n){var p=this;if(p._isClosed)return Promise.reject(k("InvalidStateError","Can not call createOffer after close"));var w=p.transceivers.filter(function(D){return"audio"===D.kind}).length,z=p.transceivers.filter(function(D){return"video"===D.kind}).length;if(n){if(n.mandatory||n.optional)throw new TypeError("Legacy mandatory/optional constraints not supported.");void 0!==n.offerToReceiveAudio&&(w=!0===n.offerToReceiveAudio?1:!1===n.offerToReceiveAudio?0:n.offerToReceiveAudio);void 0!==n.offerToReceiveVideo&&
(z=!0===n.offerToReceiveVideo?1:!1===n.offerToReceiveVideo?0:n.offerToReceiveVideo)}for(p.transceivers.forEach(function(D){"audio"===D.kind?(w--,0>w&&(D.wantReceive=!1)):"video"===D.kind&&(z--,0>z&&(D.wantReceive=!1))});0<w||0<z;)0<w&&(p._createTransceiver("audio"),w--),0<z&&(p._createTransceiver("video"),z--);var B=f.writeSessionBoilerplate(p._sdpSessionId,p._sdpSessionVersion++);p.transceivers.forEach(function(D,G){var M=D.track,Z=D.kind,L=D.mid||f.generateIdentifier();D.mid=L;D.iceGatherer||(D.iceGatherer=
...
L.headerExtensions.forEach(function(J){(D.remoteCapabilities&&D.remoteCapabilities.headerExtensions||[]).forEach(function(Q){J.uri===Q.uri&&(J.id=Q.id)})});G=D.sendEncodingParameters||[{ssrc:1001*(2*G+1)}];M&&15019<=t&&"video"===Z&&!G[0].rtx&&(G[0].rtx={ssrc:G[0].ssrc+1});D.wantReceive&&(D.rtpReceiver=new m.RTCRtpReceiver(D.dtlsTransport,Z));D.localCapabilities=L;D.sendEncodingParameters=G});"max-compat"!==p._config.bundlePolicy&&(B+="a=group:BUNDLE "+p.transceivers.map(function(D){return D.mid}).join(" ")+
"\r\n");B+="a=ice-options:trickle\r\n";p.transceivers.forEach(function(D,G){B+=d(D,D.localCapabilities,"offer",D.stream,p._dtlsRole);B+="a=rtcp-rsize\r\n";!D.iceGatherer||"new"===p.iceGatheringState||0!==G&&p.usingBundle||(D.iceGatherer.getLocalCandidates().forEach(function(M){M.component=1;B+="a="+f.writeCandidate(M)+"\r\n"}),"completed"===D.iceGatherer.state&&(B+="a=end-of-candidates\r\n"))});n=new m.RTCSessionDescription({type:"offer",sdp:B});return Promise.resolve(n)};v.prototype.createAnswer=
...
G=0<Object.keys(n.candidate).length?f.parseCandidate(n.candidate):{};if("tcp"===G.protocol&&(0===G.port||9===G.port)||G.component&&1!==G.component)return z();if((0===D||0<D&&M.iceTransport!==p.transceivers[0].iceTransport)&&!q(M.iceTransport,G))return B(k("OperationError","Can not add ICE candidate"));B=n.candidate.trim();0===B.indexOf("a=")&&(B=B.substr(2));w=f.getMediaSections(p._remoteDescription.sdp);w[D]+="a="+(G.type?B:"end-of-candidates")+"\r\n";p._remoteDescription.sdp=f.getDescription(p._remoteDescription.sdp)+
w.join("")}else return B(k("OperationError","Can not add ICE candidate"))}else for(D=0;D<p.transceivers.length&&(p.transceivers[D].rejected||(p.transceivers[D].iceTransport.addRemoteCandidate({}),w=f.getMediaSections(p._remoteDescription.sdp),w[D]+="a=end-of-candidates\r\n",p._remoteDescription.sdp=f.getDescription(p._remoteDescription.sdp)+w.join(""),!p.usingBundle));D++);else return B(k("InvalidStateError","Can not add ICE candidate without a remote description"));z()})};v.prototype.getStats=function(n){if(n&&
n instanceof m.MediaStreamTrack){var p=null;this.transceivers.forEach(function(z){z.rtpSender&&z.rtpSender.track===n?p=z.rtpSender:z.rtpReceiver&&z.rtpReceiver.track===n&&(p=z.rtpReceiver)});if(!p)throw k("InvalidAccessError","Invalid selector.");return p.getStats()}var w=[];this.transceivers.forEach(function(z){["rtpSender","rtpReceiver","iceGatherer","iceTransport","dtlsTransport"].forEach(function(B){z[B]&&w.push(z[B].getStats())})});return Promise.all(w).then(function(z){var B=new Map;z.forEach(function(D){D.forEach(function(G){B.set(G.id,
G)})});return B})};["RTCRtpSender","RTCRtpReceiver","RTCIceGatherer","RTCIceTransport","RTCDtlsTransport"].forEach(function(n){if((n=m[n])&&n.prototype&&n.prototype.getStats){var p=n.prototype.getStats;n.prototype.getStats=function(){return p.apply(this).then(function(w){var z=new Map;Object.keys(w).forEach(function(B){var D=w[B];w[B].type={inboundrtp:"inbound-rtp",outboundrtp:"outbound-rtp",candidatepair:"candidate-pair",localcandidate:"local-candidate",remotecandidate:"remote-candidate"}[D.type]||
D.type;z.set(B,w[B])});return z})}}});var A=["createOffer","createAnswer"];A.forEach(function(n){var p=v.prototype[n];v.prototype[n]=function(){var w=arguments;return"function"===typeof w[0]||"function"===typeof w[1]?p.apply(this,[arguments[2]]).then(function(z){"function"===typeof w[0]&&w[0].apply(null,[z])},function(z){"function"===typeof w[1]&&w[1].apply(null,[z])}):p.apply(this,arguments)}});A=["setLocalDescription","setRemoteDescription","addIceCandidate"];A.forEach(function(n){var p=v.prototype[n];
...
return v}},{sdp:17}],17:[function(a,b,c){var d={generateIdentifier:function(){return Math.random().toString(36).substr(2,10)}};d.localCName=d.generateIdentifier();d.splitLines=function(e){return e.trim().split("\n").map(function(g){return g.trim()})};d.splitSections=function(e){return e.split("\nm=").map(function(g,h){return(0<h?"m="+g:g).trim()+"\r\n"})};d.getDescription=function(e){return(e=d.splitSections(e))&&e[0]};d.getMediaSections=function(e){e=d.splitSections(e);e.shift();return e};d.matchPrefix=
function(e,g){return d.splitLines(e).filter(function(h){return 0===h.indexOf(g)})};d.parseCandidate=function(e){e=0===e.indexOf("a=candidate:")?e.substring(12).split(" "):e.substring(10).split(" ");for(var g={foundation:e[0],component:parseInt(e[1],10),protocol:e[2].toLowerCase(),priority:parseInt(e[3],10),ip:e[4],address:e[4],port:parseInt(e[5],10),type:e[7]},h=8;h<e.length;h+=2)switch(e[h]){case "raddr":g.relatedAddress=e[h+1];break;case "rport":g.relatedPort=parseInt(e[h+1],10);break;case "tcptype":g.tcpType=
e[h+1];break;case "ufrag":g.ufrag=e[h+1];g.usernameFragment=e[h+1];break;default:g[e[h]]=e[h+1]}return g};d.writeCandidate=function(e){var g=[];g.push(e.foundation);g.push(e.component);g.push(e.protocol.toUpperCase());g.push(e.priority);g.push(e.address||e.ip);g.push(e.port);var h=e.type;g.push("typ");g.push(h);"host"!==h&&e.relatedAddress&&e.relatedPort&&(g.push("raddr"),g.push(e.relatedAddress),g.push("rport"),g.push(e.relatedPort));e.tcpType&&"tcp"===e.protocol.toLowerCase()&&(g.push("tcptype"),
g.push(e.tcpType));if(e.usernameFragment||e.ufrag)g.push("ufrag"),g.push(e.usernameFragment||e.ufrag);return"candidate:"+g.join(" ")};d.parseIceOptions=function(e){return e.substr(14).split(" ")};d.parseRtpMap=function(e){e=e.substr(9).split(" ");var g={payloadType:parseInt(e.shift(),10)};e=e[0].split("/");g.name=e[0];g.clockRate=parseInt(e[1],10);g.channels=3===e.length?parseInt(e[2],10):1;g.numChannels=g.channels;return g};d.writeRtpMap=function(e){var g=e.payloadType;void 0!==e.preferredPayloadType&&
(g=e.preferredPayloadType);var h=e.channels||e.numChannels||1;return"a=rtpmap:"+g+" "+e.name+"/"+e.clockRate+(1!==h?"/"+h:"")+"\r\n"};d.parseExtmap=function(e){e=e.substr(9).split(" ");return{id:parseInt(e[0],10),direction:0<e[0].indexOf("/")?e[0].split("/")[1]:"sendrecv",uri:e[1]}};d.writeExtmap=function(e){return"a=extmap:"+(e.id||e.preferredId)+(e.direction&&"sendrecv"!==e.direction?"/"+e.direction:"")+" "+e.uri+"\r\n"};d.parseFmtp=function(e){for(var g={},h=e.substr(e.indexOf(" ")+1).split(";"),
q=0;q<h.length;q++)e=h[q].trim().split("="),g[e[0].trim()]=e[1];return g};d.writeFmtp=function(e){var g="",h=e.payloadType;void 0!==e.preferredPayloadType&&(h=e.preferredPayloadType);if(e.parameters&&Object.keys(e.parameters).length){var q=[];Object.keys(e.parameters).forEach(function(k){e.parameters[k]?q.push(k+"="+e.parameters[k]):q.push(k)});g+="a=fmtp:"+h+" "+q.join(";")+"\r\n"}return g};d.parseRtcpFb=function(e){e=e.substr(e.indexOf(" ")+1).split(" ");return{type:e.shift(),parameter:e.join(" ")}};
d.writeRtcpFb=function(e){var g="",h=e.payloadType;void 0!==e.preferredPayloadType&&(h=e.preferredPayloadType);e.rtcpFeedback&&e.rtcpFeedback.length&&e.rtcpFeedback.forEach(function(q){g+="a=rtcp-fb:"+h+" "+q.type+(q.parameter&&q.parameter.length?" "+q.parameter:"")+"\r\n"});return g};d.parseSsrcMedia=function(e){var g=e.indexOf(" "),h={ssrc:parseInt(e.substr(7,g-7),10)},q=e.indexOf(":",g);-1<q?(h.attribute=e.substr(g+1,q-g-1),h.value=e.substr(q+1)):h.attribute=e.substr(g+1);return h};d.parseSsrcGroup=
function(e){e=e.substr(13).split(" ");return{semantics:e.shift(),ssrcs:e.map(function(g){return parseInt(g,10)})}};d.getMid=function(e){if(e=d.matchPrefix(e,"a=mid:")[0])return e.substr(6)};d.parseFingerprint=function(e){e=e.substr(14).split(" ");return{algorithm:e[0].toLowerCase(),value:e[1]}};d.getDtlsParameters=function(e,g){return{role:"auto",fingerprints:d.matchPrefix(e+g,"a=fingerprint:").map(d.parseFingerprint)}};d.writeDtlsParameters=function(e,g){var h="a=setup:"+g+"\r\n";e.fingerprints.forEach(function(q){h+=
"a=fingerprint:"+q.algorithm+" "+q.value+"\r\n"});return h};d.parseCryptoLine=function(e){e=e.substr(9).split(" ");return{tag:parseInt(e[0],10),cryptoSuite:e[1],keyParams:e[2],sessionParams:e.slice(3)}};d.writeCryptoLine=function(e){return"a=crypto:"+e.tag+" "+e.cryptoSuite+" "+("object"===typeof e.keyParams?d.writeCryptoKeyParams(e.keyParams):e.keyParams)+(e.sessionParams?" "+e.sessionParams.join(" "):"")+"\r\n"};d.parseCryptoKeyParams=function(e){if(0!==e.indexOf("inline:"))return null;e=e.substr(7).split("|");
return{keyMethod:"inline",keySalt:e[0],lifeTime:e[1],mkiValue:e[2]?e[2].split(":")[0]:void 0,mkiLength:e[2]?e[2].split(":")[1]:void 0}};d.writeCryptoKeyParams=function(e){return e.keyMethod+":"+e.keySalt+(e.lifeTime?"|"+e.lifeTime:"")+(e.mkiValue&&e.mkiLength?"|"+e.mkiValue+":"+e.mkiLength:"")};d.getCryptoParameters=function(e,g){return d.matchPrefix(e+g,"a=crypto:").map(d.parseCryptoLine)};d.getIceParameters=function(e,g){var h=d.matchPrefix(e+g,"a=ice-ufrag:")[0];e=d.matchPrefix(e+g,"a=ice-pwd:")[0];
return h&&e?{usernameFragment:h.substr(12),password:e.substr(10)}:null};d.writeIceParameters=function(e){return"a=ice-ufrag:"+e.usernameFragment+"\r\na=ice-pwd:"+e.password+"\r\n"};d.parseRtpParameters=function(e){for(var g={codecs:[],headerExtensions:[],fecMechanisms:[],rtcp:[]},h=d.splitLines(e)[0].split(" "),q=3;q<h.length;q++){var k=h[q],f=d.matchPrefix(e,"a=rtpmap:"+k+" ")[0];if(f){f=d.parseRtpMap(f);var m=d.matchPrefix(e,"a=fmtp:"+k+" ");f.parameters=m.length?d.parseFmtp(m[0]):{};f.rtcpFeedback=
d.matchPrefix(e,"a=rtcp-fb:"+k+" ").map(d.parseRtcpFb);g.codecs.push(f);switch(f.name.toUpperCase()){case "RED":case "ULPFEC":g.fecMechanisms.push(f.name.toUpperCase())}}}d.matchPrefix(e,"a=extmap:").forEach(function(t){g.headerExtensions.push(d.parseExtmap(t))});return g};d.writeRtpDescription=function(e,g){var h="";h+="m="+e+" ";h+=0<g.codecs.length?"9":"0";h+=" UDP/TLS/RTP/SAVPF ";h+=g.codecs.map(function(k){return void 0!==k.preferredPayloadType?k.preferredPayloadType:k.payloadType}).join(" ")+
"\r\n";h+="c=IN IP4 0.0.0.0\r\n";h+="a=rtcp:9 IN IP4 0.0.0.0\r\n";g.codecs.forEach(function(k){h+=d.writeRtpMap(k);h+=d.writeFmtp(k);h+=d.writeRtcpFb(k)});var q=0;g.codecs.forEach(function(k){k.maxptime>q&&(q=k.maxptime)});0<q&&(h+="a=maxptime:"+q+"\r\n");h+="a=rtcp-mux\r\n";g.headerExtensions&&g.headerExtensions.forEach(function(k){h+=d.writeExtmap(k)});return h};d.parseRtpEncodingParameters=function(e){var g=[],h=d.parseRtpParameters(e),q=-1!==h.fecMechanisms.indexOf("RED"),k=-1!==h.fecMechanisms.indexOf("ULPFEC"),
f=d.matchPrefix(e,"a=ssrc:").map(function(r){return d.parseSsrcMedia(r)}).filter(function(r){return"cname"===r.attribute}),m=0<f.length&&f[0].ssrc,t;f=d.matchPrefix(e,"a=ssrc-group:FID").map(function(r){return r.substr(17).split(" ").map(function(y){return parseInt(y,10)})});0<f.length&&1<f[0].length&&f[0][0]===m&&(t=f[0][1]);h.codecs.forEach(function(r){"RTX"===r.name.toUpperCase()&&r.parameters.apt&&(r={ssrc:m,codecPayloadType:parseInt(r.parameters.apt,10)},m&&t&&(r.rtx={ssrc:t}),g.push(r),q&&(r=
JSON.parse(JSON.stringify(r)),r.fec={ssrc:m,mechanism:k?"red+ulpfec":"red"},g.push(r)))});0===g.length&&m&&g.push({ssrc:m});var x=d.matchPrefix(e,"b=");x.length&&(x=0===x[0].indexOf("b=TIAS:")?parseInt(x[0].substr(7),10):0===x[0].indexOf("b=AS:")?950*parseInt(x[0].substr(5),10)-16E3:void 0,g.forEach(function(r){r.maxBitrate=x}));return g};d.parseRtcpParameters=function(e){var g={},h=d.matchPrefix(e,"a=ssrc:").map(function(q){return d.parseSsrcMedia(q)}).filter(function(q){return"cname"===q.attribute})[0];
h&&(g.cname=h.value,g.ssrc=h.ssrc);h=d.matchPrefix(e,"a=rtcp-rsize");g.reducedSize=0<h.length;g.compound=0===h.length;e=d.matchPrefix(e,"a=rtcp-mux");g.mux=0<e.length;return g};d.parseMsid=function(e){var g=d.matchPrefix(e,"a=msid:");if(1===g.length)return e=g[0].substr(7).split(" "),{stream:e[0],track:e[1]};e=d.matchPrefix(e,"a=ssrc:").map(function(h){return d.parseSsrcMedia(h)}).filter(function(h){return"msid"===h.attribute});if(0<e.length)return e=e[0].value.split(" "),{stream:e[0],track:e[1]}};
d.parseSctpDescription=function(e){var g=d.parseMLine(e),h=d.matchPrefix(e,"a=max-message-size:"),q;0<h.length&&(q=parseInt(h[0].substr(19),10));isNaN(q)&&(q=65536);h=d.matchPrefix(e,"a=sctp-port:");if(0<h.length)return{port:parseInt(h[0].substr(12),10),protocol:g.fmt,maxMessageSize:q};if(0<d.matchPrefix(e,"a=sctpmap:").length)return e=d.matchPrefix(e,"a=sctpmap:")[0].substr(10).split(" "),{port:parseInt(e[0],10),protocol:e[1],maxMessageSize:q}};d.writeSctpDescription=function(e,g){e="DTLS/SCTP"!==
e.protocol?["m="+e.kind+" 9 "+e.protocol+" "+g.protocol+"\r\n","c=IN IP4 0.0.0.0\r\n","a=sctp-port:"+g.port+"\r\n"]:["m="+e.kind+" 9 "+e.protocol+" "+g.port+"\r\n","c=IN IP4 0.0.0.0\r\n","a=sctpmap:"+g.port+" "+g.protocol+" 65535\r\n"];void 0!==g.maxMessageSize&&e.push("a=max-message-size:"+g.maxMessageSize+"\r\n");return e.join("")};d.generateSessionId=function(){return Math.random().toString().substr(2,21)};d.writeSessionBoilerplate=function(e,g,h){g=void 0!==g?g:2;e=e?e:d.generateSessionId();return"v=0\r\no="+
(h||"thisisadapterortc")+" "+e+" "+g+" IN IP4 127.0.0.1\r\ns=-\r\nt=0 0\r\n"};d.writeMediaSection=function(e,g,h,q){g=d.writeRtpDescription(e.kind,g);g+=d.writeIceParameters(e.iceGatherer.getLocalParameters());g+=d.writeDtlsParameters(e.dtlsTransport.getLocalParameters(),"offer"===h?"actpass":"active");g+="a=mid:"+e.mid+"\r\n";g=e.direction?g+("a="+e.direction+"\r\n"):e.rtpSender&&e.rtpReceiver?g+"a=sendrecv\r\n":e.rtpSender?g+"a=sendonly\r\n":e.rtpReceiver?g+"a=recvonly\r\n":g+"a=inactive\r\n";e.rtpSender&&
(h="msid:"+q.id+" "+e.rtpSender.track.id+"\r\n",g=g+("a="+h)+("a=ssrc:"+e.sendEncodingParameters[0].ssrc+" "+h),e.sendEncodingParameters[0].rtx&&(g+="a=ssrc:"+e.sendEncodingParameters[0].rtx.ssrc+" "+h,g+="a=ssrc-group:FID "+e.sendEncodingParameters[0].ssrc+" "+e.sendEncodingParameters[0].rtx.ssrc+"\r\n"));g+="a=ssrc:"+e.sendEncodingParameters[0].ssrc+" cname:"+d.localCName+"\r\n";e.rtpSender&&e.sendEncodingParameters[0].rtx&&(g+="a=ssrc:"+e.sendEncodingParameters[0].rtx.ssrc+" cname:"+d.localCName+
"\r\n");return g};d.getDirection=function(e,g){e=d.splitLines(e);for(var h=0;h<e.length;h++)switch(e[h]){case "a=sendrecv":case "a=sendonly":case "a=recvonly":case "a=inactive":return e[h].substr(2)}return g?d.getDirection(g):"sendrecv"};d.getKind=function(e){return d.splitLines(e)[0].split(" ")[0].substr(2)};d.isRejected=function(e){return"0"===e.split(" ",2)[1]};d.parseMLine=function(e){e=d.splitLines(e)[0].substr(2).split(" ");return{kind:e[0],port:parseInt(e[1],10),protocol:e[2],fmt:e.slice(3).join(" ")}};
d.parseOLine=function(e){e=d.matchPrefix(e,"o=")[0].substr(2).split(" ");return{username:e[0],sessionId:e[1],sessionVersion:parseInt(e[2],10),netType:e[3],addressType:e[4],address:e[5]}};d.isValidSDP=function(e){if("string"!==typeof e||0===e.length)return!1;e=d.splitLines(e);for(var g=0;g<e.length;g++)if(2>e[g].length||"="!==e[g].charAt(1))return!1;return!0};"object"===typeof b&&(b.exports=d)},{}]},{},[1])(1)});class pc{constructor(a){this.FrameDisplayDeltaTimeMs=this.BrowserReceiptTimeMs=this.UETransmissionTimeMs=
...
ueTestDuration:c.toFixed(1),networkLatency:d.toFixed(1)};this.FrameDisplayDeltaTimeMs&&this.BrowserReceiptTimeMs&&(e.endToEndLatency=this.FrameDisplayDeltaTimeMs+d+("string"===typeof b?0:b),e.browserSideLatency=this.FrameDisplayDeltaTimeMs+(a-d-c),e.endToEndLatency=e.endToEndLatency.toFixed(1),e.browserSideLatency=e.browserSideLatency.toFixed(1));if(this.onReady)this.onReady(e)}}}class qc{constructor(a,b){this.useStats=a.useStats;this.events=a.events;this.webRtcConfig=a.peerConnectionOptions||{};
this.webRtcConfig.sdpSemantics="unified-plan";this.tnClient=this.dcClient=this.pcClient=null;this.sdpConstraints={offerToReceiveAudio:0,offerToReceiveVideo:1,voiceActivityDetection:!1};this.dataChannelOptions={ordered:!0};this.lastStats={};this.playerId=0;this.latencyTestTimings=new pc(this.events.onLatencyTimingsReady);this.api_isSending=!1;this.api_queue=[];this.player=b;this.api_enableLog=a.enableApiCallLog;this.log=(c,d,e)=>this.player.getAPI().log(c,d,e)}setVideo(a){this.video=a}logStartupInfo(a){if(this.events.onlog)this.events.onlog(a)}logApiCall(a,
...
(clearInterval(this.aggregateStatsIntervalId),this.aggregateStatsIntervalId=void 0)}send(a){return this.dcClient&&"open"==this.dcClient.readyState?(this.dcClient.send(a),!0):!1}requestInitialSettings(){this.send((new Uint8Array([7])).buffer)}requestQualityControl(){this.send((new Uint8Array([1])).buffer)}sendEnableIntervalSendQP(a){this.send((new Uint8Array([11,a?1:0])).buffer)}sendEnableReceiveEvents(a){this.send((new Uint8Array([12,a?1:0])).buffer)}_createApiBinBuffer(a,b,c){let d=new DataView(new ArrayBuffer(this.headerOffset+
2*b)),e=0;d.setUint8(e,52);e++;d.setUint8(e,a);e++;d.setUint16(e,b,!0);e+=2;for(a=0;a<c.length;a++)d.setUint16(e,c.charCodeAt(a),!0),e+=2;return d.buffer}_pushApiToSendingQueue(a){if("object"==typeof a){a.__playerId=this.playerId;var b=JSON.stringify(a);a=b.length;if(a>this.lenPerChunk){let d=Math.ceil(a/this.lenPerChunk);for(let e=0;e<d;e++){var c=0==e?1:e==d-1?3:2;let g=e==d-1?a-e*this.lenPerChunk:this.lenPerChunk,h=b.substr(e*this.lenPerChunk,g);c=this._createApiBinBuffer(c,g,h);this.api_queue.push(c)}this.logApiCall(`Push ${d} chunks, length: ${a}`)}else b=
...
b=>{this.logPerfTest(`[bufferedamountlow] sendCalls: ${this.pt_numberOfSendCalls}, sended: ${this.pt_sended}, bufferedAmount: ${this.dcClient.bufferedAmount}`,!1,"gray");this.pt_finished||this.pt_send()},this.pt_create_data=()=>{var b=new Date;b=b.toLocaleString()+"."+b.getMilliseconds();let c=new DataView(new ArrayBuffer(this.chunkSize)),d=0;c.setUint8(d,53);d++;c.setUint16(d,b.length,!0);d+=2;for(let e=0;e<b.length;e++)c.setUint16(d,b.charCodeAt(e),!0),d+=2;return c.buffer},this.pt_send=()=>{null!==
...
Shift:16,Control:17,Alt:18,RightShift:253,RightControl:254,RightAlt:255};class tc extends ia{constructor(a,b){super(a);this.video=null;this.useBuiltinCursors=b.useBuiltinCursors;this.keyEventTargetStr=b.keyEventTarget;this.keyEventTarget="document"==b.keyEventTarget?document:"none"==b.keyEventTarget?null:"video";this.callOnUserInteraction=()=>this.player.resetInteractTimestamp();this.fakeMouseWithTouches=!1;this.onMButtonDoubleClick=b.onMButtonDoubleClick;this.mouseKeyListener=b.mouseKeyListener;
this.touchListener=b.touchListener;this.onActionEnable=!0;this.onEvents=b.onEvents;this.onVideoLoaded=b.onVideoLoaded;this.orientationChangeTimeout=void 0;document.addEventListener("WeixinJSBridgeReady",()=>{R.isInWeixinBrowser=!0;this.video.play()});this.create()}registerEvents(){window.addEventListener("orientationchange",()=>{clearTimeout(this.orientationChangeTimeout);this.orientationChangeTimeout=setTimeout(()=>this.player.resize(),500)});this.registerKeyboardEvents();this.registerMouseEvents();
...
R.isAndroidDevice||R.isIOSDevice&&!R.isInWeixinBrowser)&&this.create();this.rtc=a;this.rtc.setVideo(this.video)}setActionEventEnabled(a){this.onActionEnable=a}destroy(){this.video&&(this.removeElement(this.video),this.video=null)}valid(){return!!this.video}videoWidth(){let a;return null==(a=this.video)?void 0:a.videoWidth}videoHeight(){let a;return null==(a=this.video)?void 0:a.videoHeight}clientWidth(){let a;return null==(a=this.video)?void 0:a.clientWidth}clientHeight(){let a;return null==(a=this.video)?
void 0:a.clientHeight}resize(a){this.playerAspectRatio=this.container.clientHeight/this.container.clientWidth;this.videoAspectRatio=a?this.playerAspectRatio:this.videoHeight()/this.videoWidth()}setTrack(a){let b=a.streams[0];this.player.logStartupInfo("track: "+a.track.kind);"audio"==a.track.kind?(a=document.createElement("Audio"),a.autoplay=!0,a.srcObject=b,a.play(),this.player.logStartupInfo("audio element created")):"video"==a.track.kind&&this.video.srcObject!==b&&(this.video.srcObject=b)}setKeyEventTarget(a){this.keyEventTargetStr!=
...
a=>{112<=a.keyCode&&123>=a.keyCode||a.ctrlKey||this.sendKeydown(a);if(a.keyCode===ea.BackSpace)this.keyEventTarget.onkeypress({charCode:ea.BackSpace});this.callActionEventHander(5,a)},this.keyEventTarget.onkeyup=a=>{112<=a.keyCode&&123>=a.keyCode||a.ctrlKey||this.sendKeyup(a);this.callActionEventHander(6,a)},this.keyEventTarget.onkeypress=a=>{112<=a.keyCode&&123>=a.keyCode||this.sendKeypress(a);this.callActionEventHander(7,a)})}setCursor(){if(this.video)if(this.useBuiltinCursors)switch(this.mouseDownButton){case 0:this.video.setAttribute("class",
"streamingVideoCursorPan");break;case 1:this.video.setAttribute("class","streamingVideoCursorMove");break;case 2:this.video.setAttribute("class","streamingVideoCursorRotate");break;default:this.video.setAttribute("class","streamingVideoCursorPointer")}else this.video.setAttribute("class","streamingVideoNoCursor")}callActionEventHander(a,b){if(this.mouseKeyListener&&this.onActionEnable)switch(a){case 0:if(R.isFunction(this.mouseKeyListener.onMouseEnter))this.mouseKeyListener.onMouseEnter(b);break;
case 1:if(R.isFunction(this.mouseKeyListener.onMouseLeave))this.mouseKeyListener.onMouseLeave(b);break;case 2:if(R.isFunction(this.mouseKeyListener.onMouseMove))this.mouseKeyListener.onMouseMove(b);break;case 3:if(R.isFunction(this.mouseKeyListener.onMouseDown))this.mouseKeyListener.onMouseDown(b);break;case 4:if(R.isFunction(this.mouseKeyListener.onMouseUp))this.mouseKeyListener.onMouseUp(b);break;case 5:if(R.isFunction(this.mouseKeyListener.onKeyDown))this.mouseKeyListener.onKeyDown(b);break;case 6:if(R.isFunction(this.mouseKeyListener.onKeyUp))this.mouseKeyListener.onKeyUp(b);
break;case 7:if(R.isFunction(this.mouseKeyListener.onKeyPress))this.mouseKeyListener.onKeyPress(b)}}isMiddleDoubleClick(a){if(1==a.button){if(this.lastMClickTimestamp&&200>a.timeStamp-this.lastMClickTimestamp)return!0;this.lastMClickTimestamp=a.timeStamp}else this.lastMClickTimestamp=void 0;return!1}normalizeAndQuantizeUnsigned(a,b){if(this.playerAspectRatio>this.videoAspectRatio){let c=this.playerAspectRatio/this.videoAspectRatio;a/=this.container.clientWidth;b=c*(b/this.container.clientHeight-.5)+
.5}else a=this.videoAspectRatio/this.playerAspectRatio*(a/this.container.clientWidth-.5)+.5,b/=this.container.clientHeight;return 0>a||1<a||0>b||1<b?{inRange:!1,x:65535,y:65535}:{inRange:!0,x:65536*a,y:65536*b}}normalizeAndQuantizeSigned(a,b){if(this.playerAspectRatio>this.videoAspectRatio){let c=this.playerAspectRatio/this.videoAspectRatio;a/=.5*this.container.clientWidth;b=c*b/(.5*this.container.clientHeight);return{x:32767*a,y:32767*b}}return{x:this.videoAspectRatio/this.playerAspectRatio*a/(.5*
this.container.clientWidth)*32767,y:b/(.5*this.container.clientHeight)*32767}}registerMouseEvents(){this.video.onmouseenter=a=>{this.sendMouseEnter();a.buttons&1&&this.sendMouseDown(0,a.offsetX,a.offsetY);a.buttons&2&&this.sendMouseDown(2,a.offsetX,a.offsetY);a.buttons&4&&this.sendMouseDown(1,a.offsetX,a.offsetY);a.buttons&8&&this.sendMouseDown(3,a.offsetX,a.offsetY);a.buttons&16&&this.sendMouseDown(4,a.offsetX,a.offsetY);this.callActionEventHander(0,a)};this.video.onmouseleave=a=>{this.sendMouseLeave();
a.buttons&1&&this.sendMouseUp(0,a.offsetX,a.offsetY);a.buttons&2&&this.sendMouseUp(2,a.offsetX,a.offsetY);a.buttons&4&&this.sendMouseUp(1,a.offsetX,a.offsetY);a.buttons&8&&this.sendMouseUp(3,a.offsetX,a.offsetYy);a.buttons&16&&this.sendMouseUp(4,a.offsetX,a.offsetY);this.callActionEventHander(1,a)};this.video.onmousemove=a=>{this.sendMouseMove(a.offsetX,a.offsetY,a.movementX,a.movementY);a.preventDefault();if(0==this.mouseDownButton||2==this.mouseDownButton)this.setCursor(),this.mouseDownButton=void 0;
this.callActionEventHander(2,a)};this.video.onmousedown=a=>{this.keyEventTarget==this.video&&this.video.focus();this.sendMouseEnter();this.isMiddleDoubleClick(a)&&this.onMButtonDoubleClick?(this.onMButtonDoubleClick(a.offsetX,a.offsetY),a.preventDefault()):(this.mouseDownButton=a.button,this.sendMouseDown(a.button,a.offsetX,a.offsetY),a.preventDefault(),0!=a.button&&2!=a.button&&this.setCursor(),this.callActionEventHander(3,a))};this.video.onmouseup=a=>{this.mouseDownButton=void 0;this.sendMouseUp(a.button,
a.offsetX,a.offsetY);a.preventDefault();this.setCursor();this.callActionEventHander(4,a)};this.video.oncontextmenu=a=>{a.preventDefault()};"onmousewheel"in this.video?this.video.addEventListener("mousewheel",a=>{this.sendMouseWheel(a.wheelDelta,a.offsetX,a.offsetY);a.preventDefault()},{passive:!1}):this.video.addEventListener("DOMMouseScroll",a=>{this.sendMouseWheel(-120*a.detail,a.offsetX,a.offsetY);a.preventDefault()},!1)}registerTouchEvents(){this.initFingers=()=>{this.fingers=[9,8,7,6,5,4,3,2,
1,0];this.fingerIds={};this.bWaitFor0Fingers=!1};this.rememberTouch=a=>{let b=this.fingers.pop();if(void 0===b){let c;null==(c=this.onEvents)||c.call(this,"\tError! Exhausted touch indentifiers!")}else this.fingerIds[a.identifier]=b};this.forgetTouch=a=>{this.fingers.push(this.fingerIds[a.identifier]);delete this.fingerIds[a.identifier]};this.triggerTouchEvent=(a,b)=>{"function"===typeof this.touchListener&&this.onActionEnable&&this.touchListener(a,b)};this.initFingers();this.handleTouchStart=a=>
{a.preventDefault();let b;null==(b=this.onEvents)||b.call(this,`[S] ${a.touches.length} / ${a.changedTouches.length}`);if(this.bWaitFor0Fingers){let d;null==(d=this.onEvents)||d.call(this,"\tWaiting...")}else if(2<a.touches.length){this.bWaitFor0Fingers=!0;let d;null==(d=this.onEvents)||d.call(this,"\tWAITING START!");this.sendTouch(81,a.touches)}else{for(let d of a.changedTouches)this.rememberTouch(d);var c;null==(c=this.onEvents)||c.call(this,`\t${JSON.stringify(this.fingerIds)} ${JSON.stringify(this.fingers)}`);
this.sendTouch(80,a.changedTouches);this.triggerTouchEvent("touchstart",a)}};this.handleTouchMove=a=>{a.preventDefault();let b;null==(b=this.onEvents)||b.call(this,`[M] ${a.touches.length} / ${a.changedTouches.length}`);if(this.bWaitFor0Fingers){let c;null==(c=this.onEvents)||c.call(this,"\tWaiting...")}else this.sendTouch(82,a.touches),this.triggerTouchEvent("touchmove",a)};this.handleTouchEnd=a=>{a.preventDefault();let b;null==(b=this.onEvents)||b.call(this,`[E] ${a.touches.length} / ${a.changedTouches.length}`);
if(this.bWaitFor0Fingers){if(0==a.touches.length){this.bWaitFor0Fingers=!1;this.initFingers();let d;null==(d=this.onEvents)||d.call(this,"\tWAITING END!")}}else{this.sendTouch(81,a.changedTouches);for(let d of a.changedTouches)this.forgetTouch(d);var c;null==(c=this.onEvents)||c.call(this,`\t${JSON.stringify(this.fingerIds)} ${JSON.stringify(this.fingers)}`);this.triggerTouchEvent("touchend",a)}};this.handleTouchCancel=a=>{a.preventDefault();let b;null==(b=this.onEvents)||b.call(this,`[C] ${a.touches.length} / ${a.changedTouches.length}`);
this.sendTouch(81,a.changedTouches);this.initFingers();this.triggerTouchEvent("touchcancel",a)};this.video.addEventListener("touchstart",a=>this.handleTouchStart(a),!1);this.video.addEventListener("touchmove",a=>this.handleTouchMove(a),!1);this.video.addEventListener("touchend",a=>this.handleTouchEnd(a),!1);this.video.addEventListener("touchcancel",a=>this.handleTouchCancel(a),!1)}sendTouch(a,b){this.callOnUserInteraction();let c=new DataView(new ArrayBuffer(2+10*b.length));c.setUint8(0,a);c.setUint8(1,
b.length);a=2;let d=[],e=this.video.getBoundingClientRect();for(let g of b){let h=g.clientX-e.left,q=g.clientY-e.top,k=this.normalizeAndQuantizeUnsigned(h,q),f=this.fingerIds[g.identifier];if(void 0==f){let m;null==(m=this.onEvents)||m.call(this,`\tError! Invalid: ${g.identifier}, ${JSON.stringify(this.fingerIds)} ${JSON.stringify(this.fingers)}, count:${b.length}`)}else c.setUint16(a,k.x,!0),a+=2,c.setUint16(a,k.y,!0),a+=2,c.setInt32(a,f,!0),a+=4,c.setUint8(a,255*g.force,!0),a+=1,c.setUint8(a,k.inRange?
1:0,!0),a+=1,d.push(`{${f} (${parseInt(h)},${parseInt(q)})->(${parseInt(k.x)},${parseInt(k.y)})}`)}this.rtc.send(c.buffer)}sendKeydown(a){this.callOnUserInteraction();let b=Ba(a),c;null==(c=this.onEvents)||c.call(this,`Send KeyDown, Code:${b}, Repeat:${a.repeat}`);this.rtc.send((new Uint8Array([60,b,a.repeat])).buffer)}sendKeyup(a){this.callOnUserInteraction();a=Ba(a);let b;null==(b=this.onEvents)||b.call(this,`Send KeyUp:${a}`);this.rtc.send((new Uint8Array([61,a])).buffer)}sendKeypress(a){this.callOnUserInteraction();
var b;null==(b=this.onEvents)||b.call(this,`Send KeyPress:${a.charCode}`);b=new DataView(new ArrayBuffer(3));b.setUint8(0,62);b.setUint16(1,a.charCode,!0);this.rtc.send(b.buffer)}sendMouseEnter(){this.callOnUserInteraction();var a;null==(a=this.onEvents)||a.call(this,"Send MouseEnter");a=new DataView(new ArrayBuffer(1));a.setUint8(0,70);this.rtc.send(a.buffer)}sendMouseLeave(){this.callOnUserInteraction();var a;null==(a=this.onEvents)||a.call(this,"Send MouseLeave");a=new DataView(new ArrayBuffer(1));
a.setUint8(0,71);this.rtc.send(a.buffer)}sendMouseMove(a,b,c,d){this.callOnUserInteraction();this.normalizeAndQuantizeUnsigned&&(a=this.normalizeAndQuantizeUnsigned(a,b),c=this.normalizeAndQuantizeSigned(c,d),d=new DataView(new ArrayBuffer(9)),d.setUint8(0,74),d.setUint16(1,a.x,!0),d.setUint16(3,a.y,!0),d.setInt16(5,c.x,!0),d.setInt16(7,c.y,!0),this.rtc.send(d.buffer))}sendMouseDown(a,b,c){this.callOnUserInteraction();if(this.normalizeAndQuantizeUnsigned){var d;null==(d=this.onEvents)||d.call(this,
`Send MouseDown, Button:${a}, X:${b}, Y:${c}`);b=this.normalizeAndQuantizeUnsigned(b,c);c=new DataView(new ArrayBuffer(6));c.setUint8(0,72);c.setUint8(1,a);c.setUint16(2,b.x,!0);c.setUint16(4,b.y,!0);this.rtc.send(c.buffer)}}sendMouseUp(a,b,c){if(this.normalizeAndQuantizeUnsigned){var d;null==(d=this.onEvents)||d.call(this,`Send MouseUp, Button:${a}, X:${b}, Y:${c}`);b=this.normalizeAndQuantizeUnsigned(b,c);c=new DataView(new ArrayBuffer(6));c.setUint8(0,73);c.setUint8(1,a);c.setUint16(2,b.x,!0);
c.setUint16(4,b.y,!0);this.rtc.send(c.buffer)}}sendMouseWheel(a,b,c){this.callOnUserInteraction();if(this.normalizeAndQuantizeUnsigned){var d;null==(d=this.onEvents)||d.call(this,`Send MouseWheel, Delta:${a}, X:${b}, Y:${c}`);b=this.normalizeAndQuantizeUnsigned(b,c);c=new DataView(new ArrayBuffer(7));c.setUint8(0,75);c.setInt16(1,a,!0);c.setUint16(3,b.x,!0);c.setUint16(5,b.y,!0);this.rtc.send(c.buffer)}}}class uc extends ia{constructor(a,b,c){super(a);this.updateConnectionCount(b);this.createButton(c)}createButton(a){if(!this.elButton){this.elButton=
document.createElement("button");this.elButton.id=`liveStatusSwitchButton_${this.uniqueId}`;this.elButton.innerHTML=da.Information;this.elButton.title=a;this.elButton.className="__liveStatusSwitchButton";if(R.isIOSDevice||R.isSafari)this.elButton.style.backgroundSize="cover";this.elButton.oncontextmenu=new Function("return false");this.elButton.onselectstart=new Function("return false");this.elButton.onclick=()=>this.setPanelVisible();this.elButton.onmousedown=b=>{1==b.button&&b.preventDefault()};
this.appendElement(this.elButton)}}createPanel(){if(!this.elPanel){var a='<table border="0" cellspacing="0" cellpadding="0" style="position:absolute !important;padding:4px;left:0px;top:0px;width:100%;height:100%;">'+`<tr><td height="22" align="right" width="66" title="${H.getString("Connections")}-PlayerId-QualityControl">${H.getString("ConnInfo")}</td><td><span id="i_connections_${this.uniqueId}">1</span>-<span id="i_playerId_${this.uniqueId}">1</span></td><td align="right"><a id="i_hide_panel_${this.uniqueId}" href="javascript:">${H.getString("Close")}</a></td></tr>`+
...
{maximumFractionDigits:0,minimumIntegerDigits:2}),d=[],e=[60,60];for(let g=0;g<e.length;g++)d.push(b%e[g]),b/=e[g];d.push(b);e=d[0];b=d[1];d=d[2];b=60==b?0:b;e=c.format(60==e?0:e);b=c.format(Math.floor(b));c=c.format(Math.floor(d));this.setText("i_duration",c+":"+b+":"+e);this.setText("i_resolution",a.frameWidth&&a.frameHeight?a.frameWidth+" x "+a.frameHeight:"-");c="B";d=a.bytesReceived||0;b=["kB","MB","GB"];for(e=0;e<b.length&&!(1E5>d);e++)d/=1E3,c=b[e];this.setText("i_bytesReceived",this.formatNumber(d)+
...
this.setValue("i_settings_maxBitrate",a)}updateQPAndRenderFPS(a,b){let c=this.get("i_qp");c.style.color=35<a?"red":26<a?"orange":"rgb(128,255,0)";c.innerText=a;this.get("i_framerateRender").innerText=this.processValue(b)}}class vc extends ia{constructor(a){super(a);this.bDelayClear=!1;this.create()}create(){this.el=document.createElement("pre");this.el.id=`startupInfoPanel_${this.uniqueId}`;this.el.className="__startupInfoPanel";this.el.oncontextmenu=new Function("return false");this.el.onselectstart=
...
"function"==typeof a&&a(b,c)}getHost(){return this.host}getAPI(){return this.api}getInstanceInfo(){return this.paramInfo}getVideoElement(){let a;return null==(a=this.htmlVideo)?void 0:a.video}getVideoElementSize(){let a=this.getVideoElement();return{width:null==a?void 0:a.clientWidth,height:null==a?void 0:a.clientHeight}}getVideoStreamSize(){return{width:this.htmlVideo.videoWidth(),height:this.htmlVideo.videoHeight()}}getVideoSize(){return this.getVideoStreamSize()}screen2World(a,b,c){let d=this.getVideoElementSize(),
e=this.getVideoStreamSize(),g=0,h=0,q=e.height/e.width;d.height/d.width>q?h=-(d.width*q-d.height)/2:g=-(d.height/q-d.width)/2;a=e.width/(d.width-2*g)*(a-g);b=e.height/(d.height-2*h)*(b-h);return this.getAPI().coord.screen2World(a,b,c)}world2Screen(a,b,c,d){const e=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){let g=yield e.getAPI().coord.world2Screen(a,b,c,d),h=e.getVideoElementSize(),q=e.getVideoStreamSize(),k=0,f=0,m=q.height/q.width;h.height/h.width>m?f=-(h.width*m-h.height)/
2:k=-(h.height/m-h.width)/2;g.screenPosition=[g.screenPosition[0]/(q.width/(h.width-2*k))+k,g.screenPosition[1]/(q.height/(h.height-2*f))+f];return g})}setResolution(a,b){if(this.streamerAdaptive&&(0!=a||0!=b)){window.devicePixelRatio&&(a*=window.devicePixelRatio,b*=window.devicePixelRatio);if(4096<a||4096<b)b=a/b,1<=b?(a=4096,b=4096/b):(a=4096*b,b=4096);this.streamerAdaptive&&this.streamerLimitMaxResolution&&(a>this.streamerResX||b>this.streamerResY)&&(b=a/b,b>=this.streamerResX/this.streamerResY?
(a=this.streamerResX,b=this.streamerResX/b):(a=this.streamerResY*b,b=this.streamerResY));a=Math.floor(a);b=Math.floor(b);256>a&&(console.warn("ResX:"+a),a=256);256>b&&(console.warn("ResY:"+b),b=256);var c=this.htmlVideo.videoWidth(),d=this.htmlVideo.videoHeight();if(a!=c&&a+1!=c&&a-1!=c||b!=d&&b+1!=d&&b-1!=d){if(this.lastWidth&&this.lastHeight&&(c=Math.abs(this.lastWidth-a),d=Math.abs(this.lastHeight-b),(0!=c||0!=d)&&4>c&&4>d))return;this.lastWidth=a;this.lastHeight=b;this.rtc&&this.rtc.updateRenderResolution(a,
b);return[a,b]}}}destroy(a,b){console.log(`call DigitalTwinPlayer.destroy: ${a||" "}`);if(!this.isDestroyed){this.logStartupInfo(a||" ");ya--;this.isDestroyed=!0;this.destroyReason=a;var c;null==(c=this.rtc)||c.close();var d;null==(d=this.signallingConnection)||d.close(b)}}setKeyEventTarget(a){let b;null==(b=this.htmlVideo)||b.setKeyEventTarget(a)}setKeyEventReceiver(a){this.setKeyEventTarget(a)}resize(){if(this.container){this.rect=this.container.getBoundingClientRect();if(this.bNeedReposUI||!this.oldRect||
this.oldRect.width!=this.rect.width||this.oldRect.height!=this.rect.height){this.bNeedReposUI=!1;this.oldRect=this.rect;let b;null==(b=this.eventsPanel)||b.setPosition(this.rect);let c;null==(c=this.startupInfo)||c.setPosition(this.rect);let d;null==(d=this.liveStatus)||d.setPosition(this.rect);let e;null==(e=this.fullscreenButton)||e.setPosition(this.rect,this.options.ui.statusButton);let g;null==(g=this.homeButton)||g.setPosition(this.rect,this.options.ui.statusButton,this.options.ui.fullscreenButton);
let h;null==(h=this.taskListBar)||h.setPosition(this.rect,this.options.ui.statusButton,this.options.ui.fullscreenButton,this.options.ui.homeButton)}if(this.htmlVideo.valid()){this.canAdaptiveResolution&&this.setResolution(this.htmlVideo.clientWidth(),this.htmlVideo.clientHeight());var a;null==(a=this.htmlVideo)||a.resize(this.streamerAdaptive&&this.canAdaptiveResolution)}}}setInstanceOptions(a){const b=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){var c=a.pid==b.options.pid&&
a.iid==b.options.iid||!a.pid&&a.iid==b.options.iid||!a.iid&&a.pid==b.options.pid;if(c&&!a.reset)b.api.log("setInstanceOptions: no change.");else{if(!c){c=(!a.iid||a.iid==b.options.iid)&&a.pid!=b.options.pid;if(b.streamerLocked&&c){b.api.log(H.getString("CannotChangeProject"));return}c=yield b.signallingConnection.checkParams(a);if(null!==c){if(!1===c.iid){b.api.log(`iid(${a.iid})${H.getString("InstanceNotExist")}`);return}if(!1===c.pid){b.api.log(`pid(${a.pid})${H.getString("ProjectNotExist")}`);
return}}}console.warn("call setInstanceOptions!");b.destroy();b.options.iid=a.iid;b.options.pid=a.pid;b.options.reset=a.reset;b.constructUrlAndConnect()}})}set fullscreen(a){a?R.fullscreen(this.container):R.exitFullscreen()}get fullscreen(){return!!document.fullscreenElement}setActionEventEnabled(a){let b;null==(b=this.htmlVideo)||b.setActionEventEnabled(a)}perfTest(a){let b;null==(b=this.rtc)||b.perfTest(a)}onApiReady(){this.setStatus(U.OnReady);let a;null==(a=this.signallingConnection)||a.sendReady();
1==this.options.ui.mainUI?this.api.settings.setMainUIVisibility(!0):0==this.options.ui.mainUI&&this.api.settings.setMainUIVisibility(!1);1==this.options.ui.campass?this.api.settings.setCampassVisible(!0):0==this.options.ui.campass&&this.api.settings.setCampassVisible(!1)}sendApi(a,b){if(a)if(b){let c;null==(c=this.signallingConnection)||c.sendApi(a)}else{let c;null==(c=this.rtc)||c.sendApi(a)}}onMainThreadBusy(a){if(1===a.busy){let b="BUSY! ",c=this.api.apiQueue.queueSize(),d=this.api.apiQueue.dataSize();
0<c&&(b+=`${H.getString("JSQueue")}${c}/${d}\uff0c`);1<a.taskCount&&(b+=`${H.getString("BackQueue")}${a.taskCount}\uff0c`);b+=`${H.getString("Execting")}${l[a.currentTask]}${H.getString("PleaseWait")}`;this.hasVideo&&(this.htmlVideo.isVideoLoaded()&&this.options.ui.taskListBar||!this.htmlVideo.isVideoLoaded())&&this.taskListBar.updateText(b)}else this.taskListBar.hide()}viewHome(a){this.api.viewHome(a)}resetInteractTimestamp(){let a=Date.now();this.timeOfLastInteraction=a;let b;null==(b=this.signallingConnection)||
b.resetInteractTimestamp(a)}receiveParamInfo(a){this.paramInfo=a;let b=a.project,c=a.nodeIP,d=a.hostName;this.options.iid=a.iid;this.options.pid=a.pid;this.streamerAdaptive=a.adjustResolution;this.streamerLimitMaxResolution=a.limitMaxResolution;this.streamerResX=a.resX;this.streamerResY=a.resY;this.streamerLocked=a.locked;if(this.kickOutInMinutes=a.kickOutInMinutes){let g=setInterval(()=>{if(Date.now()-this.timeOfLastInteraction>6E4*this.kickOutInMinutes){let h=H.getString("DisconnectForIdle"),q;
null==(q=this.startupInfo)||q.setVisible(!0);this.destroy(h,ja.kicked);console.warn(h);clearInterval(g)}},2E4)}this.nodeInfoArray=[`${H.getString("NodeInfo")}`];d&&this.nodeInfoArray.push(`\t${H.getString("Host")}`+d);c&&this.nodeInfoArray.push(`\t${H.getString("HostAddress")}`+c);b&&this.nodeInfoArray.push(`\t\u3000${H.getString("Project")}`+b);this.options.pid&&this.nodeInfoArray.push(`\t${H.getString("ProjectId")}`+this.options.pid);this.nodeInfoArray.push(`\t${H.getString("IID")}`+this.options.iid);
this.nodeInfoArray.push(`\t${H.getString("Adaptive")}`+this.streamerAdaptive);this.nodeInfoArray.push(`\t${H.getString("LimitMaxRes")}`+this.streamerLimitMaxResolution);this.nodeInfoArray.push(`\t${H.getString("Resolution")}${this.streamerResX}x${this.streamerResY}`);let e;null==(e=this.liveStatus)||e.updateButtonTip(this.nodeInfoArray.join("\n"));this.api.log(this.nodeInfoArray.join("\n\t"))}logStartupInfo(a){if(a){a=`[${ua()}] ${a}`;var b;null==(b=this.startupInfo)||b.log(a);1<ya&&(a=`[${this.uniqueId}] `+
a);console.log("[DEBUG]"+a);this.api.log(a)}}setStatus(a,b){this.cloudStatus=a;let c;null==(c=this.statusIndicator)||c.setStatus(a);switch(a){case U.WS_Disconnected:if(this.isDestroyed){console.log("destroyed.");break}b&&(this.logStartupInfo(b),console.warn(b));break;case U.WS_Connecting:this.logStartupInfo(`connecting with ${this.useHttps?"wss":"ws"}...`);break;case U.WS_Connected:this.logStartupInfo("connected");break;case U.OnReady:let d;null==(d=this.startupInfo)||d.hide();this.options.ui.debugEventsPanel&&
!this.eventsPanel&&(this.eventsPanel=new rc(this),this.eventsPanel.appendText("Start recording events here:"))}}createWidgetsInConstructor(){this.taskListBar=new yc(this);this.htmlVideo=new tc(this,{keyEventTarget:this.options.keyEventTarget,useBuiltinCursors:this.options.useBuiltinCursors,mouseKeyListener:this.options.events.mouseKeyListener,touchListener:this.options.events.touchListener,onEvents:a=>{let b;return null==(b=this.eventsPanel)?void 0:b.appendText(a)},onVideoLoaded:()=>{this.logStartupInfo("video: loadedmetadata");
this.createWidgets();this.callEvent("onVideoLoaded");this.resize()},onMButtonDoubleClick:(a,b)=>{let c;null==(c=this.liveStatus)||c.setPanelVisible(a,b)}});this.options.ui.statusIndicator&&(this.statusIndicator=new wc(this));this.options.ui.startupInfo&&(this.startupInfo=new vc(this),this.logStartupInfo("sdk version: "+this.api.getVersion()),this.logStartupInfo("uniqueId: "+this.uniqueId));this.options.disableResizeObserver||R.isMobileDevice||(this.resizeObserver=new ResizeObserver(La(()=>this.resize(),
1E3)),this.resizeObserver.observe(this.container))}createWidgets(){this.options.ui.statusButton&&(this.liveStatus=new uc(this,this.playerCount,this.nodeInfoArray.join("\n")));this.options.ui.fullscreenButton&&(this.fullscreenButton=new sc(this));this.options.ui.homeButton&&(this.homeButton=new zc(this));this.taskListBar&&this.taskListBar.setMode(1)}destroyWidgets(){this.liveStatus&&(this.liveStatus.destroy(),this.liveStatus=null);this.fullscreenButton&&(this.fullscreenButton.destroy(),this.fullscreenButton=
null);this.homeButton&&(this.homeButton.destroy(),this.homeButton=null);this.eventsPanel&&(this.eventsPanel.destroy(),this.eventsPanel=null);this.taskListBar&&(this.taskListBar.destroy(),this.taskListBar=null)}isQualityController(){return this.bQualityController}initWebRtcPlayer(a){H.setLanguage(a.language);this.rtc=new qc({useStats:this.hasVideo&&(this.options.ui.statusButton||this.options.events.onRtcStatsReport),peerConnectionOptions:a.peerConnectionOptions,events:{onlog:b=>this.logStartupInfo(b),
ontrack:b=>{let c;null==(c=this.htmlVideo)||c.setTrack(b)},onicecandidate:b=>{let c;return null==(c=this.signallingConnection)?void 0:c.sendCandidate(b)},onOfferCreated:b=>{let c;return null==(c=this.signallingConnection)?void 0:c.sendOffer(b.sdp,this.hasVideo)},onAnswerCreated:b=>{let c;return null==(c=this.signallingConnection)?void 0:c.send(b)},onstats:b=>{let c;null==(c=this.liveStatus)||c.updateWebRtcStats(b);this.callEvent("onRtcStatsReport",b)},ondatachannelopen:()=>{this.setStatus(U.RTC_Opened);
this.signallingConnection.sendCustomString(this.options.customString);this.hasVideo&&(this.rtc.requestQualityControl(),this.liveStatus&&this.rtc.requestInitialSettings());this.receiveRenderEvents||this.rtc.sendEnableReceiveEvents(!1);this.api.onConnectionOpen()},ondatachannelclose:b=>this.api.onConnectionClose(b),ondatachannelerror:b=>this.api.onConnectionClose(b.error),ondatachannelmessage:(b,c)=>{switch(b){case "ResponseAPI":this.api.onConnectionMessage(c);break;case "InitialSettings":let d;null==
(d=this.liveStatus)||d.updateInitialSettings(c);break;case "VideoEncoderAvgQP":let e;if(null==(e=this.liveStatus)?0:e.visible)b=(new TextDecoder("utf-16")).decode(c.data.slice(1)),(b=JSON.parse(b))&&this.liveStatus.updateQPAndRenderFPS(b.qp,b.renderFPS);break;case "QualityControlOwnership":this.bQualityController=c;let g;null==(g=this.liveStatus)||g.updatePlayerId()}}},enableApiCallLog:this.options.enableApiCallLog},this);this.hasVideo&&this.htmlVideo.setWebRtcPlayer(this.rtc);this.logStartupInfo("setting up...");
this.options.offer&&this.rtc.createOffer();this.hasVideo&&this.options.registerEvents&&this.htmlVideo.registerEvents()}connectSignallingServer(){this.setStatus(U.WS_Connecting);this.signallingConnection=new nc({onopen:()=>{this.isDestroyed=!1;this.setStatus(U.WS_Connected);this.options.password&&this.signallingConnection.sendInstancePassword(this.options.password)},onclose:a=>this.handleSignallingClose(a),onerror:()=>{this.setStatus(U.WS_Disconnected)},onmessage:a=>{switch(a.type){case "config":setTimeout(()=>
this.initWebRtcPlayer(a),200);break;case "answer":this.playerId=a.playerId;this.rtc&&this.rtc.onReceiveAnswer(a);break;case "offer":this.playerId=a.playerId;this.rtc&&this.rtc.onReceiveOffer(a);break;case "iceCandidate":this.rtc&&this.rtc.onIceCandidate(a.candidate);break;case "paramInfo":this.receiveParamInfo(a);break;case "status":this.handleSignallingMessage_Status(a);break;case "playerCount":this.handleSignallingMessage_PlayerCount(a);break;case "api":this.api.onConnectionMessage(JSON.stringify(a));
...
WhiteSmoke:"RGB(245,245,245)",Gainsboro:"RGB(220,220,220)",LightGrey:"RGB(211,211,211)",Silver:"RGB(192,192,192)",DarkGray:"RGB(169,169,169)",Gray:"RGB(128,128,128)",DimGray:"RGB(105,105,105)",Black:"RGB(0,0,0)"};u.CommandType=l;u.CustomObjectData=fb;u.CustomObjectData2=gb;u.CustomTagData=Ta;u.DecalData=db;u.DigitalTwinAPI=ta;u.DigitalTwinPlayer=Ac;u.DynamicWaterData=ib;u.FieldType={String:0,Number:1};u.HeatMapPointData=Qa;u.HeatMapStyle={Normal:-1,CustomColor:0,CustomWave:1};u.HighlightAreaData=
Ua;u.HydroDynamic2DStyle={TrueWater:0,HeatMap:1};u.ImageButtonData=Va;u.LayerVisibleData=Pa;u.MapMode={Campass:0,SmallMap:1,BigMap:2};u.MeasurementMode={Coordinate:1,Linear:2,Horizontal:3,Vertical:4,MultiPoint:5,TerrainArea:6};u.MousePickMask=ra;u.ODLineData=ab;u.PanelType={ViewshedAnalysis:0,SkylineAnalysis:1,ViewDomeAnalysis:2,VisiblityAnalysis:3,FloodFillAnalysis:4,SolarAnalysis:5,CutFillAnalysis:6,TerrainSlopeAnalysi:7,ContourLineAnalysis:8};u.PanoramaData=cb;u.Polygon3DData=Za;u.Polygon3DStyle=
{Wave:0,LoopLine:1,Gradual:2,DynamicGradual:3,WaveTransparent:4,WideWave:5,RotateArrow:6,RotateLine:7,RotateGradual:8,SingleColor:9,SingleColorWithLight:10,OriginColor:11,OceanWater:12,LakeWater:13,Opacity:14,Mask:15,Transparent:16,Volumn:17};u.PolygonData=bb;u.PolygonStyle={SingleColor:0,CirclePoint:1,Volumn:2,Gradual:3,DynamicGradual:4,WaveTransparent:5,WideWave:6,RotateArrow:7,RotateLine:8,RotateGradual:9,OnTerrain:10,OriginColor:11};u.PolylineData=$a;u.PolylineStyle={Arrow:0,Arrow1:1,Flow:2,Beam:3,
Normal:4,OnTerrain:5,DottedNormal:6,DottedCircle:7,OriginColor:8};u.REVISION=18518;u.RadiationPointData=Ya;u.RendererType={SimpleRenderer:0,UniqueValueRenderer:1,ClassBreaksRenderer:2,VisibleRenderer:3};u.ResetType=Da;u.TagData=Ra;u.TileLayerActorData=fa;u.TileLayerData=eb;u.UIPanelType={MainUI:0,NewACP:1,OpenACP:2,MergeACP:3,SaveACP:4,Load3DT:5,Load3DTService:6,LoadSHP:7,Load3DTiles:8,Exit:9,InfoTreeGet:10,ResourceGet:11,PreferenceSettings:12,Around:13,CenterAround:14,Robomb:15,Role:16,Map:17,Vehicle:18,
Edit:19,CameraTour:20,Report:21,Weather:22,PostProcess:23,Camera:24,ShowSettings:25,Measure:26,Flatten:27,Hole:28,Clip:29,Select:30,Screenshot:31,Material:32,Vegetation:33,Vehicle:34,DynamicWater:35,VideoProjection:36,Panorama:37,Light:38,Marker:39,Marker3D:40,Decal:41,Beam:42,RadiationPoint:43,Polyline:44,Polygon:45,Settings:46,Help:47,ViewshedAnalysis:48,SkylineAnalysis:49,ViewDomeAnalysis:50,VisiblityAnalysis:51,FloodFillAnalysis:52,SolarAnalysis:53,CutFillAnalysis:54,TerrainSlopeAnalysi:55,ContourLineAnalysis:56};
u.VERSION="6.1";u.VectorFieldStyle={Typhoon:"DTS_TPHOON",Waves:"DTS_WAVE",Ocean:"DTS_OCEAN",Fluid:"DTS_STYLE_FLUID",Fluid_UV:"DTS_FLUID_COUNT_XYZ_UV",River:"DTS_RIVER",Wave:"DTS_WATER_WAVE"};u.VehicleViewMode={FirstPerson:0,ThirdPerson:1};u.VideoProjectionData=hb;u.Viewport=ca;u.VisualType={Color:0,Size:1,Height:1,Opacity:1};u.WaterFlowFieldStyle={HeatMap:0,Water:1,Particle:2};u.WaterMode={Animation:0,Simulation:1,Arrow:2};u.WebUIData=Sa;u.__onCefResponse=function(a,b){if(xa)xa.onConnectionMessage(a,
b)};Object.defineProperty(u,"__esModule",{value:!0});return u}({});(()=>{if("undefined"!=typeof module&&module.exports)module.exports=acapi;else if("function"==typeof define&&define.amd)define(function(){return acapi});else{window.AcApiVersion=acapi.VERSION;acapi.AirCityAPI=acapi.DigitalTwinAPI;acapi.AirCityPlayer=acapi.DigitalTwinPlayer;for(let u in acapi)"VERSION"!=u&&(window[u]=acapi[u]);acapi.DigitalTwinAPI.__onApiConstructed=u=>{window.__g=u;window.fdapi=u}}})();
